...
- idk about the party_count variable I feel like the game should
be broken and its not...and i dont know why its not broken.
code doesnt work: i gotta fix it. code works but im pretty sure
it shouldnt: i gotta try to break it so i can make sure to fix it
