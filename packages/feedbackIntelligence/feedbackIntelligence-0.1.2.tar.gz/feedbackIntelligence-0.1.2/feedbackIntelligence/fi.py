...
class FeedbackIntelligenceSDK:
    ...
    def add_context(self, company_id: int, context: str, context_id: Optional[int] = None) -> Dict:
        """
        Add context to the database for later use in user messages (synchronous).

        :param company_id: The ID of the company to which the context belongs.
        :param context: The context to add.
        :param context_id: Optional context ID.
        :return: Response from the API.
        """
        url = f"{self.__base_url}/data/{company_id}/context/add"
    ...
    async def add_context_async(self, company_id: int, context: str, context_id: Optional[int] = None) -> Dict:
        """
    ...
    def add_chat(self, company_id: int, chat_id: int, messages: List[Message], user_id: Optional[int] = None,
                 version: Optional[str] = None) -> Dict:
        """
        Add chat data to the database (synchronous).

        :param company_id: The ID of the company to which the chat data belongs.
        ...
        :return: Response from the API.
        """
        url = f"{self.__base_url}/data/{company_id}/chat/add"
        payload = {
            "chat_id": chat_id,
    ...
    async def add_chat_async(self, company_id: int, chat_id: int, messages: List[Message],
    ...
    def add_feedback(self, company_id: int, message: str, source: str, user_id: Optional[int] = None,
                     chat_id: Optional[int] = None, date: Optional[str] = None) -> Dict:
        """
        Add feedback data to the database (synchronous).

        :param company_id: The ID of the company to which the feedback data belongs.
        ...
        :return: Response from the API.
        """
        url = f"{self.__base_url}/data/{company_id}/feedback/add"
        payload = {
            "message": message,
            "source": source,
        }
    ...
    async def add_feedback_async(self, company_id: int, message: str, source: str, user_id: Optional[int] = None,
                                 chat_id: Optional[int] = None, date: Optional[str] = None) -> Dict:
        """
