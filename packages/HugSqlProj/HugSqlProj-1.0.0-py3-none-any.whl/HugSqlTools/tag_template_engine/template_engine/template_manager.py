...
def start_construct_tag_template(config_dict):
    ...
    tempalte_path = '/HugSqlTools/tag_template_engine/template_engine/tag_templates/offline'
    if template_type == 1:
        tempalte_path = '/HugSqlTools/tag_template_engine/template_engine/tag_templates/offline'
    elif template_type == 2:
        tempalte_path = '/HugSqlTools/tag_template_engine/template_engine/tag_templates/nrt'
    else :
