...
def experimental(func):
    ...
    """
    standard_j.log.put(f"Import of experimental function: {func.__name__}",
                       status=standard_j.log.LogStatusType.WARNING, files=())
...
def experimental_class(cls):
    ...
    """
    standard_j.log.put(f"Import of experimental class: {cls.__name__}",
                       status=standard_j.log.LogStatusType.WARNING, files=())
    ...
    def func_wrapper(*args, **kwargs):
        ...
        if len(matches) == 0:
            if DEBUG:
                ...
                standard_j.log.flush(status=standard_j.log.LogStatusType.ERROR)
