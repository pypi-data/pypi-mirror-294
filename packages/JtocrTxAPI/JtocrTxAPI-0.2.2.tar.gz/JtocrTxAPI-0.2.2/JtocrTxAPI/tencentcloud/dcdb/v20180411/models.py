...
class DescribeSqlLogsRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :param _InstanceId: 实例 ID，形如：dcdbt-ow728lmc，可以通过 DescribeDCDBInstances 查询实例详情获得。
        :type InstanceId: str
        :param _Offset: SQL日志偏移。
        :type Offset: int
        :param _Limit: 拉取数量（0-10000，为0时拉取总数信息）。
        :type Limit: int
        """
        self._InstanceId = None
        self._Offset = None
...
class DescribeSqlLogsResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _TotalCount: 当前消息队列中的sql日志条目数。
        :type TotalCount: int
        :param _StartOffset: 消息队列中的sql日志起始偏移。
        :type StartOffset: int
        :param _EndOffset: 消息队列中的sql日志结束偏移。
        :type EndOffset: int
        :param _Offset: 返回的第一条sql日志的偏移。
        :type Offset: int
        :param _Count: 返回的sql日志数量。
        :type Count: int
        :param _SqlItems: Sql日志列表。
    ...
    @property
    def SqlItems(self):
        return self._SqlItems

    @SqlItems.setter
    def SqlItems(self, SqlItems):
        self._SqlItems = SqlItems
...
class SqlLogItem(AbstractModel):
    ...
    def __init__(self):
        ...
        self._DbName = None
        self._Sql = None
        self._SelectRowNum = None
        self._AffectRowNum = None
        self._Timestamp = None
        self._TimeCostMs = None
    ...
    @property
    def SelectRowNum(self):
        return self._SelectRowNum

    @SelectRowNum.setter
    def SelectRowNum(self, SelectRowNum):
        self._SelectRowNum = SelectRowNum

    @property
    def AffectRowNum(self):
        return self._AffectRowNum

    @AffectRowNum.setter
    def AffectRowNum(self, AffectRowNum):
        self._AffectRowNum = AffectRowNum
    ...
    @property
    def TimeCostMs(self):
        return self._TimeCostMs

    @TimeCostMs.setter
    def TimeCostMs(self, TimeCostMs):
        self._TimeCostMs = TimeCostMs
    ...
    def _deserialize(self, params):
        ...
        self._SelectRowNum = params.get("SelectRowNum")
        self._AffectRowNum = params.get("AffectRowNum")
        self._Timestamp = params.get("Timestamp")
        self._TimeCostMs = params.get("TimeCostMs")
