...
LinearCrdTransf2d::LinearCrdTransf2d(int tag)
    : FrameTransform2d(tag, CRDTR_TAG_LinearCrdTransf2d), nodeIPtr(0), nodeJPtr(0),
      nodeIOffset(0), nodeJOffset(0), cosTheta(0), sinTheta(0), L(0),
...
// constructor:
LinearCrdTransf2d::LinearCrdTransf2d(int tag, const Vector &rigJntOffset1,
      ...
      nodeIInitialDisp(0), nodeJInitialDisp(0), initialDispChecked(false)
{
  ...
  if (rigJntOffset1.Size() != 2) {
    opserr << "LinearCrdTransf2d::LinearCrdTransf2d:  Invalid rigid joint "
...
LinearCrdTransf2d::getBasicIncrDisp(void)
{
  ...
  dub(0) = -cosTheta * dug[0] - sinTheta * dug[1] + cosTheta * dug[3] +
           sinTheta * dug[4];
...
LinearCrdTransf2d::getBasicTrialVel(void)
{
  ...
  vb(0) = -cosTheta * vg[0] - sinTheta * vg[1] + cosTheta * vg[3] +
          sinTheta * vg[4];
...
LinearCrdTransf2d::getBasicTrialAccel(void)
{
  ...
  ab(0) = -cosTheta * ag[0] - sinTheta * ag[1] + cosTheta * ag[3] +
          sinTheta * ag[4];
