                                  ...
                                  int argc, TCL_Char ** const argv, Domain *theDomain)
{
  ...
  if ((strcmp(argv[1], "PySimple1") == 0) ||
    ...
    if (strcmp(argv[1], "PySimple1") == 0)
      theMaterial = new PySimple1(tag, MAT_TAG_PySimple1, soilType, pult, y50,
                                  drag, dashpot);
    else
      theMaterial = new PySimple2(tag, MAT_TAG_PySimple1, soilType, pult, y50,
                                  drag, dashpot);
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (strcmp(argv[9], "-timeSeries") != 0) {
      ...
      theMaterial = new PyLiq1(tag, MAT_TAG_PyLiq1, soilType, pult, y50, drag,
                               dashpot, pRes, theDomain, theSeries);
    }
  }
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (strcmp(argv[1], "TzSimple1") == 0)
      theMaterial =
          new TzSimple1(tag, MAT_TAG_TzSimple1, tzType, tult, z50, dashpot);
    else
      theMaterial =
          new TzSimple2(tag, MAT_TAG_TzSimple1, tzType, tult, z50, dashpot);
  }
