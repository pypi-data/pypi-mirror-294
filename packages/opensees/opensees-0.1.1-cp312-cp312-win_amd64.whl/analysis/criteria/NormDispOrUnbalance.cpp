...
int NormDispOrUnbalance::test(void)
{
    ...
    if (printFlag == ConvergenceTest::PrintTest) {
        opserr << "NormDispOrUnbalance::test() - iteration: " << pad(currentIter);
        opserr << ", NormX: " << normX;
    ...
    // algo failed to converged after specified number of iterations - but RETURN OK
        ...
        if (printFlag & ConvergenceTest::PrintFailure) {
            opserr << "WARNING Failed to converge with criteria NormDispOrUnbalance but going on - ";
            opserr << ", NormX: " << normX;
            opserr << ", NormB: " << normB  << ", NormIncr: " << numIncr << "\n";
        }
        return currentIter;
    ...
    // algo failed to converged after specified number of iterations - return FAILURE -2
        ...
        opserr << "WARNING Failed to converge with criteria NormDispOrUnbalance \n";
