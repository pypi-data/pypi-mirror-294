...
class Block:
    ...
    def __init__(self, index: int, prev_hash: bytes,
                 ...
                 data: Union[bytearray, bytes], logs_dict: dict = None):
        self.index = index
    ...
    def to_bytes(self) -> bytes:
        ...
        compressed_data = CompressionWrapper.compress_lz4(self.data)
        ...
        if self.logs_dict:
            ...
            self.logs_dict["data_header_ratio"][1].send(compressed_data_len / packed_block_len)
