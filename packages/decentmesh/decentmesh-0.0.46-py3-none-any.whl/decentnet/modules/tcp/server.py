...
class TCPServer:
    ...
    def handle_client(client_socket,
                      beam_pipe_comm: dict, beam_message_queue: dict, logs_dict: dict):
        """
        Handle a client connection

        ! This function is run by separate process
        :param logs_dict: Logs dict of pipes
        ...
        relay = None
        try:
            relay = Relay(client_socket, beam_pipe_comm, beam_message_queue, logs_dict)
