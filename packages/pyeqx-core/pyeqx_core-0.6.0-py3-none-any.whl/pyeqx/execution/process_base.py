...
class ProcessBase(ABC):
    ...
    def _on_retry_error(
        ...
        **kwargs,
        ...
        self.logger.error(error) if callback is None else callback(
            prefix, error, *args, **kwargs
        )
    ...
    def _on_retry_last_error(
        ...
        **kwargs,
        ...
        self.logger.error(f"{prefix}: failed.") if callback is None else callback(
            prefix, attempt, error, *args, **kwargs
        )
