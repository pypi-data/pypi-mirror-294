...
class CreditTransactionProto(_message.Message):
    ...
    amount: int
    created_at: str
    def __init__(self, id: _Optional[str] = ..., organization_id: _Optional[str] = ..., type: _Optional[_Union[TransactionType, str]] = ..., parent_id: _Optional[str] = ..., amount: _Optional[int] = ..., created_at: _Optional[str] = ...) -> None: ...
