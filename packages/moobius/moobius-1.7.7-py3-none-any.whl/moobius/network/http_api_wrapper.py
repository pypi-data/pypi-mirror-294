...
class HTTPAPIWrapper:
    ...
    async def sign_up(self):
        """Signs up. Returns None. After confirming the account, self.authenticate() can be used to retrieve access and refresh tokens."""
    ...
    async def get_new_password(self):
        """Sends a reset-password request to the platform. After such a request is sent it will be necessary to check user email. Returns None"""
    ...
    async def reset_password(self, the_code):
        """Sends. Accepts the code that was emailed to the user."""
