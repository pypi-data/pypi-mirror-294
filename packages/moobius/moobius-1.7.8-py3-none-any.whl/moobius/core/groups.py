...
class ServiceGroupLib():
    ...
    async def convert_list(self, http_api, character_ids, is_message_down, channel_id=None, valid_ids=None):
        """
        ...
        Parameters:
          ...
          valid_ids=None: Remove anyone not in this list. If None will not filter.
        ...
        async with self.alock: # Make sure the old list is stored before the new list is created.
            ...
            if valid_ids:
                character_ids = [c_id for c_id in character_ids if c_id in set(valid_ids)]
