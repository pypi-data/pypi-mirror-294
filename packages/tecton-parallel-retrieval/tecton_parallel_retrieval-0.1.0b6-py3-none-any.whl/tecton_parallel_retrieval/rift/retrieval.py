...
def split_spine(spine: pandas.DataFrame, join_keys: List[str], split_count: int,
                strategy: str) -> List[pandas.DataFrame]:
    """
    ...
    if strategy == "even":
        ...
        return data_processing_utils._minimize_distance_split(
            spine, join_keys, split_count)
    elif strategy == "agglomerative_clustering":
        return data_processing_utils._agglomerative_clustering_split(
            spine, join_keys, split_count)
    else:
