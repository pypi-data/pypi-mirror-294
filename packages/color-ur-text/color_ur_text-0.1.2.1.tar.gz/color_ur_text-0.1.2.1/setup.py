...
setup(
    name="color_ur_text",
    version="0.1.2.1",  # Increment this version number for each new release
    author="Basit Ahmad Ganie",
    author_email="basitahmed1412@gmail.com",
    description="A module for printing colored text to terminal/console inPython",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    url="https://github.com/basitganie",  # Replace with your actual repository URL
