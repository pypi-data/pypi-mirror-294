...
if __name__ == "__main__":
    input_directory = os.path.join(base_directory, "txt_processed/3-paragraph_fix")
    output_directory = os.path.join(base_directory, "txt_processed/4-numbers_replaced")
