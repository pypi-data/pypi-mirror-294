...
json_file = os.path.join(base_directory, 'words_dictionary.json')
...
os.path.join(base_directory, "txt_processed/0-main_txt")
input_dir = os.path.join(base_directory, 'txt_processed/6-5-es_ait_')
output_dir = os.path.join(base_directory, 'txt_processed/7-word_replacement_')
