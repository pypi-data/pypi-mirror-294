...
if __name__ == "__main__":
    input_directory = os.path.join(base_directory, 'txt_processed/1-page_nb_cln')
    output_directory = os.path.join(base_directory, 'txt_processed/2-chapter_split')
    info_output_directory = os.path.join(base_directory, 'txt_processed/10-book_info')
