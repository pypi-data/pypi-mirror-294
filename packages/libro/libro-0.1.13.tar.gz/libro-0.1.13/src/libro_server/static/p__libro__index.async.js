...
var es = __webpack_require__(34438);
...
var mana_app_es = __webpack_require__(65565);
...
// EXTERNAL MODULE: ./node_modules/_@difizen_libro-prompt-cell@0.2.29@@difizen/libro-prompt-cell/es/index.js + 24 modules
var libro_prompt_cell_es = __webpack_require__(83227);
...
// EXTERNAL MODULE: ./node_modules/_@difizen_libro-core@0.2.29@@difizen/libro-core/es/index.js + 317 modules
var libro_core_es = __webpack_require__(10812);
...
var LibroSchemaFormWidgetComponent = /*#__PURE__*/(0,_react_18_3_1_react.forwardRef)(function (props, ref) {
  ...
  var schema = (0,_react_18_3_1_react.useMemo)(function () {
    try {
  ...
  var value = (0,_react_18_3_1_react.useMemo)(function () {
    try {
  ...
  var handleChange = (0,_react_18_3_1_react.useCallback)(function (values) {
    var data = {
      buffer_paths: [],
      method: 'update',
      state: {
