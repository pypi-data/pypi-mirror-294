...
class EmailRoutingCatchAll(
    ...
    def __init__(
        ...
        *,
        ...
        :param action: action block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#action EmailRoutingCatchAll#action}
        :param matcher: matcher block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#matcher EmailRoutingCatchAll#matcher}
        :param name: Routing rule name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#name EmailRoutingCatchAll#name}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#zone_id EmailRoutingCatchAll#zone_id}
        :param enabled: Routing rule status. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#enabled EmailRoutingCatchAll#enabled}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#id EmailRoutingCatchAll#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing EmailRoutingCatchAll that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#import import section} in the documentation of this resource for the id to use
...
class EmailRoutingCatchAllAction:
    def __init__(
        ...
        *,
        ...
        '''
        :param type: Type of supported action. Available values: ``drop``, ``forward``, ``worker``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#type EmailRoutingCatchAll#type}
        :param value: A list with items in the following form. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#value EmailRoutingCatchAll#value}
        '''
        if __debug__:
...
class EmailRoutingCatchAllMatcher:
    def __init__(self, *, type: builtins.str) -> None:
        '''
        :param type: Type of matcher. Available values: ``all``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.41.0/docs/resources/email_routing_catch_all#type EmailRoutingCatchAll#type}
        '''
        if __debug__:
