...
class Config:
    ...
    DEFAULT_PREFIX_SINGLE_DF = """
        ...
        - Import and Create Copy: Start by importing the 'copy' library and create "df_plot = copy.deepcopy(df)". 
        - Work with df_plot: Make all plots using df_plot, not df.
        - Clean up the data smartly including but not limit to remove na, impute missing values, remove outliers, replace or remove unreasonable values etc.
        ...
        - Import and Create Copy: Start by importing the 'copy' library and create "df_ml = copy.deepcopy(df)". 
        ...
        - Import and Create Copy: Start by importing the 'copy' library and create "df_update = copy.deepcopy(df)". 
        - Work with df_update: Make all modifications using df_update, not df.
        ...
        - Do not create new features, apply normalization or scaling, or drop any features unless specifically requested.
