...
def github_repo_insights(
    ...
    try:
        ...
        err_console.print(
            "[bold green]For more information, please refer to the [link=https://github.com/AryanK1511/github-echo/blob/main/README.md]project README File[/link].[/bold green]\n"
        )
