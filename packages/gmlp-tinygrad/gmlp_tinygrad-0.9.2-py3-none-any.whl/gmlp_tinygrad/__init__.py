...
class TinyAttention:
    ...
    def __init__(
        ...
        dropout_p: float = 0.0):
        """
        Initializes the TinyAttention module.

        Args:
            dim (int): The input dimension.
            out_dim (int): The output dimension.
            attn_dim (int, optional): The dimension of the attention mechanism.
...
class SpatialGatingUnit:
    ...
    def __init__(self, dim: int, max_seq_len: int):
        """
        Initializes the SpatialGatingUnit module.
...
class gMLPLayer:
    ...
    def __init__(self,
                 ...
                 dropout_p: float = 0.0):
        """
        Initializes the gMLPLayer module.
        ...
        Args:
            ...
            max_seq_len (int): The maximum sequence length.
            attn_dim (int, optional): The dimension of the attention mechanism.
            use_attn (bool, optional): Whether to use the attention mechanism.
            dropout_p (float, optional): Dropout probability.
        """
...
class gMLP:
    ...
    def __init__(self,
        ...
        """
        Initializes the gMLP model.

        Args:
            dim (int): The input dimension.
            num_layers (int): The number of gMLP layers.
            hidden_dim (int): The hidden dimension.
            max_seq_len (int): The maximum sequence length.
            layer_skip_p (float, optional): Probability of skipping a layer during training.
        """
        self.layer_skip_p = layer_skip_p
        self.layers = [gMLPLayer(dim, hidden_dim, max_seq_len, attn_dim, use_attn, dropout_p) for _ in range(num_layers)]
