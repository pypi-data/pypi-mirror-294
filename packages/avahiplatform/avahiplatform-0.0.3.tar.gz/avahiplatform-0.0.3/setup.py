...
setup(
    ...
    install_requires=["boto3>=1.34.160", "loguru>=0.7.2", "python-docx>=1.1.2", "PyMuPDF>=1.24.9", "langchain>=0.2.16",
                      ...
                      "PyMySQL>=1.1.1", "tabulate>=0.9.0", "langchain-aws>=0.1.17","chromadb==0.5.3", "langchain-chroma>=0.1.3", "unstructured>=0.12.3", "python-magic-bin", "unstructured[pdf]", "pillow>=10.4.0","pandas"],
    extras_require={
        "dev": ["twine>=4.0.2"],
