...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-lambda-dotnet.BundlingOptions",
    jsii_struct_bases=[],
    name_mapping={
        ...
        "msbuild_parameters": "msbuildParameters",
    },
)
class BundlingOptions:
    def __init__(
        ...
        *,
        ...
        msbuild_parameters: typing.Optional[typing.Sequence[builtins.str]] = None,
    ) -> None:
        ...
        :param msbuild_parameters: (experimental) Arguments passed to the ``dotnet publish`` command.

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fd6ccc2cd8076130b302882ddd2a6055c6ca75f4d125cb330719e0f6dfb12aad)
            ...
            check_type(argname="argument msbuild_parameters", value=msbuild_parameters, expected_type=type_hints["msbuild_parameters"])
        ...
        if msbuild_parameters is not None:
            self._values["msbuild_parameters"] = msbuild_parameters
    ...
    @builtins.property
    def msbuild_parameters(self) -> typing.Optional[typing.List[builtins.str]]:
        '''(experimental) Arguments passed to the ``dotnet publish`` command.

        :stability: experimental
        '''
        result = self._values.get("msbuild_parameters")
...
class DotNetFunction(
    ...
    jsii_type="@aws-cdk/aws-lambda-dotnet.DotNetFunction",
):
    '''(experimental) A .NET Lambda function.
    ...
    def __init__(
        ...
        *,
        ...
        solution_dir: typing.Optional[builtins.str] = None,
        ...
        :param scope: -
        :param id: -
        :param project_dir: (experimental) Directory containing your .csproj file.
        :param bundling: (experimental) Bundling options. Default: - use default bundling options
        :param handler: (experimental) The name of the method within your code that Lambda calls to execute your function. The format includes the file name. It can also include namespaces and other qualifiers, depending on the runtime. For more information, see https://docs.aws.amazon.com/lambda/latest/dg/foundation-progmodel.html. Default: - the .csproj file is used as project name and the handler is set to the project name or the handler is found reading the aws-lambda-tools-defaults.json file in the project directory.
        :param runtime: (experimental) The runtime environment. Only runtimes of the .NET family and provided family are supported. Default: lambda.Runtime.PROVIDED_AL2
        :param solution_dir: (experimental) Directory containing your .sln file. This will be used as the source of the volume mounted in the Docker container and will be the directory where it will run ``dotnet build`` from. Default: - the path is found by walking up parent directories searching for a ``.sln`` file from the location of ``projectDir``. If no ``.sln`` file is found, the ``projectDir`` will be used.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6c686172af9fa410e7a20009d2f1e3db419052ad1db4754adefa6823bc949808)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = DotNetFunctionProps(
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-lambda-dotnet.DotNetFunctionProps",
...
class DotNetFunctionProps(_aws_cdk_aws_lambda_ceddda9d.FunctionOptions):
    def __init__(
        self,
        *,
        max_event_age: typing.Optional[_aws_cdk_ceddda9d.Duration] = None,
        ...
        '''(experimental) Properties for a .NET Function.
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__31f0766825e60244613fcb35d6145a1404a56c90d1753ff8a38432917d3b5632)
            ...
            check_type(argname="argument project_dir", value=project_dir, expected_type=type_hints["project_dir"])
            check_type(argname="argument bundling", value=bundling, expected_type=type_hints["bundling"])
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
            check_type(argname="argument runtime", value=runtime, expected_type=type_hints["runtime"])
            check_type(argname="argument solution_dir", value=solution_dir, expected_type=type_hints["solution_dir"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "project_dir": project_dir,
        }
        ...
        if solution_dir is not None:
            self._values["solution_dir"] = solution_dir
    ...
    @builtins.property
    def project_dir(self) -> builtins.str:
        '''(experimental) Directory containing your .csproj file.

        :stability: experimental
        '''
        result = self._values.get("project_dir")
        assert result is not None, "Required property 'project_dir' is missing"
    ...
    def handler(self) -> typing.Optional[builtins.str]:
        ...
        - the .csproj file is used as project name and the handler is set to the project name
    ...
    @builtins.property
    def solution_dir(self) -> typing.Optional[builtins.str]:
        '''(experimental) Directory containing your .sln file.
        ...
        :stability: experimental
        '''
        result = self._values.get("solution_dir")
        return typing.cast(typing.Optional[builtins.str], result)
    ...
    def __repr__(self) -> str:
        return "DotNetFunctionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.interface(jsii_type="@aws-cdk/aws-lambda-dotnet.ICommandHooks")
...
class _ICommandHooksProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "@aws-cdk/aws-lambda-dotnet.ICommandHooks"
    ...
    def after_bundling(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__836924403fe21b5340960422a76d4ceeaefacbd825e85b469a690d9f99cb8701)
    ...
    def before_bundling(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__912dff981ee433c963bc14ec3ff937d4d085b9c5e5dc1bc3addc755fb61d7e34)
            check_type(argname="argument input_dir", value=input_dir, expected_type=type_hints["input_dir"])
            check_type(argname="argument output_dir", value=output_dir, expected_type=type_hints["output_dir"])
...
def _typecheckingstub__fd6ccc2cd8076130b302882ddd2a6055c6ca75f4d125cb330719e0f6dfb12aad(
    *,
    asset_hash: typing.Optional[builtins.str] = None,
    asset_hash_type: typing.Optional[_aws_cdk_ceddda9d.AssetHashType] = None,
    command_hooks: typing.Optional[ICommandHooks] = None,
...
def _typecheckingstub__6c686172af9fa410e7a20009d2f1e3db419052ad1db4754adefa6823bc949808(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    project_dir: builtins.str,
...
def _typecheckingstub__31f0766825e60244613fcb35d6145a1404a56c90d1753ff8a38432917d3b5632(
    *,
    max_event_age: typing.Optional[_aws_cdk_ceddda9d.Duration] = None,
    on_failure: typing.Optional[_aws_cdk_aws_lambda_ceddda9d.IDestination] = None,
    on_success: typing.Optional[_aws_cdk_aws_lambda_ceddda9d.IDestination] = None,
...
def _typecheckingstub__836924403fe21b5340960422a76d4ceeaefacbd825e85b469a690d9f99cb8701(
    input_dir: builtins.str,
    output_dir: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__912dff981ee433c963bc14ec3ff937d4d085b9c5e5dc1bc3addc755fb61d7e34(
    input_dir: builtins.str,
    output_dir: builtins.str,
) -> None:
    """Type checking stubs"""
