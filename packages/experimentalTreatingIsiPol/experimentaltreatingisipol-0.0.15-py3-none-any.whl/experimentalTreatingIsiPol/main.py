...
class ReadExperimentalData():
    ...
    def __init__(self, archive_name,machineArqData  :dict = {
                     'column_delimitador':';',
                     'skiprows':10,
                     'decimal':','
                 }):
        
        self.raw_data = pd.read_csv(archive_name, sep=machineArqData['column_delimitador'],
                                                encoding_errors='backslashreplace', 
                                                on_bad_lines='skip', 
                                                skiprows=machineArqData['skiprows'], 
                                                decimal=machineArqData['decimal'])
