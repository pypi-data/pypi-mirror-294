...
from main import scatter_helper
import numpy as np
import matplotlib.pyplot as plt
...
from main import plot_helper, blue_tonalities_options
import numpy as np
import matplotlib.pyplot as plt
...
from main import MechanicalTestFittingLinear
import os
archive = os.path.join(os.getcwd(),r'..\DataArquives\Specimen_RawData_1.csv')
classInit =  MechanicalTestFittingLinear(machineName='_older_machine', archive_name=archive, direction = 'parallel')
...
sys.path.insert(0, os.path.join(os.getcwd(),r'..\src\experimentalTreatingIsiPol'))
import numpy as np
from main import SeveralMechanicalTestingFittingLinear
