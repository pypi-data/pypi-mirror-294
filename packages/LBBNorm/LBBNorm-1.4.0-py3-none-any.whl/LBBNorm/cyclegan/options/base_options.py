...
class BaseOptions():
    ...
    def initialize(self, parser, result_dir):
        ...
        parser.add_argument('--results_dir', type=str, default=result_dir, help='saves results here.')
        
        # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 ADDED THIS
        # parser.add_argument('--dataroot',default=data_root, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--dataroot',default="", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        
        parser.add_argument('--name', type=str, default="mitos-atypia", help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--model', type=str, default='test', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        # parser.add_argument('--model_suffix', type=str, default='_A', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        #===============================================
    ...
    def gather_options(self, result_dir):
        ...
        if not self.initialized:  # check if it has been initialized
            ...
            parser = self.initialize(parser, result_dir)
    ...
    def parse(self, result_dir):
        """Parse our options, create checkpoints directory suffix, and set up gpu device."""
        opt = self.gather_options(result_dir)
