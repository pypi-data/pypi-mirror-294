...
class DataGroup:
    ...
    name: str
    path: str
    attributes: Optional[DataKeycloakAttributes]
    realmRoles: list = field(default_factory=list, compare=False)
    clientRoles: dict = field(default_factory=dict)
...
class KeycloakService():
    ...
    def get_groups_by_path(self, path: str) -> List[DataGroup]:
