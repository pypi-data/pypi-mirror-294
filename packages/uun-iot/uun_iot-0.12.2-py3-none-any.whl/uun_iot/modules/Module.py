...
class Module:
    ...
    def __init__(
        ...
        *,
        ...
        if not registered:
            ...
            self._on_config = EvConfUpdate.subscribe(self._update_config).extract()  # type: ignore
    ...
    def _config_manager(
        self, key: Optional[str] = None, scope: ConfigScopeEnum = ConfigScopeEnum.BASED
    ) -> Any:
