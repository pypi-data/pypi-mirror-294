...
from creao.core.component.util import class_registry, extract_json_schema
...
class Pipeline:
    ...
    def load_from_rf_json(file_path, rf_dict=None, global_variables=None):
        ...
        for edge in rf_dict["edges"]:
            ...
            # Handle special case for HFDataComponent nodes
            if from_node["class"] == "HFDataComponent":
                dataset_children_map.setdefault(from_node["label"], {})[to_node["label"]] = Pipeline.extract_jinja2_variables(to_node["prompt_template"])
