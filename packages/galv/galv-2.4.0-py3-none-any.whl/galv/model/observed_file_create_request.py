...
class ObservedFileCreateRequest(
    schemas.DictSchema
):
...
The data and preview image will be extracted and stored in Storage.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["path", "uploader", "file", "team", "target_file_id", "name", "mapping", "state", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["path", "uploader", "file", "team", "target_file_id", "name", "mapping", "state", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
