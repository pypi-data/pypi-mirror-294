...
class OrbitalCovarianceEphemeris(BaseModel):
    ...
    covariance_type: Optional[OrbitType] = Field(default=None, alias="covarianceType")
    ...
    __properties: ClassVar[List[str]] = ["dates", "description", "covarianceType", "anomalyType", "inertialFrameId", "data"]
