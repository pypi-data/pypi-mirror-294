...
class DatedLocalFrameFiniteThrust(BaseModel):
    """
    Thrust defined by the starting date, firing duration and a direction in a local orbital frame
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatedLocalFrameFiniteThrust from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatedLocalFrameFiniteThrust from a dict"""
        if obj is None:
            return None
