...
class UserOrganization(BaseModel):
    ...
    __properties = ["id", "name", "logo", "isDeveloperProfile", "whitelabelId", "isAdmin", "created", "trialId", "trialExpiredDate", "trialUpgradedDate", "entitlementLimits", "userCount", "adminCount"]
