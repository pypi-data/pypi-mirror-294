...
class Connection:
    ...
    def download(self, resource_name, remote_file, local_dir='E:/workspace/pycharm/jupyter/'):
        """
        获取远程的日志文件内容
        """
    ...
    def win_ssh(self):
        ...
        for index, row in self.resources.iterrows():
            resource_name = row['resource_name']
            self.upload(resource_name, 'C:/Users/{}/.ssh/id_rsa.pub'.format(username), '/root/id_rsa.pub')
