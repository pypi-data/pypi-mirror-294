...
class CrystalReportsLoader:
    ...
    STATIC_CONFIG = {
        "crystal_reports_engine": "CR/CrystalDecisions.CrystalReports.Engine",
        "crystal_reports_windows_forms": "CR/CrystalDecisions.Windows.Forms",
        "crystal_reports_shared": "CR/CrystalDecisions.Shared"
    }
    def __init__(self):
        """
    ...
    def load_config(self):
        ...
        try:
            ...
            self.crystal_reports_engine = os.path.join(script_dir, self.STATIC_CONFIG["crystal_reports_engine"])
            self.crystal_reports_windows_forms = os.path.join(script_dir, self.STATIC_CONFIG["crystal_reports_windows_forms"])
            self.crystal_reports_shared = os.path.join(script_dir, self.STATIC_CONFIG["crystal_reports_shared"])
