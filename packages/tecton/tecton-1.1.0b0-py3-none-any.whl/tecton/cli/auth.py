...
def whoami():
    """
    Deprecated in 1.0. Please use `tecton get-caller-identity`

    Show the current User or API Key used to authenticate with Tecton.
    """
    printer.safe_print("This command is deprecated in 1.0. Please use `tecton get-caller-identity` instead.")
    printer.safe_print()
