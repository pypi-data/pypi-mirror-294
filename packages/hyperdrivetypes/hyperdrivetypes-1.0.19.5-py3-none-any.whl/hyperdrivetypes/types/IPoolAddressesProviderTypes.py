...
ACLAdminUpdated = ABIEvent(
    anonymous=False,
    inputs=[
        ABIComponentIndexed(indexed=True, name="oldAddress", type="address"),
        ABIComponentIndexed(indexed=True, name="newAddress", type="address"),
    ],
...
AddressSet = ABIEvent(
    anonymous=False,
    inputs=[
        ABIComponentIndexed(indexed=True, name="id", type="bytes32"),
        ABIComponentIndexed(indexed=True, name="oldAddress", type="address"),
        ABIComponentIndexed(indexed=True, name="newAddress", type="address"),
    ],
    name="AddressSet",
...
AddressSetAsProxy = ABIEvent(
    ...
    inputs=[
        ABIComponentIndexed(indexed=True, name="id", type="bytes32"),
        ABIComponentIndexed(indexed=True, name="proxyAddress", type="address"),
        ABIComponentIndexed(
...
MarketIdSet = ABIEvent(
    anonymous=False,
    inputs=[
        ABIComponentIndexed(indexed=True, name="oldMarketId", type="string"),
        ABIComponentIndexed(indexed=True, name="newMarketId", type="string"),
    ],
    name="MarketIdSet",
    type="event",
)
