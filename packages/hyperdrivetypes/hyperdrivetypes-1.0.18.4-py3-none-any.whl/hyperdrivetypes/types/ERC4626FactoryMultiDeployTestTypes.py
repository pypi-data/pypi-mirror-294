...
SlotFound = ABIEvent(
    anonymous=False,
    inputs=[
        ABIEventParams(indexed=False, name="who", type="address"),
        ABIEventParams(indexed=False, name="fsig", type="bytes4"),
        ABIEventParams(indexed=False, name="keysHash", type="bytes32"),
        ABIEventParams(indexed=False, name="slot", type="uint256"),
    ],
    name="SlotFound",
    type="event",
)
