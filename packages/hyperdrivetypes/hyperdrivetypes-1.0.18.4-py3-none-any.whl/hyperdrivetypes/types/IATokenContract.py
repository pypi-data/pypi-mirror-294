...
class IATokenPOOLContractFunction(ContractFunction):
    """ContractFunction for the POOL method."""

    def __call__(self) -> IATokenPOOLContractFunction:  # type: ignore
        clone = super().__call__()
        self.kwargs = clone.kwargs
        self.args = clone.args
        return self
...
class IATokenContractFunctions(ContractFunctions):
    ...
    POOL: IATokenPOOLContractFunction
    ...
    def __init__(
        ...
        self.POOL = IATokenPOOLContractFunction.factory(
            "POOL",
            w3=w3,
            contract_abi=abi,
            address=address,
