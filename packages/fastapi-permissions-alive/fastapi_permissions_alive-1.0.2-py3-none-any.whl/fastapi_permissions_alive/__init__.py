...
def permission_dependency_factory(
    ...
    def permission_dependency(
        principals=active_principals_func, resource=dependable_resource
    ):
        if has_permission(user_principals=principals, resource=resource, requested_permission=permission):
            return resource
