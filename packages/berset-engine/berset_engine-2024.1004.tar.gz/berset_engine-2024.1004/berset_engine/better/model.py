...
class InverseModel:
    ...
    def fit_model(self, has_fit=False, threshold=0.0001):
        ### Handle outliers (TBD)
        ...
        try:
            ...
            traceback.print_exc()
            print(err)
            # return has_fit = False when optimize.curve_fit could not find a solution
            return has_fit
    ...
    def plot_IM(self, building):
        ...
        # Initialization for using plotly
        # TODO: add line in terms of model type
