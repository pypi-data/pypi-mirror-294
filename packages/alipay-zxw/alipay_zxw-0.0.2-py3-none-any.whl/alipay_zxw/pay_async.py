...
from .compat import decodebytes, encodebytes, quote_plus
...
class BaseAliPay:
    ...
    def server_api(self, api_name, biz_content=None, **kwargs):
        ...
        # print(data)
        return self.verified_async_response(data, response_type)
    ...
    async def api_alipay_trade_query(self, out_trade_no=None, trade_no=None):
        """
        response = {
        ...
        return await self.verified_async_response(data, response_type)

    async def api_alipay_trade_pay(
    ...
    async def api_alipay_trade_cancel(self, out_trade_no=None, trade_no=None):
        """
        response = {
    ...
    async def api_alipay_trade_close(self, out_trade_no=None, trade_no=None, operator_id=None):
        """
        response = {
    ...
    async def api_alipay_trade_create(
            self, subject, out_trade_no, total_amount, notify_url=None, **kwargs
    ):
        biz_content = {
            "subject": subject,
    ...
    async def api_alipay_trade_precreate(
            self, subject, out_trade_no, total_amount, notify_url=None, **kwargs
    ):
        """
        success response = {
    ...
    async def api_alipay_trade_fastpay_refund_query(
    ...
    async def api_alipay_fund_trans_toaccount_transfer(
    ...
    async def api_alipay_fund_trans_order_query(self, out_biz_no=None, order_id=None):
    ...
    async def api_alipay_trade_order_settle(
        self,
        out_request_no,
        trade_no,
        royalty_parameters,
    ...
    async def api_alipay_ebpp_invoice_token_batchquery(self, invoice_token=None, scene=None):
        if scene is None:
    ...
    async def verified_async_response(self, data, response_type):
        url = self._gateway + "?" + self.sign_data(data)
        async with httpx.AsyncClient() as client:
            response = await client.get(url, timeout=self._config.timeout)
...
class DCAliPay(BaseAliPay):
    ...
    async def api_alipay_fund_trans_uni_transfer(
...
class ISVAliPay(BaseAliPay):
    ...
    @property
    async def app_auth_token(self):
        # 没有则换取token
        if not self._app_auth_token:
            result = await self.api_alipay_open_auth_token_app(self._app_auth_code)
    ...
    async def api_alipay_open_auth_token_app(self, refresh_token=None):
        """
        response = {
            "code": "10000",
            "msg": "Success",
    ...
    async def api_alipay_open_auth_token_app_query(self):
