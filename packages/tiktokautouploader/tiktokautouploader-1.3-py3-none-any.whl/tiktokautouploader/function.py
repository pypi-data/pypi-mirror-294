...
def upload_tiktok(video, description, hashtags, cookies_path, sound_name=None, sound_aud_vol='mix', schedule=None, day=None, copyrightcheck=False, headless = True):
    ...
    with sync_playwright() as p:
        ...
        try:
            page.wait_for_selector('input[type="file"][accept="video/*"]', timeout=10000)
        except:
