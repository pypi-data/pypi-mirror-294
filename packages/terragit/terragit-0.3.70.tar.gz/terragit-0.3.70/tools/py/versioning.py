...
def log_func(env, functions):
    ...
    for function in functions:
        print(
            function["FunctionName"],  # type: ignore
            function["Environment"]["Variables"]["VERSION"],  # type: ignore
            function["Runtime"],  # type: ignore
            function["LastModified"],  # type: ignore
            sep=" / ",
        )
    ...
    while True:
        ...
        for function in functions:
            if function.get("Environment"):
                if function["Environment"]["Variables"].get("VERSION"):  # type: ignore
                    func_name = function["FunctionName"].lower()  # type: ignore
                    if "dev" in func_name:
