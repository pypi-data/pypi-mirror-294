...
class CreateLeadRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_version_id, policy_objects, product_code, payment_method, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_version_id, policy_objects, product_code, payment_method, *args, **kwargs):  # noqa: E501
        """CreateLeadRequestDto - a model defined in OpenAPI
