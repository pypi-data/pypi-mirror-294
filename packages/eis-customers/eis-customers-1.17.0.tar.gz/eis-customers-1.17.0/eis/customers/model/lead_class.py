...
class LeadClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, status, account, policy, ern, quote, payment_method, created_at, updated_at, partner_links, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, status, account, policy, ern, quote, payment_method, created_at, updated_at, partner_links, *args, **kwargs):  # noqa: E501
        """LeadClass - a model defined in OpenAPI
