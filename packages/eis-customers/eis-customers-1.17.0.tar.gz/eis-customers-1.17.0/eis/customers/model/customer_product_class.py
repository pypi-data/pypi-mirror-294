...
class CustomerProductClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, name, slug, contract_duration_days, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, name, slug, contract_duration_days, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """CustomerProductClass - a model defined in OpenAPI
