...
class PolicyClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, policy_number, account_code, versions, created_at, updated_at, status, ern, organization_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, policy_number, account_code, versions, created_at, updated_at, status, ern, organization_name, *args, **kwargs):  # noqa: E501
        """PolicyClass - a model defined in OpenAPI
