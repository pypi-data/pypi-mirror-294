...
class Workflow(
    ...
    def __init__(
        ...
        *,
        ...
        :param destination: destination block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#destination Workflow#destination}
        :param issues_filter: issues_filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#issues_filter Workflow#issues_filter}
        :param muting_rules_handling: The type of the muting rule handling. One of: (NOTIFY_ALL_ISSUES, DONT_NOTIFY_FULLY_MUTED_ISSUES, DONT_NOTIFY_FULLY_OR_PARTIALLY_MUTED_ISSUES). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#muting_rules_handling Workflow#muting_rules_handling}
        :param name: (Required) The name of the workflow. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#name Workflow#name}
        :param account_id: The account id of the workflow. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#account_id Workflow#account_id}
        :param destinations_enabled: Indicates whether the destinations are enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#destinations_enabled Workflow#destinations_enabled}
        :param enabled: Indicates whether the workflow is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#enabled Workflow#enabled}
        :param enrichments: enrichments block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#enrichments Workflow#enrichments}
        :param enrichments_enabled: Indicates whether the enrichments are enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#enrichments_enabled Workflow#enrichments_enabled}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#id Workflow#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Workflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#import import section} in the documentation of this resource for the id to use
    ...
    def put_enrichments(
        ...
        *,
        ...
        '''
        :param nrql: nrql block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#nrql Workflow#nrql}
        '''
    ...
    def put_issues_filter(
        ...
        *,
        ...
        '''
        :param name: (Required) Filter's name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#name Workflow#name}
        :param type: (Required) The type of the filter. One of: (FILTER, VIEW). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#type Workflow#type}
        :param predicate: predicate block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#predicate Workflow#predicate}
        '''
...
class WorkflowDestination:
    def __init__(
        ...
        *,
        ...
        '''
        :param channel_id: (Required) Destination's channel id. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#channel_id Workflow#channel_id}
        :param notification_triggers: List of triggers to notify about in this destination configuration. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#notification_triggers Workflow#notification_triggers}
        :param update_original_message: Update original notification message (Slack channels only). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#update_original_message Workflow#update_original_message}
        '''
        if __debug__:
...
class WorkflowEnrichmentsNrql:
    def __init__(
        ...
        *,
        ...
        '''
        :param configuration: configuration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#configuration Workflow#configuration}
        :param name: (Required) Enrichment's name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#name Workflow#name}
        '''
        if __debug__:
...
class WorkflowEnrichmentsNrqlConfiguration:
    def __init__(self, *, query: builtins.str) -> None:
        '''
        :param query: enrichment's NRQL query. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#query Workflow#query}
        '''
        if __debug__:
...
class WorkflowIssuesFilterPredicate:
    def __init__(
        ...
        *,
        ...
        '''
        :param attribute: (Required) predicate's attribute. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#attribute Workflow#attribute}
        :param operator: The type of the operator. One of: (CONTAINS, DOES_NOT_CONTAIN, DOES_NOT_EQUAL, DOES_NOT_EXACTLY_MATCH, ENDS_WITH, EQUAL, EXACTLY_MATCHES, GREATER_OR_EQUAL, GREATER_THAN, IS, IS_NOT, LESS_OR_EQUAL, LESS_THAN, STARTS_WITH). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#operator Workflow#operator}
        :param values: List of predicate values. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.45.0/docs/resources/workflow#values Workflow#values}
        '''
        if __debug__:
