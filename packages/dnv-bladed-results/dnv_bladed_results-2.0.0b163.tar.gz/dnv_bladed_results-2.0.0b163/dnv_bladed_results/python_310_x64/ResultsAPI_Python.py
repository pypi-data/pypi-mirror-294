...
class Run(object):
    ...
    def get_groups(self) -> np.ndarray[Group]:
        ...
        Notes
        -----
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_groups_native_array` to avoid this penalty.
        """

        return np.array(self._get_groups_native_array(), copy=False)
...
class Group(object):
    ...
    def _get_variables_1d_native_array(self) -> ArrayOfVariable1D_Float32 | ArrayOfVariable1D_Float64 | ArrayOfVariable1D_Int32:
        ...
        data_type = self.get_variable_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return np.array(self._get_variables_1d_float32_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return np.array(self._get_variables_1d_float64_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_INT32):
            return np.array(self._get_variables_1d_int32_native_array(), copy=False)
        else:
            raise TypeError("Variable1D data type not supported: " + str(data_type))
    ...
    def get_variables_1d(self) -> np.ndarray[Variable1D_Float32] | np.ndarray[Variable1D_Float64] | np.ndarray[Variable1D_Int32]:
        ...
        - The group must be one-dimensional (containing variables of subtype `Variable1D`) for the call to succeed.
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_variables_1d_native_array` to avoid this penalty.
        """

        return np.array(self._get_variables_1d_native_array(), copy=False)
    ...
    def _get_variables_2d_native_array(self) -> ArrayOfVariable2D_Float32 | ArrayOfVariable2D_Float64 | ArrayOfVariable2D_Int32:
        ...
        data_type = self.get_variable_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return np.array(self._get_variables_2d_float32_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return np.array(self._get_variables_2d_float64_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_INT32):
            return np.array(self._get_variables_2d_int32_native_array(), copy=False)
        else:
            raise TypeError("Variable2D data type not supported: " + str(data_type))
    ...
    def get_variables_2d(self) -> np.ndarray[Variable2D_Float32] | np.ndarray[Variable2D_Float64] | np.ndarray[Variable2D_Int32]:
        ...
        - The group must be two-dimensional (containing variables of subtype `Variable2D`) for the call to succeed.
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_variables_2d_native_array` to avoid this penalty.
        """

        return np.array(self._get_variables_2d_native_array(), copy=False)
    ...
    def _get_variables_1d_float32_native_array(self) -> ArrayOfVariable1D_Float32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variables_1d_float32_native_array(self)
    ...
    def _get_variables_1d_float64_native_array(self) -> ArrayOfVariable1D_Float64:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variables_1d_float64_native_array(self)
    ...
    def _get_variables_1d_int32_native_array(self) -> ArrayOfVariable1D_Int32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variables_1d_int32_native_array(self)
    ...
    def _get_variables_2d_float32_native_array(self) -> ArrayOfVariable2D_Float32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variables_2d_float32_native_array(self)
    ...
    def _get_variables_2d_float64_native_array(self) -> ArrayOfVariable2D_Float64:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variables_2d_float64_native_array(self)
    ...
    def _get_variables_2d_int32_native_array(self) -> ArrayOfVariable2D_Int32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variables_2d_int32_native_array(self)
