...
def export_all_variables_in_group(source_run_directory, source_run_name, source_group_name, mat_file_path):
    ...
    try:
        ...
        print("\nSuccessfully exported all variables in output group '" + source_group_name + "' to " + mat_file_path)
...
# 1D group
export_all_variables_in_group(source_run_directory, source_run_name, "Hub loads: rotating GL coordinates", os.path.join(output_directory, "Hub_Loads.mat"))

# 2D group - numeric secondary axis
export_all_variables_in_group(source_run_directory, source_run_name, "Blade 1 Loads: Principal axes", os.path.join(output_directory, "Blade_1_Loads.mat"))

# 2D group - labelled string secondary axis
export_all_variables_in_group(source_run_directory, source_run_name, "Tower member loads - local coordinates", os.path.join(output_directory, "Tower_Member_Loads.mat"))

# 1D + 2D variables
export_selected_variables(source_run_directory, source_run_name, "Rotating hub Mx", "Tower Mx", os.path.join(output_directory, "RotatingHubMx_TowerMx.mat"))
