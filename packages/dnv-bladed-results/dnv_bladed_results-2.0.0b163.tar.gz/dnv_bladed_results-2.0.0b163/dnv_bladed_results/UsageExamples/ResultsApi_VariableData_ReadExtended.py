...
for type_specifier in data_type_specifiers:
    ...
    get_data_for_2d_variable(run_directory, run_name, "blade 1 mx (principal axes)")
...
get_data_for_2d_variable_at_specific_independent_variable_value(run_directory, run_name, "blade 1 mx (principal axes)", 4.8400002, 1)
