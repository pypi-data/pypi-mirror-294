...
from witchie.cache import cache_status
...
class Account:
    ...
    @staticmethod
    def __post_prepare__(obj: Dict, cache: bool = False) -> Dict:
    ...
    def note_plaintext(self) -> str:
        return '\n'.join(html_to_paragraphs(self.note))
...
def from_dict(cls: Type[T], data: Dict, cache: bool = False) -> T:
