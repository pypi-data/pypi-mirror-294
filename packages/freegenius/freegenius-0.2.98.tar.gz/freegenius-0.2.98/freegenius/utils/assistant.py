...
{files if files else "Not found!"}'''
                ...
                actionPattern = f"@(extract_python_code|run_python_code|list_current_directory_contents|command|append_command|append_prompt|improve_writing|{toolNames})[ \n]"
