            ...
            if userInput.startswith("!"):
                ...
                def runSingleAction(action: str, description: str) -> None:
                    ...
                    if action in ("command", "append_command"):
                        ...
                        description = f'''List directory contents in current directory:\n{os.getcwd()}'''
...
{files if files else "Not found!"}'''
                ...
                actionPattern = f"@(list_current_directory_contents|command|append_command|append_prompt|improve_writing|{toolNames})[ \n]"
