  ...
  <div class="w-full h-full flex flex-col gap-2">
    <div class="compliance-step bg-white w-full border border-transparent rounded-md">
      ...
      <div class="compliance-step-content compliance-status w-full flex p-3 gap-2">
        ...
        <div class="compliance-step-content-el-value py-1 px-3">Approval required</div>
      </div>
    </div>
    <div class="compliance-step bg-white w-full border border-transparent rounded-md">
      <div class="compliance-step-header flex justify-between py-4 px-3">
...
const mockActivity = [{ date: new Date().toDateString(), description: 'Admin Edit Session: End. dasjh djkash djkhas jkhdjkas hdkhas dhjkashdkjash kjdh askj dhjkas kdhaskjh dklashdksakjdhkjasdhkjasdkjhaskdaskjdh' },
