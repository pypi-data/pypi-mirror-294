...
class TaskCreateRequest(object):
    ...
    def __init__(self, type=None, title=None, priority=None, data=None, task_catalog_name=None, external_tag=None, tags=None, parent_operation_id=None, _configuration=None):  # noqa: E501
    ...
    def parent_operation_id(self):
        """Gets the parent_operation_id of this TaskCreateRequest.  # noqa: E501

        Operation id which created the task.  # noqa: E501

        :return: The parent_operation_id of this TaskCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_operation_id(self, parent_operation_id):
        """Sets the parent_operation_id of this TaskCreateRequest.

        Operation id which created the task.  # noqa: E501

        :param parent_operation_id: The parent_operation_id of this TaskCreateRequest.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
