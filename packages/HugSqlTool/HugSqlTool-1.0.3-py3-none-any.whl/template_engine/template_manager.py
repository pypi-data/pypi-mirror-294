...
def start_construct_tag_template(config_dict):
    ...
    tempalte_path = '/HugSqlTools/template_engine/tag_templates/offline'
    if template_type == 1:
        tempalte_path = '/HugSqlTools/template_engine/tag_templates/offline'
    elif template_type == 2:
        tempalte_path = '/HugSqlTools/template_engine/tag_templates/nrt'
    else :
...
############################################################################################################################
    ...
    final_path='/Users/zhangyi10_dxm/HugSqlTemplate/tag_templates/nrt'
    output_path='/Users/zhangyi10_dxm/HugSqlTemplate/dw/ads/tag/index_06_nrt/%s' %(config_dict['tag_code'])
