        ...
        for i in samples_to_plot:
                ...
                for j in mask:
                    ...
                    if file_data[j][2] in specimen_mask:
                        ...
                        if deriv0:
                            ...
                            shiny_de.append( np.array( data[1] )[temp_mask].tolist() )
                            shiny_de.append( np.array( data[3][j] )[temp_mask].tolist() )
            ...
            if mean:
                ...
                if deriv0:
                    ...
                    shiny_de.append( np.array( data[1] )[temp_mask].tolist() )
                    shiny_de.append( np.array( data[5][index] )[temp_mask].tolist() )
