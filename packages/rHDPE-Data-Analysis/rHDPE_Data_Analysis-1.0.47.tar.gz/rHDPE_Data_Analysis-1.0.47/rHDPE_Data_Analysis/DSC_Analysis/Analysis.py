...
def DSC_Analysis_Main( ip ):
    ...
    if ip.plot_data:
        ...
        DSC_plotting.plot_data( ip.directory, ip.output_directory, file_data, data, first_derivative_data, second_derivative_data, ip.shiny, ip.shiny_samples_to_plot, ip.shiny_split, ip.shiny_cryst, ip.shiny_melt, ip.shiny_specimen, ip.shiny_mean )
