...
class RunwayWindComponents:
    def __init__(self, rwy_direction_true_north_rounded10):
        self.rwy_direction_true_north_rounded10 = rwy_direction_true_north_rounded10
    ...
    def _define_cross_tail_wind_directions(self):
        ...
        # TAILWIND LEFT SIDE
        tailwind_central_direction = (self.rwy_direction_true_north_rounded10 + 180) % 360
        ...
        index_of_direction = rwy_directions_list_anticlockwise.index(self.rwy_direction_true_north_rounded10)
        ...
        # crosswind front left starts 1 position in the list from the rwy_direction_true_north_rounded10 index onwards, since the RWY direction itself is headwind, no crosswind
        ...
        index_of_direction = rwy_directions_list_clockwise.index(self.rwy_direction_true_north_rounded10)
        ...
        # crosswind front right starts 1 position in the list from the rwy_direction_true_north_rounded10 index onwards, since the RWY direction itself is headwind, no crosswind
    ...
    def calculate_cross_tail_head_wind(self, wind_direction_true_north_rounded10, wind_speed):
        (tailwind_directions, crosswind_directions_front_leftside, crosswind_directions_back_leftside, crosswind_directions_front_rightside, crosswind_directions_back_rightside) = self.cross_tail_wind_directions

        # DETERMINE CROSSWIND ANGLE
        if wind_direction_true_north_rounded10 in crosswind_directions_front_leftside:
            position_in_list = (crosswind_directions_front_leftside.index(wind_direction_true_north_rounded10) + 1)
        ...
        elif wind_direction_true_north_rounded10 in crosswind_directions_back_leftside:
            position_in_list = (crosswind_directions_back_leftside.index(wind_direction_true_north_rounded10) + 1)
            crosswind_angle = position_in_list * 10
        elif (wind_direction_true_north_rounded10 in crosswind_directions_front_rightside):
            position_in_list = (crosswind_directions_front_rightside.index(wind_direction_true_north_rounded10) + 1)
            crosswind_angle = position_in_list * 10
        elif wind_direction_true_north_rounded10 in crosswind_directions_back_rightside:
            position_in_list = (crosswind_directions_back_rightside.index(wind_direction_true_north_rounded10) + 1)
            crosswind_angle = position_in_list * 10
        else:
            crosswind_angle = 0
        ...
        if wind_direction_true_north_rounded10 in tailwind_directions:
        ...
        return (crosswind_angle, crosswind_speed, tailwind_headwind, tailwind_speed, headwind_speed)
