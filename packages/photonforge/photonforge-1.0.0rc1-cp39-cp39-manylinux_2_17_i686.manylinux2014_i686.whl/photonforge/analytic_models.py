...
from .tidy3d_model import _Tidy3DModeSolverRunner
...
class ModelResult:
    ...
    def __init__(self, s_matrix: SMatrix, status: Optional[dict[str, Any]] = None):
...
class TerminationModel(Model):
    ...
    def __init__(self, r: _ComplexArray = 0):
        super().__init__(r=r)
...
class _WaveguideModelRunner:
    def __init__(self, runner, free_space_phase, frequencies, ports):
        self.runner = runner
...
class WaveguideModel(Model):
    ...
    def start(self, component: Component, frequencies: Sequence[float], **kwargs) -> Any:
        ...
        if self.coeff is None:
            ...
            runner = _Tidy3DModeSolverRunner(
