...
_gdsii_safe_chars = set("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_?$")
...
def _filename_cleanup(s, strict=True, max_length=64):
    if strict:
...
def _suffix_from_args(*args, **kwargs):
    suffix = ""
...
def parametric_component(
    decorated_function: Callable = None,
