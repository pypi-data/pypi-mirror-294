...
class KritenCluster(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:kriten:kritencluster', args=[self.pk])
...
class KritenRunner(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:kriten:kritenrunner', args=[self.pk])
...
class KritenTask(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:kriten:kritentask', args=[self.pk])
...
class KritenJob(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:kriten:kritenjob', args=[self.pk])