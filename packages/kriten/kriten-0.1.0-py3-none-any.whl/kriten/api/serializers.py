...
class NestedKritenClusterSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:kriten-api:kritencluster-detail'
    )
...
class NestedKritenRunnerSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:kriten-api:kritenrunner-detail'
    )

    class Meta:
        model = KritenTask
        fields = ('id', 'url', 'display', 'name', 'branch', 'giturl', 'image')
        
        
class NestedKritenTaskSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:kriten-api:kritentask-detail'
    )

    class Meta:
        model = KritenTask
        fields = ('id', 'url', 'display', 'name', 'runner', 'command', 'secrets', 'schema', 'synchronous')
...
class NestedKritenJobSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:kriten-api:kritenjob-detail'
    )
...
class KritenRunnerSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = KritenRunner
        fields = (
            'id', 'url', 'kriten_cluster', 'display', 'name', 'branch', 'giturl', 'image'
        )
...
class KritenTaskSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = KritenTask
        fields = (
            'id', 'url', 'kriten_cluster', 'display', 'name', 'runner', 'command', 'secrets', 'schema', 'synchronous'
        )
