...
class WASDHandler(tk.Frame):
    ...
    def onW(self, event):
        self.pycoordHandle.relativePos(x= [self.pycoordHandle._postocounts(self.steps.get()),self.pycoordHandle._postocounts(self.speed.get())])

    def onA(self, event):
        self.pycoordHandle.relativePos(y= [-self.pycoordHandle._postocounts(self.steps.get()),self.pycoordHandle._postocounts(self.speed.get())])
    ...
    def onE(self, event):
        self.pycoordHandle.relativePos(z= [-self.pycoordHandle._postocounts(self.steps.get()),self.pycoordHandle._postocounts(self.speed.get())])
