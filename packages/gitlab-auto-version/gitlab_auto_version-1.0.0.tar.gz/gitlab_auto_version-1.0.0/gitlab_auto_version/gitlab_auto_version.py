...
def create_tag(version, tag_name=None):
    ...
    try:
        ...
        # Construct the remote URL with the Deploy Token using 'oauth2'
        remote_url = f"https://oauth2:{deploy_token}@{os.getenv('CI_SERVER_HOST')}/{os.getenv('CI_PROJECT_PATH')}.git"
