...
from egstudio.app.models.project import Project, PROJECT_STYLES
...
from egstudio.app.utils import events, permissions, fields

from egstudio.app.blueprints.crud.base import BaseModelResource, BaseModelsResource

from egstudio.app.services.exception import ArgumentsException
