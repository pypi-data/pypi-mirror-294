from egstudio.app.blueprints.crud.base import BaseModelsResource, BaseModelResource
...
from egstudio.app.services import user_service, tasks_service, files_service
from egstudio.app.utils import permissions
