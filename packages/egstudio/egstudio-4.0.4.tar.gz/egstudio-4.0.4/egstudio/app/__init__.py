...
from egstudio.app import config, swagger
...
from egstudio.app.utils import cache, fs, logs, monitoring
from egstudio.app.utils.flask import ParsedUserAgent, ORJSONProvider
...
def configure_auth():
    from egstudio.app.services import persons_service
