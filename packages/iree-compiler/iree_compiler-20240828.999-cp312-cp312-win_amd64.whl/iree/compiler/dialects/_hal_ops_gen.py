...
class CommandBufferCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, result, device, modes, command_categories, queue_affinity, *, binding_capacity=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def command_buffer_create(result, device, modes, command_categories, queue_affinity, *, binding_capacity=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CommandBufferCreateOp(result=result, device=device, modes=modes, command_categories=command_categories, queue_affinity=queue_affinity, binding_capacity=binding_capacity, loc=loc, ip=ip))
...
def command_buffer_update_buffer(command_buffer, source_buffer, source_size, source_offset, target_buffer, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferUpdateBufferOp(command_buffer=command_buffer, source_buffer=source_buffer, source_size=source_size, source_offset=source_offset, target_buffer=target_buffer, target_offset=target_offset, length=length, loc=loc, ip=ip))
...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_806')) else
      _ods_ir.AttrBuilder.get('anonymous_806')(function_type, context=_ods_context))
...
class ExecutableCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, result, device, executable_target, constants, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def executable_create(result, device, executable_target, constants, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ExecutableCreateOp(result=result, device=device, executable_target=executable_target, constants=constants, loc=loc, ip=ip))
...
def interface_binding_subspan(result, layout, binding, dynamic_dims, *, byte_offset=None, alignment=None, descriptor_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InterfaceBindingSubspanOp(result=result, layout=layout, binding=binding, dynamic_dims=dynamic_dims, byte_offset=byte_offset, alignment=alignment, descriptor_flags=descriptor_flags, loc=loc, ip=ip))
...
def interface_constant_load(result, layout, ordinal, *, alignment=None, values=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InterfaceConstantLoadOp(result=result, layout=layout, ordinal=ordinal, alignment=alignment, values=values, loc=loc, ip=ip))
...
class TensorAliasOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, source_dims, storage, *, wait_fence=None, affinity=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def tensor_alias(result, source, source_dims, storage, *, wait_fence=None, affinity=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TensorAliasOp(result=result, source=source, source_dims=source_dims, storage=storage, wait_fence=wait_fence, affinity=affinity, loc=loc, ip=ip))
...
def tensor_export(target, source, source_encoding, source_dims, *, name=None, affinity=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TensorExportOp(target=target, source=source, source_encoding=source_encoding, source_dims=source_dims, name=name, affinity=affinity, loc=loc, ip=ip))
...
def tensor_import(target, source, target_encoding, target_dims, *, wait_fence=None, name=None, affinity=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TensorImportOp(target=target, source=source, target_encoding=target_encoding, target_dims=target_dims, wait_fence=wait_fence, name=name, affinity=affinity, loc=loc, ip=ip))
