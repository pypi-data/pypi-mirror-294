...
class GPUFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, workgroup_attrib_attrs=None, private_attrib_attrs=None, known_block_size=None, known_grid_size=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_566')) else
      _ods_ir.AttrBuilder.get('anonymous_566')(function_type, context=_ods_context))
...
class SubgroupReduceOp(_ods_ir.OpView):
  ...
  def __init__(self, value, op, *, uniform=None, cluster_size=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def subgroup_reduce(value, op, *, uniform=None, cluster_size=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SubgroupReduceOp(value=value, op=op, uniform=uniform, cluster_size=cluster_size, loc=loc, ip=ip))
