...
import os
import re
from typing import Any, Generic, Optional, Union, cast, ClassVar
...
class PyTorchBitfountModel(
    ...
    def test_epoch_end(
        self,
        outputs: list[dict[str, Union[torch.Tensor, list[str]]]],  # type: ignore[override] # Reason: see below # noqa: B950
    ) -> None:
