...
def delegates(
    ...
    def _decorate_class(klass: _C) -> _C:
        ...
        from_klass = klass.__init__  # type: ignore[misc] # Reason: just "unsound" not impossible ('Accessing "__init__" on an instance is unsound, since instance.__init__ could be from an incompatible subclass') # noqa: B950
