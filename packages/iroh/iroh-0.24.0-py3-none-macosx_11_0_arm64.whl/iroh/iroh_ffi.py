...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_iroh_ffi_checksum_method_blobs_list_incomplete() != 31740:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_blobs_read_at_to_bytes() != 29675:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class BlobsProtocol(typing.Protocol):
    ...
    def list_incomplete(self, ):
        ...
        raise NotImplementedError
    def read_at_to_bytes(self, hash: "Hash",offset: "int",len: "typing.Optional[int]"):
        """
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def read_at_to_bytes(self, hash: "Hash",offset: "int",len: "typing.Optional[int]") -> "bytes":
        """
        Read all bytes of single blob at `offset` for length `len`.
...
class NodeOptions:
    ...
    def __init__(self, *, gc_interval_millis: "typing.Optional[int]", blob_events: "typing.Optional[BlobProvideEventCallback]"):
        self.gc_interval_millis = gc_interval_millis
        self.blob_events = blob_events

    def __str__(self):
        return "NodeOptions(gc_interval_millis={}, blob_events={})".format(self.gc_interval_millis, self.blob_events)
