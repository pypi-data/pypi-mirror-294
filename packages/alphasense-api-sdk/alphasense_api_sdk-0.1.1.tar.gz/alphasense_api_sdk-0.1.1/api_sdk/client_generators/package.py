...
class PackageGenerator:
    def __init__(
        ...
        auth_path: str = DEFAULT_AUTH_PATH.as_posix(),
        client_config_path: str = DEFAULT_CLIENT_CONFIG_PATH.as_posix(),
    ...
    def _copy_files(self):
        files_to_copy = (
            ...
            + [self.auth_path, self.client_config_path]
        )
...
def get_package_generator(
    ...
    return PackageGenerator(
        ...
        client_config_path=settings.client_config_path,
