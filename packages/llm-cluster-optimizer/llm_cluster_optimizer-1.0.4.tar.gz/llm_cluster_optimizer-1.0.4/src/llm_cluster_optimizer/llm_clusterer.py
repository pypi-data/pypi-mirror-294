...
class LLMClusterOptimizer:
    ...
    def __init__(self, cluster_model: ClusterMixinOrCallable,
                 ...
                 recluster_threshold_fn: Callable[[int], int] = None,
        ...
        :param recluster_threshold_fn: Function that takes the number of input texts and outputs the minimum size cluster that will be reclustered using `cluster_model`. If not provided, the minimum size is the square root of input size (implying uniform distribution of cluster sizes)
        ...
        self._recluster_threshold_fn = recluster_threshold_fn or (lambda x: round(math.sqrt(x)))
