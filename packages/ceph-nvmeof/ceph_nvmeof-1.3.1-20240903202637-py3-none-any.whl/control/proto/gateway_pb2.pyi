...
class add_host_req(_message.Message):
    __slots__ = ["host_nqn", "psk", "subsystem_nqn"]
    ...
    psk: str
    subsystem_nqn: str
    def __init__(self, subsystem_nqn: _Optional[str] = ..., host_nqn: _Optional[str] = ..., psk: _Optional[str] = ...) -> None: ...
...
class connection(_message.Message):
    __slots__ = ["adrfam", "connected", "controller_id", "nqn", "qpairs_count", "secure", "traddr", "trsvcid", "trtype", "use_psk"]
    ...
    trtype: str
    use_psk: bool
    def __init__(self, nqn: _Optional[str] = ..., traddr: _Optional[str] = ..., trsvcid: _Optional[int] = ..., trtype: _Optional[str] = ..., adrfam: _Optional[_Union[AddressFamily, str]] = ..., connected: bool = ..., qpairs_count: _Optional[int] = ..., controller_id: _Optional[int] = ..., secure: bool = ..., use_psk: bool = ...) -> None: ...
...
class host(_message.Message):
    __slots__ = ["nqn", "use_psk"]
    NQN_FIELD_NUMBER: _ClassVar[int]
    USE_PSK_FIELD_NUMBER: _ClassVar[int]
    nqn: str
    use_psk: bool
    def __init__(self, nqn: _Optional[str] = ..., use_psk: bool = ...) -> None: ...
