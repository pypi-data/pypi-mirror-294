...
class Database(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Database that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.95.0/docs/resources/database#import import section} in the documentation of this resource for the id to use
...
class DatabaseReplicationEnableToAccount:
    def __init__(
        ...
        *,
        ...
        '''
        :param account_identifier: Specifies account identifier for which replication should be enabled. The account identifiers should be in the form of ``"<organization_name>"."<account_name>"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.95.0/docs/resources/database#account_identifier Database#account_identifier}
        :param with_failover: Specifies if failover should be enabled for the specified account identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.95.0/docs/resources/database#with_failover Database#with_failover}
        '''
        if __debug__:
