...
class AccountParameter(
    ...
    def __init__(
        ...
        *,
        ...
        :param key: Name of account parameter. Valid values are those in `account parameters <https://docs.snowflake.com/en/sql-reference/parameters.html#account-parameters>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.95.0/docs/resources/account_parameter#key AccountParameter#key}
        :param value: Value of account parameter, as a string. Constraints are the same as those for the parameters in Snowflake documentation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.95.0/docs/resources/account_parameter#value AccountParameter#value}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AccountParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.95.0/docs/resources/account_parameter#import import section} in the documentation of this resource for the id to use
