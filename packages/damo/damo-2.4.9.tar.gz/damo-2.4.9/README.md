...
![masim stairs heatmap in ascii](https://raw.githubusercontent.com/damonitor/damo/v2.4.9/images/masim_stairs_heatmap_ascii.png)
...
For more detailed usage, please refer to [USAGE.md](https://github.com/damonitor/damo/blob/v2.4.9/USAGE.md) file.
...
Why some features are not documented on [USAGE.md](https://github.com/damonitor/damo/blob/v2.4.9/USAGE.md) file?
------------------------------------------------------------------
