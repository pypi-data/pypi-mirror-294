...
class FabricLakehouseLocation:
    ...
    def abfss_path(self, path=None):
        ...
        """
        if path:
            return f'abfss://{self._workspace}@onelake.dfs.fabric.microsoft.com/{self._lakehouse}.Lakehouse/{path}'
        return f'abfss://{self._workspace}@onelake.dfs.fabric.microsoft.com/{self._lakehouse}.Lakehouse'
