...
class FabricDataInterface:
    ...
    def loadDeltaLakeTable(self, sourceID, ingestionConfigurationLocation, stage='RAW'):
        """
        ...
        table_location = FabricTableLocation(table_name, FabricLakehouseLocation(stage, workspace_id, lakehouse_id))

        return self.loadLatestDeltaTable(table_location)

    def loadLatestDeltaTable(self, fabricTableLocation):
        """
