...
@tool(parse_docstring=False, response_format="content_and_artifact")
def create_document(title: str, state: Annotated[dict, InjectedState]):
...
chatbot_tools = [search, call_supervisor, open_document_editor]
