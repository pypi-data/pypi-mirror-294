...
from pydantic import BaseModel, ConfigDict, Field, field_validator, NonNegativeInt, PositiveFloat, PositiveInt
...
class UpdateDeploymentConfig(BaseModel):
    ...
    cooldown_time: NonNegativeInt | None = Field(
        default=None,
