...
class Info(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_id", "capabilities", "capability_schema"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.capability_schema:
            for _key in self.capability_schema:
                if self.capability_schema[_key]:
                    _field_dict[_key] = self.capability_schema[_key].to_dict()
