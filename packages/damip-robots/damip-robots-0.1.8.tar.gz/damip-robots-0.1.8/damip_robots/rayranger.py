...
class Robot:
    ...
    def aplay(self, voice_file):
        if voice_file == "001":
            voice_file = '/usr/local/voice/mixkit-children-happy-countdown-923.wav'
            pvoice.play(voice_file)
            logging.debug(":) play voice file: " + voice_file)
            return True
        elif voice_file == "002":
            voice_file = '/usr/local/voice/mixkit-repeating-arcade-beep-1084.wav'
            pvoice.play(voice_file)
            logging.debug(":) play voice file: " + voice_file)
            return True
        elif voice_file == "003":
            voice_file = '/usr/local/voice/mixkit-musical-game-over-959.wav'
            pvoice.play(voice_file)
            logging.debug(":) play voice file: " + voice_file)
            return True
        else:
