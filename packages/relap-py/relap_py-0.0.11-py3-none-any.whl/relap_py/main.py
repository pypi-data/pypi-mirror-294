...
#▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
def make_strip(input_variables_file: Union(pd.DataFrame, str), strip_filename: str, type="fmtout"):
...
def print_ss(case, exp, llista= False, end_ss = 0, lenght = 60):
    ...
    def avg_ss(var):
        ...
        """
        i = 0
        while case['time'][i] < (end_ss - lenght):
             index_start = i
             i += 1
        while case['time'][i] < end_ss:
            index_end = i
            i += 1
        return sum(case[var][index_start:index_end]) / (index_end - index_start)
    dash = '-' * 50
    print(dash)
    print('{:<20s}{:>8s}{:>18s}'.format('variable', 'calc', 'experiment'))
    print(dash)
    for var in llista: 
        print('{:<20s}{:>8E}{:>18E}'.format(var, avg_ss(var), avg_ss(var)))
    print(dash)
