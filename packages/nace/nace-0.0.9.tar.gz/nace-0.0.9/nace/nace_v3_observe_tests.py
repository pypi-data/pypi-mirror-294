...
class TestObserveFunction(unittest.TestCase):
    ...
    def test_observe_basic(self, mock_contradicted, mock_observed, mock_match, mock_confirmed, mock_valid, mock_build):
        ...
        rule_evidence = {((left, (0,), (0, 0, ' '), (0, 1, 'x')), (0, 0, 'x', (0, 0))): (1, 0), ((up, (0,), (0, 0, ' '), (1, 0, 'x')), (0, 0, 'x', (0, 0))): (1, 0), ((right, (0,), (0, -1, 'x'), (0, 0, ' ')), (0, 0, 'x', (0, 0))): (1, 0), ((down, (0,), (-1, 0, 'x'), (0, 0, ' ')), (0, 0, 'x', (0, 0))): (1, 0), ((left, (0,), (0, -1, ' '), (0, 0, 'x')), (0, 0, ' ', (0, 0))): (1, 0), ((up, (0,), (-1, 0, ' '), (0, 0, 'x')), (0, 0, ' ', (0, 0))): (1, 0), ((right, (0,), (0, 0, 'x'), (0, 1, ' ')), (0, 0, ' ', (0, 0))): (1, 0), ((down, (0,), (0, 0, 'x'), (1, 0, ' ')), (0, 0, ' ', (0, 0))): (1, 0), ((left, (0,), (0, 0, 'o'), (0, 1, 'x')), (0, 0, 'o', (0, 0))): (1, 0), ((up, (0,), (0, 0, 'o'), (1, 0, 'x')), (0, 0, 'o', (0, 0))): (1, 0), ((right, (0,), (0, -1, 'x'), (0, 0, 'o')), (0, 0, 'o', (0, 0))): (1, 0), ((down, (0,), (-1, 0, 'x'), (0, 0, 'o')), (0, 0, 'o', (0, 0))): (1, 0), ((right, (0,), (0, 0, 'x'), (0, 1, 'u')), (0, 0, 'u', (0, 0))): (1, 0), ((down, (0,), (0, 0, 'x'), (1, 0, 'u')), (0, 0, 'u', (0, 0))): (1, 0), ((left, (0,), (0, -1, 'u'), (0, 0, 'x')), (0, 0, 'u', (0, 0))): (2, 0), ((up, (0,), (-1, 0, 'u'), (0, 0, 'x')), (0, 0, 'u', (0, 0))): (1, 0), ((left, (0,), (0, 0, 'u'), (0, 1, 'x')), (0, 0, 'x', (0, 0))): (1, 0), ((up, (0,), (0, 0, 'u'), (1, 0, 'x')), (0, 0, 'x', (0, 0))): (1, 0), ((right, (0,), (0, -1, 'x'), (0, 0, 'u')), (0, 0, 'x', (0, 0))): (1, 0), ((down, (0,), (-1, 0, 'x'), (0, 0, 'u')), (0, 0, 'x', (0, 0))): (1, 0)}
        oldworld = MagicMock()
        ...
        oldrules = {((up, (0,), (0, 0, 'o'), (1, 0, 'x')), (0, 0, 'o', (0, 0))), ((down, (0,), (-1, 0, 'x'), (0, 0, ' ')), (0, 0, 'x', (0, 0))), ((up, (0,), (-1, 0, ' '), (0, 0, 'x')), (0, 0, ' ', (0, 0))), ((right, (0,), (0, 0, 'x'), (0, 1, 'u')), (0, 0, 'u', (0, 0))), ((up, (0,), (0, 0, 'u'), (1, 0, 'x')), (0, 0, 'x', (0, 0))), ((right, (0,), (0, -1, 'x'), (0, 0, 'u')), (0, 0, 'x', (0, 0))), ((right, (0,), (0, -1, 'x'), (0, 0, ' ')), (0, 0, 'x', (0, 0))), ((right, (0,), (0, 0, 'x'), (0, 1, ' ')), (0, 0, ' ', (0, 0))), ((left, (0,), (0, 0, ' '), (0, 1, 'x')), (0, 0, 'x', (0, 0))), ((down, (0,), (0, 0, 'x'), (1, 0, 'u')), (0, 0, 'u', (0, 0))), ((left, (0,), (0, 0, 'u'), (0, 1, 'x')), (0, 0, 'x', (0, 0))), ((up, (0,), (0, 0, ' '), (1, 0, 'x')), (0, 0, 'x', (0, 0))), ((down, (0,), (-1, 0, 'x'), (0, 0, 'o')), (0, 0, 'o', (0, 0))), ((down, (0,), (0, 0, 'x'), (1, 0, ' ')), (0, 0, ' ', (0, 0))), ((right, (0,), (0, -1, 'x'), (0, 0, 'o')), (0, 0, 'o', (0, 0))), ((up, (0,), (-1, 0, 'u'), (0, 0, 'x')), (0, 0, 'u', (0, 0))), ((left, (0,), (0, -1, ' '), (0, 0, 'x')), (0, 0, ' ', (0, 0))), ((left, (0,), (0, 0, 'o'), (0, 1, 'x')), (0, 0, 'o', (0, 0))), ((left, (0,), (0, -1, 'u'), (0, 0, 'x')), (0, 0, 'u', (0, 0))), ((down, (0,), (-1, 0, 'x'), (0, 0, 'u')), (0, 0, 'x', (0, 0)))}
        oldnegrules = []
...
class TestObserveFunction2(unittest.TestCase):
    ...
    calculated_focus_set, calculated_rule_evidence, calculated_new_rules, calculated_new_negrules = _observe(
        focus_set, rule_evidence, oldworld, action, newworld, oldrules, oldnegrules,
        newworld, pre_action_agent=old_agent, ground_truth_post_action_agent=new_agent, unobserved_code='.', object_count_threshold=1
    )
