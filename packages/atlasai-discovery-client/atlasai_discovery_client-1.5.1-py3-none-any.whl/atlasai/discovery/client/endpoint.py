...
DEFAULT_WRITE_RETRIES_STATUS_LIST = [429, 503]
...
@cached(cache=TTLCache(maxsize=10, ttl=300), lock=Lock())
def _get_requests_session(enable_read_retries, enable_write_retries):
...
def get_requests_session():
    ...
    return _get_requests_session(enable_read_retries, enable_write_retries)
