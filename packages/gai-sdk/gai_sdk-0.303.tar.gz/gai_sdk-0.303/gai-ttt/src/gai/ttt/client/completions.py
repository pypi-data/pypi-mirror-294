...
class Completions:
    ...
    def _generate_dict(self, **kwargs):
        ...
        url = kwargs.pop("url")
        try:
            response = http_post(url, data={**kwargs})
    ...
    """
    def _create(self, url:str, messages:list, stream:bool, max_new_tokens:int, temperature:float=None, top_p:float=None, top_k:float=None, json_schema:dict=None, tools:list=None, tool_choice:str=None, stop_conditions:list=None):
