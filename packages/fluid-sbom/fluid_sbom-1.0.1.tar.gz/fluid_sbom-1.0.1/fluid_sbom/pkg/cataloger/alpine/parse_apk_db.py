...
def parse_package(package: str) -> ParsedData:
    data: dict[str, str] = {}
...
def update_context_with_line(
    ...
    match key:
        case "F":
            ctx.files.append(ApkFileRecord(os.path.join("/", value)))
        ...
        case "R":
            ...
            ctx.files.append(ApkFileRecord(regular_file))
