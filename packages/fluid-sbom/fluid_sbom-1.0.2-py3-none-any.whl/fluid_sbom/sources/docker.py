...
# Define the NamedTuple classes with lowercase fields
...
# Custom object hook to convert JSON dictionaries to NamedTuples
def custom_object_hook(json_object: dict[str, Any]) -> ImageMetadata | dict:
    if (
        ...
        # Convert 'LayersData' to list of LayerData NamedTuples
        layersdata = [
            LayerData(
        ...
        # Convert to ImageMetadata NamedTuple
...
def get_docker_image(
    ...
    *,
    ...
    try:
        ...
        if image_metadata:
            image_metadata = image_metadata._replace(image_ref=image_ref)
