...
def get_parent_information(parent: Tag) -> tuple[str, str, str]:
    """Extract parent artifact information."""
    parent_group_id = parent.find_next("groupid").get_text()
    parent_artifact_id = parent.find_next("artifactid").get_text()
    parent_version = parent.find_next("version").get_text()
