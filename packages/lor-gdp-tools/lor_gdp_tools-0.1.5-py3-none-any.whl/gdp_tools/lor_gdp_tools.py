...
class GlobalDataPlatformTools():
    ...
    def __init__(self,):
        ...
        self.SERVER = 'az-sql-gdp-prod-uks.database.windows.net' 
        self.DATABASE = 'az-syn-gdp-prod-uks' # Location of Synapse
        self.USERNAME = 'drumble_adm_sql' # load from config
        self.PASSWORD = 'X!2eLtGdRaCqdPaN9Rn94X' # load from config
