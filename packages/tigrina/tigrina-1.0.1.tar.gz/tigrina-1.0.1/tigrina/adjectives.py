from tigrina.tgalphabets import extract_alphabets as get_alphabet_info
from tigrina.code_decode import code_decode_info
...
def make_stem_adjective(text):
    ...
    if len(text) == 2 or len(text) == 1 or len(text) == 0:
        ...
        indexOfFirstLetterInAlphabet = alphabet_info['tigrina_alphabets'].index(lettersToBeConverted2[0])
        indexOfSecondLetterInAlphabet = alphabet_info['tigrina_alphabets'].index(lettersToBeConverted2[1])
        indexOfFromLettersNotToBeConverted = alphabet_info['tigrina_alphabets'].index(lettersNotToBeConverted2[0])
        firstLetterChoices = []
        firstLetterAfterConverstion = []
        secondLetterAfterConverstion = []

        # get_alphabet_info.get_alphabet(indexOfFromLettersNotToBeConverted,function(error,result){
        #     firstLetterChoices.push(result.sixth)
        #     lettersNotToBeConverted2.splice(0,1)
        # })
        # get_alphabet_info.get_alphabet(indexOfFirstLetterInAlphabet,function(error,result){
        #     firstLetterAfterConverstion.push(result.second)
        # })
        # get_alphabet_info.get_alphabet(indexOfSecondLetterInAlphabet,function(error,result){
        #     secondLetterAfterConverstion.push(result.sixth)
        # })
        print("lettersNotToBeConverted2[0]::",lettersNotToBeConverted2[0])
        ...
        print("firstLetterChoices:",firstLetterChoices)
        print("lettersNotToBeConverted2:",lettersNotToBeConverted2)
        print("firstLetterAfterConverstion:",firstLetterAfterConverstion)
        print("secondLetterAfterConverstion:",secondLetterAfterConverstion)
