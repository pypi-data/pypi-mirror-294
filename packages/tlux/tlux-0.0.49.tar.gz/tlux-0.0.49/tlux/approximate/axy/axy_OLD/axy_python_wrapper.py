...
class axy:
    ...
    def new_model_config(self, adn, mdn, mdo, noe, ade=None, ane=None, ads=None, ans=None, ado=None, mde=None, mne=None, mds=None, mns=None, doe=None, num_threads=None):
