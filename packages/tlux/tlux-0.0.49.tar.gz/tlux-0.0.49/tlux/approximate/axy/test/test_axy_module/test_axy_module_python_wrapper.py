...
_ordered_dependencies = ['pcg32.f90', 'axy_profiler.f90', 'axy_random.f90', 'axy_matrix_operations.f90', 'axy_sort_and_select.f90', 'axy.f90', 'test_axy_module_c_wrapper.f90']
_symbol_files = []# 
# --------------------------------------------------------------------
#               AUTO-COMPILING
#
