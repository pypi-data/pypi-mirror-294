...
class SpanNerTokenizer(PreTrainedTokenizerBase):
    ...
    def get_collate_fn(self) -> Optional[Callable]:
        ...
        return DataCollatorForSpanNer(tokenizer=self, ignore_list=ignore_list)


class BertSpanNerTokenizer(BertTokenizerFast, SpanNerTokenizer):
    ...


class RoFormerSpanNerTokenizer(RoFormerTokenizerFast, SpanNerTokenizer):
    ...
