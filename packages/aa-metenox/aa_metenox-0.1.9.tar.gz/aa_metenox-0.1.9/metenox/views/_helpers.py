...
def corporation_details_button_html(holding: HoldingCorporation) -> str:
    """
    Returns an HTML button to display the modal with corporation details
    """

    return generic_details_button_html(
        holding,
        "metenox:corporation_details",
        "Corporation details",
        "modalCroporationDetails",
        "fas fa-building",
    )
