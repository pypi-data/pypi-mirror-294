...
class STM:
    ...
    def get_avg_current(self, height, bottom=False):
        ...
        # I don't understand this part. It is not a average but max-min
    ...
    def scan_current(self, height=None, **kwargs):
        ...
        if kwargs['plot']:
            self.plot(x, y, heights, reverse=kwargs['bottom'], absolute=True)
        return x, y, heights
    ...
    def scan_height(self, height=None, **kwargs):
        if height is None:
            height = 2
        if kwargs['bottom']:
            height = self.atoms.positions[:, 2].min() - height
    ...
    def scan(self, scan_mode='constant_current', height=None, **kwargs):
        ...
        data = scan_func(height=height, **default_kwargs)
        return data
