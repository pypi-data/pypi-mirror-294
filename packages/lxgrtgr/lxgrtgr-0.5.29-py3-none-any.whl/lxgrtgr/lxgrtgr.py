...
### imports ####################################
version = "0.0.5.29"
version_notes = "0.0.5.29 - prepare for Python packaging"
...
# nominal_stop = files('').joinpath('nom_stop_list_edited.txt').read_text().strip().split("\n")
# prepVerbList = files('').joinpath('prepVerbList.txt').read_text().strip().split("\n")
...
def countTagsFile(fname,tagList = None): #need to add this to lxgrtgr
	if tagList == None:
