...
import barcode.prob.PCRMatrixProb;
import barcode.prob.PCRMatrixProbAbstract;
import barcode.prob.PCRMatrixTile;
...
//			return new PCRMatrixProb_old(length1_, length2_, delimiter_, hdistSum_);
	...
	public static boolean parseStatic(String arg, String a, String b){
		...
		if(a.equals("localcounts")){
			...
			PCRMatrixProbAbstract.parseStatic(arg, a, b);
			PCRMatrixHDist_old.parseStatic(arg, a, b);
//			PCRMatrixProb_old.parseStatic(arg, a, b);
		}else{
			return false;
		}
		return true;
	...
	public static void postParseStatic(){
		...
		PCRMatrixHDist_old.postParseStatic();
//		PCRMatrixProb_old.postParseStatic();
