...
//	public ByteBuilder append(double x, int places){return append(String.format(Locale.ROOT, decimalFormat[places], x));}
	...
	public ByteBuilder appendSlow(float x, int decimals){return append(String.format(Locale.ROOT, "%."+decimals+"f", x));}
	public ByteBuilder appendSlow(double x, int decimals){return append(String.format(Locale.ROOT, "%."+decimals+"f", x));}
