...
class S3Manager:
    def __init__(self, aws_access_key_id, aws_secret_access_key, bucket_name, s3_path, file_name, region_name="ap-northeast-2"):
        """
        S3Manager 객체 초기화
    ...
    def print(self, file_content):
        ...
        """
        try:
            file_content = f"[{time.strftime('%Y.%m.%d - %H:%M:%S')}] {file_content}"
