...
class ZneOp(_ods_ir.OpView):
  ...
  def __init__(self, result, callee, args, folding, scaleFactors, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def zne(result, callee, args, folding, scale_factors, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ZneOp(result=result, callee=callee, args=args, folding=folding, scaleFactors=scale_factors, loc=loc, ip=ip))
