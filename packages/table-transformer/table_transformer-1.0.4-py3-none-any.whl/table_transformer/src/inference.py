...
class TableExtractionPipeline(object):
    ...
    def __call__(self, reader: easyocr.Reader, page_image, page_tokens=[]):
        tables = self.extract(page_image, page_tokens)
        ...
        table_cells_text = list(map(lambda x,y: apply_ocr(reader, x, y), table_imgs, table_cells_coordinates))
