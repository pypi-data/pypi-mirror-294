...
class StixelWorld:
    ...
    def get_pseudo_coordinates(self,
        ...
        if respect_t:
            ...
            point_cloud_camera_homogeneous = np.hstack((np.array(coordinates), ones_column))
            point_cloud_vehicle_homogeneous = (self.camera_info.T @ point_cloud_camera_homogeneous.T).T
            coordinates = point_cloud_vehicle_homogeneous[:, :3]
