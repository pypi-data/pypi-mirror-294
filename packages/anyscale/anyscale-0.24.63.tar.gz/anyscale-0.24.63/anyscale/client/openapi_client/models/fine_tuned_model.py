...
class FineTunedModel(object):
    ...
    def __init__(self, id=None, base_model_id=None, creator_id=None, created_at=None, storage_uri=None, generation_config=None, ft_type=None, cloud_id=None, project_id=None, job_id=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
