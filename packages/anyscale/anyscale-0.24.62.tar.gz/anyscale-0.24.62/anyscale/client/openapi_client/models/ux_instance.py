...
class UXInstance(object):
    ...
    def __init__(self, cpu_count=None, memory_in_gib=None, gpu_type=None, gpu_count=None, cloud_type=None, support_type=None, name=None, family=None, group_key=None, anyscale_credits_per_hour=None, available_in_anyscale_hosted=None, local_vars_configuration=None):  # noqa: E501
