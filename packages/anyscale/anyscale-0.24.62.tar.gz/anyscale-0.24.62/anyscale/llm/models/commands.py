...
from anyscale.client.openapi_client import DeletedPlatformFineTunedModel, FineTunedModel
...
anyscale.llm.models.get(model_id="my-model-id")
anyscale.llm.models.get(job_ib="prodjob_123")
"""
...
anyscale.llm.models.delete(model_id="my-model-id")
"""
...
anyscale.llm.models.list()
anyscale.llm.models.list(cloud_id="cld_123")
anyscale.llm.models.list(project_id="prj_123")
anyscale.llm.models.list(cloud_id="cld_123", project_id="prj_123")
anyscale.llm.models.list(project_id="prj_123", max_items=10)
"""
...
def delete(model_id: str, _sdk: PrivateLLMModelsSDK,) -> DeletedPlatformFineTunedModel:
