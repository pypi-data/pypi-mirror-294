...
def test_get_project_id_for_cloud_from_name(project_test_data: Project) -> None:
    mock_api_client = Mock()
    mock_api_client.find_project_by_project_name_api_v2_projects_find_by_name_get.return_value.results = [
        project_test_data
    ]
    project_id = get_project_id_for_cloud_from_name(
        project_test_data.name, project_test_data.cloud_id, mock_api_client
    )
