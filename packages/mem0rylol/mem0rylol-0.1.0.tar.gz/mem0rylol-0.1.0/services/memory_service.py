...
class MemoryService:
    def __init__(self, config: Config, langchain_client, memory_extraction_service):
        self.config = config
    ...
    async def process_and_store_memory(self, user_id: str, session_id: str, input_text: str, metadata: dict = None):
