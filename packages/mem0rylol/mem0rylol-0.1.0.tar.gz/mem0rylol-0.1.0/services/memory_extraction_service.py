from models.extracted_memory import ExtractedMemory
...
class MemoryExtractionService:
    def __init__(self):
        ...
        config = get_config()  # Get an instance of Config
        self.langchain_client = config.get_langchain_client()
    ...
    async def extract_and_embed_memories(self, user_id: str, session_id: str, input_text: str, metadata: dict = None) -> ExtractedMemory:
