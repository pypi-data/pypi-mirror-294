...
from pymilvus import utility, MilvusClient, Collection, FieldSchema, CollectionSchema, DataType, connections
...
class MemoryModel:
    ...
    async def initialize(self):
        self.milvus_client = await self.config.get_milvus_client()
    ...
    async def store_memory(self, collection_name: str, memory: dict) -> bool:
        try:
