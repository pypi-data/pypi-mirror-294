...
from resemble.admin.export_import_servicer import ExportImportServicer
...
from resemble.v1alpha1 import application_config_pb2, react_pb2, sidecar_pb2
from resemble.v1alpha1.admin import export_import_pb2
...
class _ServiceServer(Server):
    ...
    class ExportImportRoutable(Routable):
        ...
        def service_name(self) -> ServiceName:
            ...
            return ServiceName('resemble.v1alpha1.admin.ExportImport')
