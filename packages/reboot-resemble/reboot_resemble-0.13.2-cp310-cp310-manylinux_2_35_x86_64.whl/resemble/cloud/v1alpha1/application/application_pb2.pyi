...
class UpResponse(google.protobuf.message.Message):
    ...
    @property
    def up_task_id(self) -> resemble.v1alpha1.tasks_pb2.TaskId:
    ...
    def __init__(
        self,
        *,
        up_task_id: resemble.v1alpha1.tasks_pb2.TaskId | None = ...,
        application_id: builtins.str = ...,
    ) -> None: ...
...
class DownResponse(google.protobuf.message.Message):
    ...
    @property
    def down_task_id(self) -> resemble.v1alpha1.tasks_pb2.TaskId:
    ...
    def __init__(
        self,
        *,
        down_task_id: resemble.v1alpha1.tasks_pb2.TaskId | None = ...,
    ) -> None: ...
