...
from layout_detector.VGT_model.layers import ShapeSpec
from layout_detector.VGT_model.structures import Boxes, Instances, pairwise_iou
from layout_detector.VGT_model.utils.events import get_event_storage
from layout_detector.VGT_model.modeling.roi_heads.box_head import FastRCNNConvFCHead
...
class CascadeROIHeads(StandardROIHeads):
    ...
    def _init_box_head(cls, cfg, input_shape):
        ...
        for match_iou, bbox_reg_weights in zip(cascade_ious, cascade_bbox_reg_weights):
            box_head = FastRCNNConvFCHead(cfg, pooled_shape)
