...
from VGT_model.data.detection_utils import get_fed_loss_cls_weights
from VGT_model.layers import ShapeSpec, batched_nms, cat, cross_entropy, nonzero_tuple
from VGT_model.modeling.box_regression import (
    Box2BoxTransform,
    _dense_box_regression_loss,
)
from VGT_model.structures import Boxes, Instances
