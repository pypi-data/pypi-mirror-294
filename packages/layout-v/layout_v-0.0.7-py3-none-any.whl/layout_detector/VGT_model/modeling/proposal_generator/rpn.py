...
from layout_detector.VGT_model.config import configurable
from layout_detector.VGT_model.layers import Conv2d, ShapeSpec, cat
from layout_detector.VGT_model.structures import Boxes, ImageList, Instances, pairwise_iou
from layout_detector.VGT_model.utils.events import get_event_storage
from layout_detector.VGT_model.utils.memory import retry_if_cuda_oom
...
class StandardRPNHead(nn.Module):
    ...
    def from_config(cls, cfg, input_shape):
        ...
        # print("cfg.MODEL.ANCHOR_GENERATOR.NAME: ", cfg.MODEL.ANCHOR_GENERATOR.NAME)
...
class RPN(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["head"] = StandardRPNHead(cfg, [input_shape[f] for f in in_features])
        return ret
