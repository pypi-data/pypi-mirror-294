...
class Backend(Utility.AbstractBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def api_gitlab_job(
            ...
            return JSONResponse(json.dumps(gitlab.main(Token.get_secret_value(), ProjectID, job_name=Job)))
        ...
        def api_gitlab_pipeline(
            ...
            from PyXMake.VTL import gitlab #@UnresolvedImport
            # Execute the command and return the result
            return JSONResponse(json.dumps(gitlab.main(Token.get_secret_value(), ProjectID)))
