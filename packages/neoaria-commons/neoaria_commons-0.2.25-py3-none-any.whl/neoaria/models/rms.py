...
class DefaultAccount(BaseModel):
    ...
    permissions: Dict[str, DefaultPermission] = None
    ...
    def setPermission(self, target_permission: DefaultPermission, department_id: str = 'default' ):
        self.permissions[department_id] = target_permission

    def getPermssion(self, department_id: str = 'default') -> DefaultPermission:
        return self.permissions[department_id]
