...
'''
class _ConstVArray(ExprProxy):
    """EUDVArray suited for constant index access"""
    dont_flatten = True


class _EUDVArray(ExprProxy):
    """EUDVArray suited for sequential access"""
    dont_flatten = True


class EUDVArray:
    __slots__ = ("_size, _basetype")
    ...
    def __call__(self, *args, _const=False, **kwargs):
        if _const:
            return _ConstVArray(*args, **kwargs)
        else:
            return _EUDVArray(*args, **kwargs)
'''
