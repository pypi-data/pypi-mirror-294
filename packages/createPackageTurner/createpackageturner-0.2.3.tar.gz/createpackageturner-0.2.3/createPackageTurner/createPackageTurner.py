...
def createPackageTurner( inputClass , packageName = "na" , packageHousePath = "na", specificPackageFolder="na", pythonAbove="3.6" , author_email='brianbrandonturner@gmail.com', author='Brigham Turner',description="auto generated package from packageMaker" , readme="this package was generated by packageMaker using a class as input that contains functions", publishToPypi = False, pypiUsername="unknown", pypiPassword="unknown" ):
    ...
    def getInfoAboutPackage():
        ...
        def getPackages( inputClass ):
            ...
            return reqs , packagesToImport , reqsMinusPeriods
        reqs , packagesToImport , reqsMinusPeriods = getPackages( inputClass )
        
        return setupLocation, thisVersion, reqs, packagesToImport, reqsMinusPeriods
    setupLocation, thisVersion, reqs, packagesToImport, reqsMinusPeriods = getInfoAboutPackage()
    ...
    if publishToPypi == True:
        ...
        def publishToPypi():
            assert pypiUsername != "unknown"
            assert pypiPassword != "unknown"
            ...
            subprocess.check_call([sys.executable, 'setup.py', 'sdist', 'bdist_wheel']) ## Build the distribution files
