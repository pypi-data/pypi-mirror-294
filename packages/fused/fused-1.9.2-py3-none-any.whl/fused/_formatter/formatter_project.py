...
from fused._formatter.common import format_number, icon, load_static_files
from fused._formatter.formatter_dataset import tables_section
from fused._options import options as OPTIONS

if TYPE_CHECKING:
    from fused.project import Project
...
def fused_project_repr(
    ...
    obj_type = f"fused.Project: {project.base_path}"
