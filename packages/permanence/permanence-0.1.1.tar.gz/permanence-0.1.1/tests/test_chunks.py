...
def test_chunk_roundtrip():
    ...
    with pr.context(Params(1002)):
        ...
        pr.logged(Arty.Binary.Blobfish, b"blorp")
    ...
    with pr_alt.overlayed(read_chunks):
        ...
        assert pr.query(values=Arty.Binary.Blobfish).values().only() == b"blorp"
