...
class pathline_child(Group):
    ...
    child_names = \
        ['name', 'field', 'release_from_surfaces', 'range', 'range_options',
         'style_attribute', 'style_attributes', 'options', 'accuracy_control',
         'option', 'step', 'skip', 'coarsen', 'onzone', 'plot', 'onphysics',
