...
class PlotDataKey:
    ...
    color: Incomplete
    legend: Incomplete
    def __init__(self, _type: PlotDataType, domain: list[int] | list[float] | list[str], tooltip: bool, color: list[str] | None = None, legend: list[str] | None = None) -> None:
...
class XAxis:
    ...
    data_key: Incomplete
    domain: Incomplete
    def __init__(self, orientation: XAxisOrientation, scale: PlotAxisScale, label: str, data_key: str, domain: list[int | float] | None = None) -> None: ...
    def to_json(self): ...
...
class YAxis:
    ...
    data_key: Incomplete
    domain: Incomplete
    def __init__(self, orientation: YAxisOrientation, scale: PlotAxisScale, label: str, data_key: str, domain: list[int | float] | None = None) -> None: ...
    def to_json(self): ...
...
class Plot(Element):
    ...
    :param orientation: The orientation for the plot. Can be "landscape" or "portrait".
    ...
    def __init__(self, title: str, _type: PlotType, x_axis: XAxis, y_axis: YAxis, data: list[PlotDataPoint], has_tooltip: bool, orientation: PlotOrientation, data_keys: dict[str, PlotDataKey], description: str = '', color_by: str | None = None, show_title: bool = True, show_description: bool = True, colors: list[str] | None = None, advanced_tooltip: Callable[[dict], list[Element | str]] | None = None, lines: list[Line] = [], legend: list[str] | None = None, **kwargs) -> None: ...
    def to_json(self): ...
    @staticmethod
