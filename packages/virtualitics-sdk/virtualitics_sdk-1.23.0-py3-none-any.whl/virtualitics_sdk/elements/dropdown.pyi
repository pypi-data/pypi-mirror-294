...
class Dropdown(InputElement):
    ...
    **EXAMPLE**
    ...
    '''
    required: Incomplete
    def __init__(self, options: list[str], selected: list[str] | None = None, include_nulls_visible: bool = True, include_nulls_value: bool = False, multiselect: bool = False, title: str = '', description: str = '', show_title: bool = True, show_description: bool = True, required: bool = True, label: str = '', placeholder: str = '') -> None: ...
