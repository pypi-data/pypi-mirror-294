...
from virtualitics_sdk import Table as Table
...
def valid_dashboard_element(elem_row_or_col: DASHBOARD_ELEMENT | Row | Column): ...
...
class Row:
    ...
    width: Incomplete
    height: int
    def __init__(self, elements: list[Element | Column], ratio: list[int] | None = None) -> None: ...
    def to_json(self): ...
...
class Column:
    ...
    height: Incomplete
    width: int
    def __init__(self, elements: list[Element | Row], ratio: list[int] | None = None) -> None: ...
