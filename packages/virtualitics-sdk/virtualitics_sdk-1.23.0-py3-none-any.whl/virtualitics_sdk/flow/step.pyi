...
class Step(ABC):
    """A Step is the basic unit of an app. Steps can be chained together to form an app.
        ...
        :param allow_filters: whether to allow filters, defaults to False.
    ...
    last_step: bool
    def __init__(self, title: str, description: str, parent: str, type: StepType, page, allow_filters: bool = False, uses_pyspark: bool = False, uses_pyvip: bool = False, uses_snowflake: bool = False, overrides_action: bool = False, await_actions: bool = True, override_skips_default: bool = False, alerts: list | None = None, **kwargs) -> None: ...
    def copy(self): ...
    @property
    def progress(self): ...
    @progress.setter
    ...
    @abstractmethod
    def run(self, flow_metadata: dict, spark_session: Incomplete | None = None, pyvip_client: VIP | None = None): ...
    def action_override(self, flow_metadata: dict[str, Any]):
        '''
