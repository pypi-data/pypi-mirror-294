...
class Asset:
    ...
    **EXAMPLE:**
    ...
    def __init__(self, object: Any, label: str, type: AssetType, metadata: dict = {}, name: str | None = None, description: str | None = None, version: int | None = None, **kwargs) -> None: ...
    ...
    def to_bytes(self, created_in_self_service_flow: bool = False) -> bytes: ...
    @staticmethod
...
def asset_v0_to_v1(asset: Asset) -> Asset:
    """Version 0 is any asset prior to asset version tracking.
    :param asset:
    :return:
    """
