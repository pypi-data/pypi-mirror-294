...
class LanguageProcessor(Asset):
    ...
    **EXAMPLE:**
    ...
    def initialize_model(self, model_name: str):
        ...
        :param model_name:
        """
    def ingest(self, data: pd.DataFrame, flow_metadata: dict = None, extract_doc_bin: bool = False, starting_progress: int | float | None = None, target_progress: int | float | None = None) -> None | DocBin:
