...
vtkBoolExists = False
try:
    importlib.import_module("vtkbool")
    vtkBoolExists = True
    from vtkbool.vtkBool import vtkPolyDataBooleanFilter
except:
    print("Defaulting to native pyvista boolean operations")
    pass
...
class Generator:
    ...
    def booleanDifference(self, obj1, obj2):
    ...
    def generateBase(self):
        ...
        for i in range(self.numMangetsInRing):
            ...
            base = self.booleanDifference(base, magnetHole)
        ...
        outerBaseWithHole = self.booleanDifference(outerBase, foamCavity)
    ...
    def generateBottomClip(self):
        ...
        for i in range(2):
            ...
            magnetHolder = self.booleanDifference(outerMagnet, magnet)
            boolean = vtkPolyDataBooleanFilter()
            boolean.SetInputData(0, base)
    ...
    def generateTopClip(self):
        ...
        for i in range(2):
            ...
            base = self.booleanDifference(base, magnetHolder)
            ...
            base = self.booleanDifference(base, magnet)
        ...
        base = self.booleanDifference(base, slot)
        if not base.is_manifold:
            raise Exception("Mesh is not manifold")
