...
class InstructionManager:
    def __init__(self)->None:
        self.default_instructions = {
                    ...
                    "notation": {"instruction": "notation is a module end  functionality that allows the module, you, to to preserve relevant information or context for subsequent prompts; allowing for communication between modules throughout the query iterations. ", "example": "Selecting additional responses due to insufficient completion tokens."},
