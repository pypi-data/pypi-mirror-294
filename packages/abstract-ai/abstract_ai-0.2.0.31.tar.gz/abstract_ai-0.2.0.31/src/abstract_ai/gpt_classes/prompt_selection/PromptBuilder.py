...
from ..instruction_selection.InstructonBuilder_nogui import InstructionManager_nogui
...
class PromptManager:
    ...
    def __init__(self,
        ...
        self.instruction_mgr = instruction_mgr or InstructionManager_nogui()
    ...
    def create_prompt(self,
        ...
        if prompt_as_previous and isinstance(prompt_as_previous,str):
            ...
            new_chunk_distributions=self.calculate_token_distribution(
                 ...
                 instruction_data=self.instruction_data[chunk_token_distribution_number]['text'],
                 notation=self.notation,
                 max_tokens=self.model_mgr.selected_max_tokens,
                 completion_percentage=self.completion_percentage,
