class BaseClient:
    ...
    #TODO: Make ttl optional on docstring
    def set(self, key: str, value, ttl: int | None = None):
        ...
        .. warning::
            Timeouted keys aren't deleted by default, you must call :func:`cleanup` from time to time
    ...
    def count(self, like: str = "%"):
        """Returns the number of keys in database
        ...
        Returns:
            :py:class:`int`: The number of keys
        """
        raise NotImplementedError
    
    def count_expire(self, like: str = "%"):
        """Returns the number of expired keys in database
        ...
        Returns:
            :py:class:`int`: The number of expired keys
        """
        raise NotImplementedError
    ...
    def pagination(self, limit: int, page: int, like: str = "%"):
        """Return list of keys in database with the given pattern
