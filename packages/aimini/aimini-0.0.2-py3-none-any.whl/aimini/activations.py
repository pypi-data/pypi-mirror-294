# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lectures/10_activations.ipynb.

# %% ../nbs/lectures/10_activations.ipynb 3
...
# %% ../nbs/lectures/10_activations.ipynb 32
class Hook():
...
# %% ../nbs/lectures/10_activations.ipynb 47
def append_stats(hook, mod, inp, outp):
    if not hasattr(hook, 'stats'): hook.stats = ([], [], [])
    acts = to_cpu(outp)
    hook.stats[0].append(acts.mean())
...
# %% ../nbs/lectures/10_activations.ipynb 50
