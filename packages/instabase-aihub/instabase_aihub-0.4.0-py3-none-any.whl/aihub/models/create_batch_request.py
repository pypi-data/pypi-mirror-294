...
class CreateBatchRequest(BaseModel):
    ...
    workspace_name: Optional[StrictStr] = Field(default=None, description="The name of the workspace in which to add the batch; the batch is created in the default drive of the workspace. If not specified, the default location for organization members is the default drive of your personal workspace. For community users, the default location is your personal workspace’s Instabase Drive.")
