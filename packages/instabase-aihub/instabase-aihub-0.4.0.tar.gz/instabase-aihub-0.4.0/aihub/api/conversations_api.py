...
class ConversationsApi:
    ...
    def delete_conversation(
        ...
        Delete a conversation by making a `DELETE` request to `API_ROOT/v2/conversations/<CONVERSATION-ID>/`.
    ...
    def delete_documents_from_conversation(
        ...
        Deletes documents from the conversation, including database and filesystem cleanup.  <Tip>You can get a list of document IDs in your conversation with a [Conversation information](#conversation-information) request.</Tip> 
