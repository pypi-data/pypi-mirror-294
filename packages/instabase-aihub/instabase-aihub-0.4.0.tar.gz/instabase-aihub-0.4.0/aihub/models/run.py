...
class Run(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the run.")
    start_timestamp: Optional[StrictInt] = Field(default=None, description="When the run started, in Unix time.")
    finish_timestamp: Optional[StrictInt] = Field(default=None, description="When the run finished, in Unix time. `null` if run is still in progress.")
