...
class OMS:
    ...
    def place_gtt_order(self, buy_price, trade_type, qty, thresh=1, slippage=0.98, ticker=None, prefix=None,
...
if __name__ == '__main__':
    ...
    print(obj.get_gtt_orders(status='open'))
    print(obj.modify_gtt_order(order_id='236829198', trigger_price=500, execution_price=450, trade_type='NRML',
                               qty=500, ticker='SENSEX2491381100PE', exchange='BFO'))
