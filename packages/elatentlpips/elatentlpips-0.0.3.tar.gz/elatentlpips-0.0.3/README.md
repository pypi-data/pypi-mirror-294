...
```
git clone https://github.com/mingukkang/e-latentlpips.git
cd e-latentlpips
...
## License
E-LatentLPIPS is an open-source library under the [MIT license](https://github.com/mingukkang/e-latentlpips/blob/main/LICENSE).
