...
{
    "distutils": {
        "name": "tbstock.utils.__init__",
        "sources": [
            "./tbstock/utils/__init__.py"
        ]
    },
    "module_name": "tbstock.utils.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__tbstock__utils
#define __PYX_HAVE_API__tbstock__utils
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "tbstock.utils" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "tbstock.utils.__init__"
extern int __pyx_module_is_main_tbstock__utils____init__;
int __pyx_module_is_main_tbstock__utils____init__ = 0;

/* Implementation of "tbstock.utils" */
...
static const char __pyx_k_tbstock_utils___init[] = "tbstock.utils.__init__";
/* #### Code section: decls ### */
...
typedef struct {
  ...
  PyObject *__pyx_kp_u_tbstock_utils___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_tbstock_utils___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_tbstock_utils___init);
...
#define __pyx_kp_u_tbstock_utils___init __pyx_mstate_global->__pyx_kp_u_tbstock_utils___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_tbstock_utils___init, __pyx_k_tbstock_utils___init, sizeof(__pyx_k_tbstock_utils___init), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_tbstock__utils____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_tbstock_utils___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "tbstock.utils")) {
      if (unlikely((PyDict_SetItemString(modules, "tbstock.utils", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init tbstock.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init tbstock.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
