...
from src.inferent.ratings import Glicko2, KalmanRating, Player, BASE_RATING

class TestGlicko2(unittest.TestCase):

    @patch('src.inferent.ratings.Player')
...
class TestKalmanRating(unittest.TestCase):
    ...
    def test_update_method(self):
        ...
        self.assertNotEqual(kalman.get_rating(p1key).o.rtg, kalman.avg_rtg)
        self.assertNotEqual(kalman.get_rating(p2key).o.rtg, kalman.avg_rtg)
