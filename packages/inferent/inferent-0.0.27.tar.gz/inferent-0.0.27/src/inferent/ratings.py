...
class Player:
    ...
    rating: Rating = Rating(BASE_RATING, BASE_RD)  # Initial rating
...
class Glicko2:
    ...
    def update(
        ...
        logger.debug("Calculaging updates for %s, %s, %s, %s",
    ...
    def calculate_updates(
        ...
        logger.debug("winexp: %s, %s", p1.win_exp, p2.win_exp)
        logger.debug("Before %s, %s, %s, %s", p1.rating.score, p1.rating.stdev,
        ...
        for player_a, player_b, outcome_a in (
            ...
            logger.debug("Adding %s", (Q / rd2_d2opp) * player_b.grd * (outcome_a - player_a.win_exp))
        ...
        logger.debug("After %s, %s, %s, %s", p1.rating.score, p1.rating.stdev,
                     p2.rating.score, p2.rating.stdev)

    def get_rating(self, pkey: str) -> float:
        """Returns the rating of a player."""
        return self.players.get(pkey, Player()).rating.score
