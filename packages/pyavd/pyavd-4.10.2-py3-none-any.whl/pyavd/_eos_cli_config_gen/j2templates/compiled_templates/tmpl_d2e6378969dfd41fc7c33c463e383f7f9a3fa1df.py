...
def root(context, missing=missing):
    ...
    if t_4(environment.getattr((undefined(name='vxlan_interface') if l_0_vxlan_interface is missing else l_0_vxlan_interface), 'Vxlan1')):
        ...
        if t_4(environment.getattr(environment.getattr(environment.getattr((undefined(name='vxlan_interface') if l_0_vxlan_interface is missing else l_0_vxlan_interface), 'Vxlan1'), 'vxlan'), 'vtep_to_vtep_bridging'), True):
            ...
            yield str(environment.getattr(environment.getattr(environment.getattr((undefined(name='vxlan_interface') if l_0_vxlan_interface is missing else l_0_vxlan_interface), 'Vxlan1'), 'vxlan'), 'vtep_to_vtep_bridging'))
            yield ' |\n'
        ...
        elif t_4(environment.getattr(environment.getattr(environment.getattr(environment.getattr((undefined(name='vxlan_interface') if l_0_vxlan_interface is missing else l_0_vxlan_interface), 'Vxlan1'), 'vxlan'), 'multicast'), 'headend_replication'), False):
            pass
...
blocks = {}
debug_info = '8=36&16=39&17=42&19=44&20=47&22=49&23=52&25=55&26=57&27=60&29=62&30=65&32=67&34=70&37=73&39=76&42=79&44=82&47=85&49=88&52=91&53=93&54=96&56=98&57=101&59=103&60=106&62=108&63=111&66=113&68=116&71=119&77=122&78=127&79=129&80=131&81=133&83=137&85=140&88=149&94=152&95=156&96=158&97=161&100=168&106=171&112=174'