...
def root(context, missing=missing):
    ...
    if t_3((undefined(name='ip_security') if l_0_ip_security is missing else l_0_ip_security)):
        ...
        for l_1_ike_policy in t_1(environment.getattr((undefined(name='ip_security') if l_0_ip_security is missing else l_0_ip_security), 'ike_policies'), []):
            ...
            yield '\n'
            if t_3(environment.getattr(l_1_ike_policy, 'local_id_fqdn')):
                pass
                yield '      local-id fqdn '
                yield str(environment.getattr(l_1_ike_policy, 'local_id_fqdn'))
                yield '\n'
            elif t_3(environment.getattr(l_1_ike_policy, 'local_id')):
                pass
                yield '      local-id '
...
blocks = {}
debug_info = '7=30&10=33&12=37&13=39&14=42&15=44&16=47&18=49&19=52&21=54&22=57&24=59&25=62&28=65&30=69&31=71&32=73&35=79&38=81&39=83&42=89&45=91&46=94&48=98&49=101&52=104&54=109&55=111&56=114&58=116&59=119&61=121&62=124&64=126&65=129&67=131&68=134&70=140&73=143&74=146&77=149&80=152&81=155&84=157'