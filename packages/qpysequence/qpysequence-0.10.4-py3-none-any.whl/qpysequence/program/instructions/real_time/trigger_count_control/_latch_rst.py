...
class LatchRst(Instruction):
    """
    Reset all trigger network address counters back to 0 and then wait for `wait_time` number of nanoseconds.

    Args:
        wait_time (Register | int): waiting time in nanoseconds.
    """
