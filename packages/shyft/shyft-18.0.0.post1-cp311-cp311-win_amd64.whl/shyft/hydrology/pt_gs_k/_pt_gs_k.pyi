...
class PTGSKModel:
    ...
    def get_catchment_parameter(self, catchment_id: int) -> PTGSKParameter:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: PTGSKParameter) -> None:
        """
...
class PTGSKOptimizer:
    ...
    def get_initial_state(self, i: int) -> PTGSKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: PTGSKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> PTGSKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: PTGSKParameter, max_n_evaluations: int) -> PTGSKParameter:
        """
    ...
    def optimize_global(self, p: PTGSKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> PTGSKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: PTGSKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> PTGSKParameter:
        """
    ...
    def trace_parameter(self, i: int) -> PTGSKParameter:
        """
...
def create_full_model_clone(src_model: PTGSKOptModel, with_catchment_params: bool = False) -> PTGSKModel:
    """
...
def create_opt_model_clone(src_model: PTGSKModel, with_catchment_params: bool = False) -> PTGSKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
