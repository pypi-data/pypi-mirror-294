...
class PTHSKModel:
    ...
    def get_catchment_parameter(self, catchment_id: int) -> PTHSKParameter:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: PTHSKParameter) -> None:
        """
...
class PTHSKOptimizer:
    ...
    def get_initial_state(self, i: int) -> PTHSKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: PTHSKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> PTHSKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: PTHSKParameter, max_n_evaluations: int) -> PTHSKParameter:
        """
    ...
    def optimize_global(self, p: PTHSKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> PTHSKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: PTHSKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> PTHSKParameter:
        """
    ...
    def trace_parameter(self, i: int) -> PTHSKParameter:
        """
...
def create_full_model_clone(src_model: PTHSKOptModel, with_catchment_params: bool = False) -> PTHSKModel:
    """
...
def create_opt_model_clone(src_model: PTHSKModel, with_catchment_params: bool = False) -> PTHSKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
