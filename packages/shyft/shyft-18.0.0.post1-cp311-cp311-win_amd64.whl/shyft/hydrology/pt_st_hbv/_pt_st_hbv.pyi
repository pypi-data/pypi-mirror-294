...
class PTSTHBVCellHBVSoilResponseStatistics:
    ...
    def inuz(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def inuz(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [mm/h]
        """
        ...

    def inuz_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [mm/h]
        """
        ...
    ...
    def soil_ae(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def soil_ae(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [mm/h]
        """
        ...

    def soil_ae_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [mm/h]
        """
        ...
...
class PTSTHBVCellHBVSoilStateStatistics:
    ...
    def sm(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def sm(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep
        """
        ...

    def sm_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep
        """
        ...
...
class PTSTHBVCellHBVTankResponseStatistics:
    ...
    def elake(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def elake(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [mm/h]
        """
        ...

    def elake_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [mm/h]
        """
        ...
    ...
    def qlz(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def qlz(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...

    def qlz_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...
    ...
    def quz0(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def quz0(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...

    def quz0_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...
    ...
    def quz1(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def quz1(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...

    def quz1_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...
    ...
    def quz2(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def quz2(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...

    def quz2_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...
...
class PTSTHBVCellHBVTankStateStatistics:
    ...
    def lz(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def lz(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep
        """
        ...

    def lz_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def uz(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def uz(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns value for cells matching catchments_ids at the i'th timestep
        """
        ...

    def uz_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns value for cells matching catchments_ids at the i'th timestep
        """
        ...
