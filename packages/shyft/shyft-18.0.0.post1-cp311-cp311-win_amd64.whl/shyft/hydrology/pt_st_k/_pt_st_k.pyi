...
class PTSTKModel:
    ...
    def get_catchment_parameter(self, catchment_id: int) -> PTSTKParameter:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: PTSTKParameter) -> None:
        """
...
class PTSTKOptimizer:
    ...
    def get_initial_state(self, i: int) -> PTSTKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: PTSTKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> PTSTKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: PTSTKParameter, max_n_evaluations: int) -> PTSTKParameter:
        """
    ...
    def optimize_global(self, p: PTSTKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> PTSTKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: PTSTKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> PTSTKParameter:
        """
    ...
    def trace_parameter(self, i: int) -> PTSTKParameter:
        """
...
def create_full_model_clone(src_model: PTSTKOptModel, with_catchment_params: bool = False) -> PTSTKModel:
    """
...
def create_opt_model_clone(src_model: PTSTKModel, with_catchment_params: bool = False) -> PTSTKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
