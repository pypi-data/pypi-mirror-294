...
class RPTGSKCellGammaSnowStateStatistics:
    ...
    def acc_melt(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def acc_melt(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def acc_melt_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def albedo(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def albedo(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def albedo_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def alpha(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def alpha(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def alpha_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def iso_pot_energy(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def iso_pot_energy(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def iso_pot_energy_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def lwc(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def lwc(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def lwc_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def sdc_melt_mean(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def sdc_melt_mean(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def sdc_melt_mean_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def surface_heat(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def surface_heat(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def surface_heat_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def temp_swe(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def temp_swe(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def temp_swe_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
...
class RPTGSKModel:
    ...
    def get_catchment_parameter(self, catchment_id: int) -> RPTGSKParameter:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: RPTGSKParameter) -> None:
        """
...
class RPTGSKOptimizer:
    ...
    def get_initial_state(self, i: int) -> RPTGSKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: RPTGSKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> RPTGSKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: RPTGSKParameter, max_n_evaluations: int) -> RPTGSKParameter:
        """
    ...
    def optimize_global(self, p: RPTGSKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> RPTGSKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: RPTGSKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> RPTGSKParameter:
        """
    ...
    def trace_parameter(self, i: int) -> RPTGSKParameter:
        """
...
def create_full_model_clone(src_model: RPTGSKOptModel, with_catchment_params: bool = False) -> RPTGSKModel:
    """
...
def create_opt_model_clone(src_model: RPTGSKModel, with_catchment_params: bool = False) -> RPTGSKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
