...
class RPMVSTKAllCollector:
    """
    collect all cell response from a run
    """
    @property
    def ae_output(self)->Any:
        """
        actual evap mm/h
        """
        ...
    @property
    def avg_charge(self)->Any:
        """
        average charge in [m^3/s]
        """
        ...
    @property
    def avg_discharge(self)->Any:
        """
    ...
    def destination_area(self)->Any:
        ...
        ...
    @property
    def end_reponse(self)->Any:
        """
        end_response, at the end of collected
        """
        ...
    @property
    def glacier_melt(self)->Any:
        """
        glacier melt (outflow) [m3/s] for the timestep
        """
        ...
    @property
    def pe_output(self)->Any:
        """
        pot evap mm/h
        """
        ...
    @property
    def snow_outflow(self)->Any:
        """
        gamma snow output [m^3/s] for the timestep
        """
        ...
    @property
    def snow_sca(self)->Any:
        """
        snow tiles covered area fraction, sca.. 0..1 - at the end of timestep (state)
        """
        ...
    @property
    def snow_swe(self)->Any:
        """
        snow tiles swe, [mm] over the cell sca.. area, - at the end of timestep
        """
        ...
...
class RPMVSTKCellActualEvapotranspirationResponseStatistics:
    """
    ActualEvapotranspiration response statistics
    """
    def __init__(self, cells: RPMVSTKCellAllVector) -> None:
        """
    ...
    def output(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def output(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def output_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def pot_ratio(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def pot_ratio(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns the ratio the ratio (1-exp(-water_level*3/scale_factor)) for cells matching catchments_ids at the i'th timestep
        """
        ...

    def pot_ratio_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
...
class RPMVSTKCellAll:
    """
    tbd: RPMVSTKCellAll doc
    """
    @property
    ...
    def geo(self, value:GeoCellData)->None:
        ...
    @property
    def parameter(self)->RPMVSTKParameter:
        """
         reference to parameter for this cell, typically shared for a catchment
        """
        ...
    @parameter.setter
    def parameter(self, value:RPMVSTKParameter)->None:
        ...
    @property
    def rc(self)->Any:
        """
        RPMVSTKCellAllResponseCollector
        """
        ...
    @property
    def sc(self)->Any:
        """
        RPMVSTKCellAllStateCollector
        """
        ...
    @property
    def state(self)->RPMVSTKState:
        """
         the current state of the cell
        """
        ...
    @state.setter
    def state(self, value:RPMVSTKState)->None:
        ...
    def __init__(self) -> None:
        ...
    ...
    def set_parameter(self, parameter: RPMVSTKParameter) -> None:
        """
...
class RPMVSTKCellAllStateHandler:
    """
    ...
    def apply_state(self, cell_id_state_vector: RPMVSTKStateWithIdVector, cids: Union[IntVector,list[int],range]) -> IntVector:
        """
    ...
    def extract_state(self, cids: Union[IntVector,list[int],range]) -> RPMVSTKStateWithIdVector:
        """
...
class RPMVSTKCellAllStatistics:
    """
    ...
    def charge(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def charge(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns charge[m^3/s]  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def charge_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns charge[m^3/s] for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def discharge(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def discharge(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def discharge_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def precipitation(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def precipitation(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def precipitation_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def radiation(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def radiation(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def radiation_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def rel_hum(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def rel_hum(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def rel_hum_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def snow_sca(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def snow_sca(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns snow_sca []  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def snow_sca_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns snow_sca [] for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def snow_swe(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def snow_swe(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns snow_swe [mm]  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def snow_swe_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns snow_swe [mm] for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def temperature(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def temperature(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def temperature_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def wind_speed(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def wind_speed(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def wind_speed_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
...
class RPMVSTKCellAllVector:
    ...
    def create_from_geo_cell_data_vector(self) -> RPMVSTKCellAllVector:
        """
    ...
    def create_from_geo_cell_data_vector_to_tin(self) -> RPMVSTKCellAllVector:
        """
        create a cell-vector filling in the geo_cell_data records as given by the DoubleVector.
            This function works together with the geo_cell_data_vector static method
            that provides a correctly formatted persistable vector
...
class RPMVSTKCellKirchnerStateStatistics:
    """
...
class RPMVSTKCellOpt:
    """
    tbd: RPMVSTKCellOpt doc
    """
    @property
    def env_ts(self)->CellEnvironment:
        """
    ...
    def rc(self)->Any:
        """
        RPMVSTKCellOptResponseCollector
        """
        ...
    @property
    def sc(self)->Any:
        """
        RPMVSTKCellOptStateCollector
        """
        ...
    @property
    def state(self)->RPMVSTKState:
...
class RPMVSTKCellOptStateHandler:
    """
    Provides functionality to extract and restore state from cells
    """
    @overload
    def __init__(self) -> None:
        ...
    @overload
    def __init__(self, cells: RPMVSTKCellOptVector) -> None:
        """
        construct a cell state handler for the supplied cells
        """
        ...
...
class RPMVSTKCellOptStatistics:
    """
    This class provides statistics for group of cells, as specified
    by the list of catchment identifiers, or list of cell-indexes passed to the methods.
    It is provided both as a separate class, but is also provided
...
class RPMVSTKCellOptVector:
    ...
    def create_from_geo_cell_data_vector(self) -> RPMVSTKCellOptVector:
        """
        create a cell-vector filling in the geo_cell_data records as given by the DoubleVector.
            This function works together with the geo_cell_data_vector static method
            that provides a correctly formatted persistable vector
    ...
    def create_from_geo_cell_data_vector_to_tin(self) -> RPMVSTKCellOptVector:
        """
        create a cell-vector filling in the geo_cell_data records as given by the DoubleVector.
            This function works together with the geo_cell_data_vector static method
            that provides a correctly formatted persistable vector
...
class RPMVSTKCellPenmanMonteithResponseStatistics:
    """
...
class RPMVSTKCellSnowTilesResponseStatistics:
    """
    ...
    def glacier_melt(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def glacier_melt(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns glacier melt for cells matching catchments_ids at the i'th timestep [m3/s]
        """
        ...

    def glacier_melt_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
    ...
    def outflow(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def outflow(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns outflow for cells matching catchments_ids at the i'th timestep [m3 s-1]
        """
        ...

    def outflow_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
    ...
    def sca(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def sca(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns snow cover fraction for cells matching catchments_ids at the i'th timestep [0...1]
        """
        ...

    def sca_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
    ...
    def swe(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def swe(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns snow-water equivalent for cells matching catchments_ids at the i'th timestep [mm]
        """
        ...

    def swe_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
...
class RPMVSTKCellSnowTilesStateStatistics:
    """
...
class RPMVSTKDischargeCollector:
    """
    collect all cell response from a run
    """
    @property
    ...
    def avg_discharge(self)->Any:
        ...
        ...
    @property
    def collect_snow(self)->Any:
        """
        controls collection of snow routine
        """
        ...
    @collect_snow.setter
    def collect_snow(self, value:Any)->None:
        ...
    @property
    def destination_area(self)->Any:
        """
...
class RPMVSTKModel:
    """
    RPMVSTKModel , a region_model is the calculation model for a region, where we can have
    ...
    def time_axis(self)->TimeAxisFixedDeltaT:
        ...
        ...
    @overload
    def __init__(self, other_model: RPMVSTKModel) -> None:
        """
        ...
        ...
    @overload
    def __init__(self, geo_data_vector: GeoCellDataVector, region_param: RPMVSTKParameter) -> None:
        """
        ...
        ...
    @overload
    def __init__(self, cells: RPMVSTKCellAllVector, region_param: RPMVSTKParameter, catchment_parameters: object) -> None:
        """
    ...
    def get_catchment_parameter(self, catchment_id: int) -> RPMVSTKParameter:
        """
    ...
    def get_cells(self) -> RPMVSTKCellAllVector:
        """
        cells as shared_ptr<vector<cell_t>>
        """
        ...

    def get_region_parameter(self) -> RPMVSTKParameter:
        """
        provide access to current region parameter-set
        """
        ...

    def get_states(self, end_states: RPMVSTKStateVector) -> None:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: RPMVSTKParameter) -> None:
        """
    ...
    def set_region_parameter(self, p: RPMVSTKParameter) -> None:
        """
    ...
    def set_states(self, states: RPMVSTKStateVector) -> None:
        """
...
class RPMVSTKOptModel:
    """
    RPMVSTKOptModel , a region_model is the calculation model for a region, where we can have
    one or more catchments.
    The role of the region_model is to describe region, so that we can run the
    region computational model efficiently for a number of type of cells, interpolation and
    catchment level algorihtms.
    ...
    def time_axis(self)->TimeAxisFixedDeltaT:
        ...
        ...
    @overload
    def __init__(self, other_model: RPMVSTKOptModel) -> None:
        """
        Create a copy of the other_model
    ...
    def __init__(self, geo_data_vector: GeoCellDataVector, region_param: RPMVSTKParameter) -> None:
        ...
        ...
    @overload
    def __init__(self, cells: RPMVSTKCellOptVector, region_param: RPMVSTKParameter, catchment_parameters: object) -> None:
        """
        Creates a model from cells and region model parameters, and specified catchment parameters
            The cell-vector and catchment-id's should match those specified in the catchment_parameters mapping
    ...
    def get_cells(self) -> RPMVSTKCellOptVector:
        """
        cells as shared_ptr<vector<cell_t>>
        """
        ...
...
class RPMVSTKOptimizer:
    ...
    def warn_size(self)->int:
        ...
        ...
    @overload
    def __init__(self, model: RPMVSTKOptModel, targets: TargetSpecificationVector, p_min: Union[DoubleVector,list[float],np.ndarray], p_max: Union[DoubleVector,list[float],np.ndarray]) -> None:
        """
        ...
        ...
    @overload
    def __init__(self, model: RPMVSTKOptModel) -> None:
        """
    ...
    def calculate_goal_function(self, full_vector_of_parameters: Union[DoubleVector,list[float],np.ndarray]) -> float:
        ...
        ...
    @overload
    def calculate_goal_function(self, parameters: RPMVSTKParameter) -> float:
        """
    ...
    def get_initial_state(self, i: int) -> RPMVSTKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: RPMVSTKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> RPMVSTKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: RPMVSTKParameter, max_n_evaluations: int) -> RPMVSTKParameter:
        """
    ...
    def optimize_global(self, p: RPMVSTKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> RPMVSTKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: RPMVSTKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> RPMVSTKParameter:
        """
    ...
    def set_target_specification(self, target_specification: TargetSpecificationVector, parameter_lower_bound: RPMVSTKParameter, parameter_upper_bound: RPMVSTKParameter) -> None:
        """
    ...
    def trace_parameter(self, i: int) -> RPMVSTKParameter:
        """
...
class RPMVSTKParameter:
    """
    Contains the parameters to the methods used in the RPMVSTK assembly
    radiation, penman_monteith, snow tiles,actual_evapotranspiration,precipitation_correction,kirchner
    """
    @property
    ...
    def p_corr(self, value:PrecipitationCorrectionParameter)->None:
        ...
    @property
    def pm(self)->PenmanMonteithVegetationParameter:
        """
         penman_monteith vegetation parameter
        """
        ...
    @pm.setter
    def pm(self, value:PenmanMonteithVegetationParameter)->None:
        ...
    @property
    ...
    def __init__(self) -> None:
        ...
    @overload
    def __init__(self, rad: RadiationParameter, pm: object, st: SnowTilesParameter, ae: ActualEvapotranspirationParameter, k: KirchnerParameter, p_corr: PrecipitationCorrectionParameter, gm: GlacierMeltParameter, routing: UHGParameter, msp: MethodStackParameter) -> None:
        """
        ...
        ...
    @overload
    def __init__(self, p: RPMVSTKParameter) -> None:
        """
        clone a parameter
        """
        ...
    ...
    @staticmethod
    def deserialize(blob: ByteVector) -> RPMVSTKParameter:
        ...
...
class RPMVSTKResponse:
    """
    This struct contains the responses of the methods used in the RPMVSTK assembly
    """
    @property
    ...
    def ae(self, value:ActualEvapotranspirationResponse)->None:
        ...
    @property
    def fwe(self)->FreeWaterEvaporationResponse:
        """
         free-water response
        """
        ...
    @fwe.setter
    def fwe(self, value:FreeWaterEvaporationResponse)->None:
        ...
    @property
    ...
    def kirchner(self, value:KirchnerResponse)->None:
        ...
    @property
    def pm(self)->PenmanMonteithVegetationResponse:
        """
         penman_monteith response
        """
        ...
    @pm.setter
    def pm(self, value:PenmanMonteithVegetationResponse)->None:
        ...
    @property
...
class RPMVSTKState:
    ...
    def __init__(self, snow: SnowTilesState, k: KirchnerState) -> None:
        """
        initializes state with snow_tiles st and kirchner k
        """
        ...



class RPMVSTKStateCollector:
    """
    ...
    def collect_state(self, value:Any)->None:
        ...
    @property
    def kirchner_discharge(self)->Any:
        """
    ...
    def snow_sca(self)->Any:
        ...
        ...
    @property
    def snow_sp(self)->Any:
        """
        raw snow-tiles state-data for 'fw'
        """
        ...
    @property
    def snow_sw(self)->Any:
        """
...
class RPMVSTKStateWithId:
    ...
    def __init__(self) -> None:
        ...
    @overload
    def __init__(self, id: CellStateId, state: RPMVSTKState) -> None:
        """
...
class RPMVSTKStateWithIdVector:
    """
...
class map_indexing_suite_RPMVSTKParameterMap_entry:
    def __init__(self) -> None:
        ...

    def data(self) -> RPMVSTKParameter:
        ...
...
def create_full_model_clone(src_model: RPMVSTKOptModel, with_catchment_params: bool = False) -> RPMVSTKModel:
    """
...
def create_opt_model_clone(src_model: RPMVSTKModel, with_catchment_params: bool = False) -> RPMVSTKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
...
def deserialize(bytes: ByteVector, states: RPMVSTKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
    ...

def extract_state_vector(cell_state_id_vector: RPMVSTKStateWithIdVector) -> RPMVSTKStateVector:
    """
...
def serialize(states: RPMVSTKStateWithIdVector) -> ByteVector:
    """
