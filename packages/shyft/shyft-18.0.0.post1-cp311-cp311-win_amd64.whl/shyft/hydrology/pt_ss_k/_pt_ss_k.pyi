...
class PTSSKCellSkaugenResponseStatistics:
    ...
    def total_stored_water(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def total_stored_water(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def total_stored_water_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
...
class PTSSKCellSkaugenStateStatistics:
    ...
    def nu(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def nu(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def nu_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    def residual(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = _api.stat_scope.catchment) -> TimeSeries:
        ...
        ...
    @overload
    def residual(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def residual_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = _api.stat_scope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
...
class PTSSKModel:
    ...
    def get_catchment_parameter(self, catchment_id: int) -> PTSSKParameter:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: PTSSKParameter) -> None:
        """
...
class PTSSKOptimizer:
    ...
    def get_initial_state(self, i: int) -> PTSSKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: PTSSKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> PTSSKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: PTSSKParameter, max_n_evaluations: int) -> PTSSKParameter:
        """
    ...
    def optimize_global(self, p: PTSSKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> PTSSKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: PTSSKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> PTSSKParameter:
        """
    ...
    def trace_parameter(self, i: int) -> PTSSKParameter:
        """
...
def create_full_model_clone(src_model: PTSSKOptModel, with_catchment_params: bool = False) -> PTSSKModel:
    """
...
def create_opt_model_clone(src_model: PTSSKModel, with_catchment_params: bool = False) -> PTSSKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
