...
class PTHPSKModel:
    ...
    def get_catchment_parameter(self, catchment_id: int) -> PTHPSKParameter:
        """
    ...
    def set_catchment_parameter(self, catchment_id: int, p: PTHPSKParameter) -> None:
        """
...
class PTHPSKOptimizer:
    ...
    def get_initial_state(self, i: int) -> PTHPSKState:
        """
    ...
    def optimize(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, tr_start: float, tr_stop: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize(self, p: PTHPSKParameter, max_n_evaluations: int, tr_start: float, tr_stop: float) -> PTHPSKParameter:
        """
    ...
    def optimize_dream(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_dream(self, p: PTHPSKParameter, max_n_evaluations: int) -> PTHPSKParameter:
        """
    ...
    def optimize_global(self, p: PTHPSKParameter, max_n_evaluations: int, max_seconds: float, solver_eps: float) -> PTHPSKParameter:
        """
    ...
    def optimize_sceua(self, p: Union[DoubleVector,list[float],np.ndarray], max_n_evaluations: int, x_eps: float, y_eps: float) -> DoubleVector:
        ...
        ...
    @overload
    def optimize_sceua(self, p: PTHPSKParameter, max_n_evaluations: int, x_eps: float, y_eps: float) -> PTHPSKParameter:
        """
    ...
    def trace_parameter(self, i: int) -> PTHPSKParameter:
        """
...
def create_full_model_clone(src_model: PTHPSKOptModel, with_catchment_params: bool = False) -> PTHPSKModel:
    """
...
def create_opt_model_clone(src_model: PTHPSKModel, with_catchment_params: bool = False) -> PTHPSKOptModel:
    """
    Clone a model to a another similar type model, full to opt-model or vice-versa
        The entire state except catchment-specific parameters, filter and result-series are cloned
        The returned model is ready to run_cells(), state and interpolated enviroment is identical to the clone source
