...
with open("ostris-ai-toolkit/README.md", "r", encoding="utf-8") as fh:
...
setup(
    ...
    url="https://github.com/cozy-creator/ostris-ai-toolkit",
    package_dir={"ostris_ai_toolkit": "ostris-ai-toolkit"},
    packages=['ostris_ai_toolkit'] + [f'ostris_ai_toolkit.{pkg}' for pkg in find_packages(where="ostris-ai-toolkit")],
    include_package_data=True,
    package_data={'': ['*']},
    exclude_package_data={
        '': ['.venv', '.git', '.github', '__pycache__', '*.pyc', 'repositories', '.gitignore', '.gitmodules'],
    },
    classifiers=[
