...
def draw_pizza(num_slices, topping):
    ...
    if num_slices > 8:
        num_slices = 8
    pizza_img_url = 'https://data.cyber.org.il/OnTopTech/pizzeria1/Images/pizza_topping/pizza_' + topping + '_' + str(num_slices)+'.png'
...
<div style="width: 500px; height: 380px; padding: 10px; font-family: Arial; position: relative;text-align:center; background-color:#FFFBDB">
  ...
  if not is_file_exist('/content/photo.jpg'):
    download_image_from_web("https://data.cyber.org.il/OnTopTech/pizzeria1/Images/intro1_pizza_box.png")
