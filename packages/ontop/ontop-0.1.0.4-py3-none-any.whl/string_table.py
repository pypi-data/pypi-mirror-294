...
def get_string_from_string_table(project, name):
  ...
  table = read_table('https://data.cyber.org.il/OnTopTech/library/StringTable/string_table_utf_05.csv')
...
def get_banners_strings():
  global language
  project_name = 'banner'
  csv_file='https://data.cyber.org.il/OnTopTech/library/StringTable/string_table_utf_05.csv'
