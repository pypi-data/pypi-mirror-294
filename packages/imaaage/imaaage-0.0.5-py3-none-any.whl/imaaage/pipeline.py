...
from imaaage.styles import apply_style, default_style_name
from imaaage.resolutions import resolutions, default_resolution
from imaaage.performance import perform_performance, default_performance
from imaaage.path import get_lora_path, default_base_model_name
from imaaage.adapters import set_lora, set_sampler
...
class Preset:
    ...
    def __str__(self):
        return str((self.base_model_name, self.refiner_model_name,
    ...
    def merge(self, payload: Payload):
...
class SDXLPipelineFactory:
    ...
    def create_pipeline(cls, preset: Preset):
        ...
        base_pipe = set_sampler(base_pipe, preset.sampler)
...
class SDXLPipeline:
    ...
    def run(self, payload: Payload, enable_preview=False):
        preset = self.preset.merge(payload)
        ...
        width, height = resolutions.get(resolution, default_resolution)
        ...
        if enable_preview:
            from imaaage.callback import latents_preview
