import{l as h,b as d,R as a,C as m,s as $,W as A,r as E,L as p,_ as S}from"./index-D2R_Ev4s.js";function y(e){return h.pick(e,["className","id"])}const L="text__single-line",N=e=>{const n=y(e),s=d(e.className,L),l={maxWidth:e.maxWidth?e.maxWidth:"",alignSelf:e.alignSelf?e.alignSelf:""},t=Array.isArray(e.children)?e.children.join(""):e.children,i={className:s,style:l,title:t},r=e.as||"span";return a.createElement(r,{...n,...i},e.children)},I={small:m`
    font-size: 12px;
  `,medium:m`
    font-size: 14px;
  `,large:m`
...
//# sourceMappingURL=Tags-CTXYl0Tp.js.map
