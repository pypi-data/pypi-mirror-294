...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_url=None, pulp_href=None, content_guard=None, hidden=False, base_path=None, pulp_labels=None, pulp_created=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
