...
# type hints were introduced in PEP 484 https://peps.python.org/pep-0484/ for Python version 3.5
# typing_extensions library allows up to Python 2.7; for ensurance rather use above 3.5 anyway

# TypeVarExtended = tpe.TypeVar
"\\@since 0.3.26rc3 - 0.3.27a3. `typing_extensions.TypeVar`"
