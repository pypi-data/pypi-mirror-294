...
import warnings, uuid, random as ra, re, tense.tcs as tcs, math as m
...
_AbroadValue1 = _uni[tcs.AbroadValue1[_T]]
_AbroadValue2 = _uni[tcs.AbroadValue2[_T]]
_AbroadModifier = _uni[tcs.AbroadModifier[_T]]
...
class _AbroadHexMode(tcs.IntegerFlag):
...
class NennɅIAbroads:
    ...
    def abroadPack(self, *values: _AbroadPackType[_T]) -> _AbroadInitializer:
        ...
        """
        from tense.primary import reckonLeast
...
class _SanitizeMode(tcs.IntegerFlag):
