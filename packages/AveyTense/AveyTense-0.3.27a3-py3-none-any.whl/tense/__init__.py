...
module tense
```
Users, which use Python 3.9 or higher, **can use this module**. \\
Support since version 3.5 is practically possible, just a temporary \\
text file would be needed to do so, but then `discord` may not \\
be supported before 3.8. Since 3.5, because of PEP 484 - Type Hints. \\
See https://peps.python.org/pep-0484/ for more information
...
class Tense(NennaiAbroads, NennaiStringz, NennaiRandomize, Time, Math, tc.Positive[str], tc.Negative[str], tc.Invertible[str]):
    ...
    @_cm
    def first(self, seq: _SizeableItemGetter[_T1], condition: _opt[_cal[[_T1], bool]] = None, /, default: _T2 = None):
        """
        \\@since 0.3.26rc2
        ```ts \\
        "class method" in class Tense
        ...
        return default
    @_cm
    def last(self, seq: _SizeableItemGetter[_T1], condition: _opt[_cal[[_T1], bool]] = None, /, default: _T2 = None):
        """
        \\@since 0.3.26rc2
        ```ts \\
        "class method" in class Tense
    ...
    def any(self, seq: _SizeableItemGetter[_T], condition: _opt[_cal[[_T], bool]] = None, /):
        ...
        return a
    @_cm
    def all(self, seq: _SizeableItemGetter[_T1], condition: _opt[_cal[[_T1], bool]] = None, /, default: _T2 = None):
        """
        \\@since 0.3.26rc2
        ```ts \\
        "class method" in class Tense
