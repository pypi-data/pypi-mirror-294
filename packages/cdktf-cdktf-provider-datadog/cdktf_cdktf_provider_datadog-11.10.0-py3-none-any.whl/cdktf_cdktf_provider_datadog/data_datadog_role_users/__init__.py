...
class DataDatadogRoleUsers(
    ...
    def __init__(
        ...
        *,
        ...
        :param role_id: The role's identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/data-sources/role_users#role_id DataDatadogRoleUsers#role_id}
        :param exact_match: When true, ``filter_keyword`` string is exact matched against the user's ``name``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/data-sources/role_users#exact_match DataDatadogRoleUsers#exact_match}
        :param filter: Search query, can be user name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/data-sources/role_users#filter DataDatadogRoleUsers#filter}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataDatadogRoleUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/data-sources/role_users#import import section} in the documentation of this resource for the id to use
