...
class RumApplication(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name of the RUM application. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/rum_application#name RumApplication#name}
        :param type: Type of the RUM application. Supported values are ``browser``, ``ios``, ``android``, ``react-native``, ``flutter``. Defaults to ``"browser"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/rum_application#type RumApplication#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RumApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/rum_application#import import section} in the documentation of this resource for the id to use
