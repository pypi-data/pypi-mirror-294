...
class SyntheticsTest(
    ...
    def __init__(
        ...
        *,
        ...
        :param locations: Array of locations used to run the test. Refer to `the Datadog Synthetics location data source <https://registry.terraform.io/providers/DataDog/datadog/latest/docs/data-sources/synthetics_locations>`_ to retrieve the list of locations. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#locations SyntheticsTest#locations}
        :param name: Name of Datadog synthetics test. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        :param status: Define whether you want to start (``live``) or pause (``paused``) a Synthetic test. Valid values are ``live``, ``paused``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#status SyntheticsTest#status}
        :param type: Synthetics test type. Valid values are ``api``, ``browser``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        :param api_step: api_step block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#api_step SyntheticsTest#api_step}
        :param assertion: assertion block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#assertion SyntheticsTest#assertion}
        :param browser_step: browser_step block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#browser_step SyntheticsTest#browser_step}
        :param browser_variable: browser_variable block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#browser_variable SyntheticsTest#browser_variable}
        :param config_variable: config_variable block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#config_variable SyntheticsTest#config_variable}
        ...
        :param options_list: options_list block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#options_list SyntheticsTest#options_list}
        :param request_basicauth: request_basicauth block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_basicauth SyntheticsTest#request_basicauth}
        :param request_client_certificate: request_client_certificate block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_client_certificate SyntheticsTest#request_client_certificate}
        :param request_definition: request_definition block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_definition SyntheticsTest#request_definition}
        :param request_file: request_file block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_file SyntheticsTest#request_file}
        :param request_headers: Header name and value map. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_headers SyntheticsTest#request_headers}
        :param request_metadata: Metadata to include when performing the gRPC request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_metadata SyntheticsTest#request_metadata}
        :param request_proxy: request_proxy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_proxy SyntheticsTest#request_proxy}
        :param request_query: Query arguments name and value map. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_query SyntheticsTest#request_query}
        ...
        :param subtype: The subtype of the Synthetic API test. Defaults to ``http``. Valid values are ``http``, ``ssl``, ``tcp``, ``dns``, ``multi``, ``icmp``, ``udp``, ``websocket``, ``grpc``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#subtype SyntheticsTest#subtype}
        ...
        :param variables_from_script: Variables defined from JavaScript code for API HTTP tests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#variables_from_script SyntheticsTest#variables_from_script}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SyntheticsTest that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#import import section} in the documentation of this resource for the id to use
    ...
    def put_options_list(
        ...
        *,
        ...
        '''
        :param tick_every: How often the test should run (in seconds). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#tick_every SyntheticsTest#tick_every}
        :param accept_self_signed: For SSL test, whether or not the test should allow self signed certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#accept_self_signed SyntheticsTest#accept_self_signed}
        :param allow_insecure: Allows loading insecure content for a request in an API test or in a multistep API test step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#allow_insecure SyntheticsTest#allow_insecure}
        ...
        :param ci: ci block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#ci SyntheticsTest#ci}
        :param disable_cors: Disable Cross-Origin Resource Sharing for browser tests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#disable_cors SyntheticsTest#disable_cors}
        :param disable_csp: Disable Content Security Policy for browser tests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#disable_csp SyntheticsTest#disable_csp}
        :param follow_redirects: Determines whether or not the API HTTP test should follow redirects. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#follow_redirects SyntheticsTest#follow_redirects}
        :param http_version: HTTP version to use for an HTTP request in an API test or step. Valid values are ``http1``, ``http2``, ``any``. Defaults to ``"any"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#http_version SyntheticsTest#http_version}
        :param ignore_server_certificate_error: Ignore server certificate error for browser tests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#ignore_server_certificate_error SyntheticsTest#ignore_server_certificate_error}
        ...
        :param min_failure_duration: Minimum amount of time in failure required to trigger an alert (in seconds). Default is ``0``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#min_failure_duration SyntheticsTest#min_failure_duration}
        :param min_location_failed: Minimum number of locations in failure required to trigger an alert. Defaults to ``1``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#min_location_failed SyntheticsTest#min_location_failed}
        :param monitor_name: The monitor name is used for the alert title as well as for all monitor dashboard widgets and SLOs. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#monitor_name SyntheticsTest#monitor_name}
        :param monitor_options: monitor_options block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#monitor_options SyntheticsTest#monitor_options}
        :param monitor_priority: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#monitor_priority SyntheticsTest#monitor_priority}.
        :param no_screenshot: Prevents saving screenshots of the steps. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#no_screenshot SyntheticsTest#no_screenshot}
        :param restricted_roles: A list of role identifiers pulled from the Roles API to restrict read and write access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#restricted_roles SyntheticsTest#restricted_roles}
        :param retry: retry block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#retry SyntheticsTest#retry}
        :param rum_settings: rum_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#rum_settings SyntheticsTest#rum_settings}
        :param scheduling: scheduling block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#scheduling SyntheticsTest#scheduling}
        '''
    ...
    def put_request_basicauth(
        ...
        *,
        ...
        '''
        :param access_key: Access key for ``SIGV4`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#access_key SyntheticsTest#access_key}
        :param access_token_url: Access token url for ``oauth-client`` or ``oauth-rop`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#access_token_url SyntheticsTest#access_token_url}
        :param audience: Audience for ``oauth-client`` or ``oauth-rop`` authentication. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#audience SyntheticsTest#audience}
        :param client_id: Client ID for ``oauth-client`` or ``oauth-rop`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#client_id SyntheticsTest#client_id}
        :param client_secret: Client secret for ``oauth-client`` or ``oauth-rop`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#client_secret SyntheticsTest#client_secret}
        :param domain: Domain for ``ntlm`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#domain SyntheticsTest#domain}
        :param password: Password for authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#password SyntheticsTest#password}
        :param region: Region for ``SIGV4`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#region SyntheticsTest#region}
        :param resource: Resource for ``oauth-client`` or ``oauth-rop`` authentication. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#resource SyntheticsTest#resource}
        :param scope: Scope for ``oauth-client`` or ``oauth-rop`` authentication. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#scope SyntheticsTest#scope}
        :param secret_key: Secret key for ``SIGV4`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#secret_key SyntheticsTest#secret_key}
        :param service_name: Service name for ``SIGV4`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#service_name SyntheticsTest#service_name}
        :param session_token: Session token for ``SIGV4`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#session_token SyntheticsTest#session_token}
        ...
        :param type: Type of basic authentication to use when performing the test. Defaults to ``"web"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        :param username: Username for authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#username SyntheticsTest#username}
        :param workstation: Workstation for ``ntlm`` authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#workstation SyntheticsTest#workstation}
        '''
    ...
    def put_request_client_certificate(
        ...
        *,
        ...
        '''
        :param cert: cert block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#cert SyntheticsTest#cert}
        :param key: key block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#key SyntheticsTest#key}
        '''
    ...
    def put_request_definition(
        ...
        *,
        ...
        '''
        :param body: The request body. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#body SyntheticsTest#body}
        ...
        :param call_type: The type of gRPC call to perform. Valid values are ``healthcheck``, ``unary``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#call_type SyntheticsTest#call_type}
        ...
        :param dns_server: DNS server to use for DNS tests (``subtype = "dns"``). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#dns_server SyntheticsTest#dns_server}
        :param dns_server_port: DNS server port to use for DNS tests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#dns_server_port SyntheticsTest#dns_server_port}
        :param host: Host name to perform the test with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#host SyntheticsTest#host}
        ...
        :param message: For UDP and websocket tests, message to send with the request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#message SyntheticsTest#message}
        ...
        :param no_saving_response_body: Determines whether or not to save the response body. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#no_saving_response_body SyntheticsTest#no_saving_response_body}
        :param number_of_packets: Number of pings to use per test for ICMP tests (``subtype = "icmp"``) between 0 and 10. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#number_of_packets SyntheticsTest#number_of_packets}
        :param persist_cookies: Persist cookies across redirects. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#persist_cookies SyntheticsTest#persist_cookies}
        :param plain_proto_file: The content of a proto file as a string. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#plain_proto_file SyntheticsTest#plain_proto_file}
        :param port: Port to use when performing the test. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#port SyntheticsTest#port}
        :param proto_json_descriptor: A protobuf JSON descriptor. **Deprecated.** Use ``plain_proto_file`` instead. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#proto_json_descriptor SyntheticsTest#proto_json_descriptor}
        ...
        :param service: The gRPC service on which you want to perform the gRPC call. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#service SyntheticsTest#service}
        ...
        :param timeout: Timeout in seconds for the test. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#timeout SyntheticsTest#timeout}
        :param url: The URL to send the request to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#url SyntheticsTest#url}
        '''
    ...
    def put_request_proxy(
        ...
        *,
        ...
        '''
        :param url: URL of the proxy to perform the test. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#url SyntheticsTest#url}
        :param headers: Header name and value map. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#headers SyntheticsTest#headers}
        '''
...
class SyntheticsTestApiStep:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The name of the step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        :param allow_failure: Determines whether or not to continue with test if this step fails. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#allow_failure SyntheticsTest#allow_failure}
        :param assertion: assertion block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#assertion SyntheticsTest#assertion}
        :param extracted_value: extracted_value block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#extracted_value SyntheticsTest#extracted_value}
        ...
        :param request_query: Query arguments name and value map. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request_query SyntheticsTest#request_query}
        :param retry: retry block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#retry SyntheticsTest#retry}
        :param subtype: The subtype of the Synthetic multi-step API test step. Valid values are ``http``, ``grpc``, ``wait``. Defaults to ``"http"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#subtype SyntheticsTest#subtype}
        :param value: The time to wait in seconds. Minimum value: 0. Maximum value: 180. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#value SyntheticsTest#value}
        '''
...
class SyntheticsTestApiStepAssertion:
    def __init__(
        ...
        *,
        ...
        :param property: If assertion type is ``header``, this is the header name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#property SyntheticsTest#property}
        ...
        :param targetjsonpath: targetjsonpath block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#targetjsonpath SyntheticsTest#targetjsonpath}
        :param targetjsonschema: targetjsonschema block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#targetjsonschema SyntheticsTest#targetjsonschema}
        :param targetxpath: targetxpath block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#targetxpath SyntheticsTest#targetxpath}
        :param timings_scope: Timings scope for response time assertions. Valid values are ``all``, ``withoutDNS``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#timings_scope SyntheticsTest#timings_scope}
        '''
...
class SyntheticsTestApiStepAssertionOutputReference(
    ...
    def put_targetjsonpath(
        ...
        *,
        ...
        '''
        :param jsonpath: The JSON path to assert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#jsonpath SyntheticsTest#jsonpath}
        :param operator: The specific operator to use on the path. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#operator SyntheticsTest#operator}
        ...
        :param targetvalue: Expected matching value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#targetvalue SyntheticsTest#targetvalue}
        '''
    ...
    def put_targetjsonschema(
        ...
        *,
        ...
        '''
        :param jsonschema: The JSON Schema to validate the body against. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#jsonschema SyntheticsTest#jsonschema}
        :param metaschema: The meta schema to use for the JSON Schema. Defaults to ``"draft-07"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#metaschema SyntheticsTest#metaschema}
        '''
    ...
    def put_targetxpath(
        ...
        *,
        ...
        '''
        :param operator: The specific operator to use on the path. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#operator SyntheticsTest#operator}
        :param xpath: The xpath to assert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#xpath SyntheticsTest#xpath}
        :param targetvalue: Expected matching value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#targetvalue SyntheticsTest#targetvalue}
        '''
...
class SyntheticsTestApiStepExtractedValue:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}.
        :param parser: parser block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#parser SyntheticsTest#parser}
        ...
        :param field: When type is ``http_header`` or ``grpc_metadata``, name of the header or metadatum to extract. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#field SyntheticsTest#field}
        :param secure: Determines whether or not the extracted value will be obfuscated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#secure SyntheticsTest#secure}
        '''
...
class SyntheticsTestApiStepExtractedValueOutputReference(
    ...
    def put_parser(
        ...
        *,
        ...
        '''
        :param type: Type of parser for a Synthetics global variable from a synthetics test. Valid values are ``raw``, ``json_path``, ``regex``, ``x_path``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        :param value: Regex or JSON path used for the parser. Not used with type ``raw``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#value SyntheticsTest#value}
        '''
...
class SyntheticsTestApiStepOutputReference(
    ...
    def put_retry(
        ...
        *,
        ...
        '''
        :param count: Number of retries needed to consider a location as failed before sending a notification alert. Defaults to ``0``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#count SyntheticsTest#count}
        :param interval: Interval between a failed test and the next retry in milliseconds. Defaults to ``300``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#interval SyntheticsTest#interval}
        '''
...
class SyntheticsTestApiStepRequestClientCertificateCert:
    def __init__(
        ...
        *,
        ...
        '''
        :param content: Content of the certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#content SyntheticsTest#content}
        :param filename: File name for the certificate. Defaults to ``"Provided in Terraform config"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#filename SyntheticsTest#filename}
        '''
        if __debug__:
...
class SyntheticsTestApiStepRequestFile:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Name of the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        :param size: Size of the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#size SyntheticsTest#size}
        :param type: Type of the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        :param content: Content of the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#content SyntheticsTest#content}
        :param original_file_name: Original name of the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#original_file_name SyntheticsTest#original_file_name}
        '''
        if __debug__:
...
class SyntheticsTestBrowserStep:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Name of the step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        :param params: params block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#params SyntheticsTest#params}
        ...
        :param allow_failure: Determines if the step should be allowed to fail. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#allow_failure SyntheticsTest#allow_failure}
        :param force_element_update: Force update of the "element" parameter for the step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#force_element_update SyntheticsTest#force_element_update}
        :param is_critical: Determines whether or not to consider the entire test as failed if this step fails. Can be used only if ``allow_failure`` is ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#is_critical SyntheticsTest#is_critical}
        :param no_screenshot: Prevents saving screenshots of the step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#no_screenshot SyntheticsTest#no_screenshot}
        :param timeout: Used to override the default timeout of a step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#timeout SyntheticsTest#timeout}
        '''
...
class SyntheticsTestBrowserStepOutputReference(
    ...
    def put_params(
        ...
        *,
        ...
        '''
        :param attribute: Name of the attribute to use for an "assert attribute" step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#attribute SyntheticsTest#attribute}
        ...
        :param click_type: Type of click to use for a "click" step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#click_type SyntheticsTest#click_type}
        :param code: Javascript code to use for the step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#code SyntheticsTest#code}
        :param delay: Delay between each key stroke for a "type test" step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#delay SyntheticsTest#delay}
        :param element: Element to use for the step, JSON encoded string. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#element SyntheticsTest#element}
        :param element_user_locator: element_user_locator block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#element_user_locator SyntheticsTest#element_user_locator}
        :param email: Details of the email for an "assert email" step, JSON encoded string. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#email SyntheticsTest#email}
        :param file: JSON encoded string used for an "assert download" step. Refer to the examples for a usage example showing the schema. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#file SyntheticsTest#file}
        :param files: Details of the files for an "upload files" step, JSON encoded string. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#files SyntheticsTest#files}
        :param modifiers: Modifier to use for a "press key" step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#modifiers SyntheticsTest#modifiers}
        :param playing_tab_id: ID of the tab to play the subtest. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#playing_tab_id SyntheticsTest#playing_tab_id}
        :param request: Request for an API step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#request SyntheticsTest#request}
        :param subtest_public_id: ID of the Synthetics test to use as subtest. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#subtest_public_id SyntheticsTest#subtest_public_id}
        :param value: Value of the step. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#value SyntheticsTest#value}
        :param variable: variable block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#variable SyntheticsTest#variable}
        :param with_click: For "file upload" steps. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#with_click SyntheticsTest#with_click}
        :param x: X coordinates for a "scroll step". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#x SyntheticsTest#x}
        :param y: Y coordinates for a "scroll step". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#y SyntheticsTest#y}
        '''
...
class SyntheticsTestBrowserStepParamsElementUserLocator:
    def __init__(
        ...
        *,
        ...
        '''
        :param value: value block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#value SyntheticsTest#value}
        :param fail_test_on_cannot_locate: Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#fail_test_on_cannot_locate SyntheticsTest#fail_test_on_cannot_locate}
        '''
...
class SyntheticsTestBrowserStepParamsElementUserLocatorOutputReference(
    ...
    def put_value(
        ...
        *,
        ...
        '''
        :param value: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#value SyntheticsTest#value}.
        :param type: Defaults to ``"css"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        '''
...
class SyntheticsTestBrowserStepParamsOutputReference(
    ...
    def put_variable(
        ...
        *,
        ...
        '''
        :param example: Example of the extracted variable. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#example SyntheticsTest#example}
        :param name: Name of the extracted variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        '''
...
class SyntheticsTestBrowserVariable:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Name of the variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        :param type: Type of browser test variable. Valid values are ``element``, ``email``, ``global``, ``javascript``, ``text``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        :param example: Example for the variable. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#example SyntheticsTest#example}
        ...
        :param pattern: Pattern of the variable. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#pattern SyntheticsTest#pattern}
        :param secure: Determines whether or not the browser test variable is obfuscated. Can only be used with a browser variable of type ``text`` Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#secure SyntheticsTest#secure}
        '''
        if __debug__:
...
class SyntheticsTestConfigVariable:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Name of the variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#name SyntheticsTest#name}
        :param type: Type of test configuration variable. Valid values are ``global``, ``text``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#type SyntheticsTest#type}
        ...
        :param secure: Whether the value of this variable will be obfuscated in test results. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#secure SyntheticsTest#secure}
        '''
        if __debug__:
...
class SyntheticsTestOptionsListCi:
    def __init__(self, *, execution_rule: typing.Optional[builtins.str] = None) -> None:
        '''
        :param execution_rule: Execution rule for a Synthetics test. Valid values are ``blocking``, ``non_blocking``, ``skipped``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#execution_rule SyntheticsTest#execution_rule}
        '''
        if __debug__:
...
class SyntheticsTestOptionsListRumSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param is_enabled: Determines whether RUM data is collected during test runs. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#is_enabled SyntheticsTest#is_enabled}
        :param application_id: RUM application ID used to collect RUM data for the browser test. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#application_id SyntheticsTest#application_id}
        :param client_token_id: RUM application API key ID used to collect RUM data for the browser test. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#client_token_id SyntheticsTest#client_token_id}
        '''
        if __debug__:
...
class SyntheticsTestOptionsListScheduling:
    def __init__(
        ...
        *,
        ...
        '''
        :param timeframes: timeframes block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#timeframes SyntheticsTest#timeframes}
        :param timezone: Timezone in which the timeframe is based. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#timezone SyntheticsTest#timezone}
        '''
        if __debug__:
...
class SyntheticsTestOptionsListSchedulingTimeframes:
    def __init__(
        ...
        *,
        ...
        '''
        :param day: Number representing the day of the week. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#day SyntheticsTest#day}
        :param from_: The hour of the day on which scheduling starts. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#from SyntheticsTest#from}
        :param to: The hour of the day on which scheduling ends. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/synthetics_test#to SyntheticsTest#to}
        '''
        if __debug__:
