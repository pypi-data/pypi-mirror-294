...
class SpansMetric(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the span-based metric. This field can't be updated after creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#name SpansMetric#name}
        :param compute: compute block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#compute SpansMetric#compute}
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#filter SpansMetric#filter}
        :param group_by: group_by block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#group_by SpansMetric#group_by}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SpansMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#import import section} in the documentation of this resource for the id to use
    ...
    def put_filter(self, *, query: typing.Optional[builtins.str] = None) -> None:
        '''
        :param query: The search query - following the span search syntax. Defaults to ``"*"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#query SpansMetric#query}
        '''
...
class SpansMetricGroupBy:
    def __init__(
        ...
        *,
        ...
        '''
        :param path: The path to the value the span-based metric will be aggregated over. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#path SpansMetric#path}
        :param tag_name: Eventual name of the tag that gets created. By default, the path attribute is used as the tag name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/spans_metric#tag_name SpansMetric#tag_name}
        '''
        if __debug__:
