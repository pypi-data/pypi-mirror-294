...
class AuthnMapping(
    ...
    def __init__(
        ...
        *,
        ...
        :param key: Identity provider key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/authn_mapping#key AuthnMapping#key}
        :param value: Identity provider value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/authn_mapping#value AuthnMapping#value}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/authn_mapping#id AuthnMapping#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param role: The ID of a role to attach to all users with the corresponding key and value. Cannot be used in conjunction with ``team``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/authn_mapping#role AuthnMapping#role}
        :param team: The ID of a team to add all users with the corresponding key and value to. Cannot be used in conjunction with ``role``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/authn_mapping#team AuthnMapping#team}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AuthnMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/authn_mapping#import import section} in the documentation of this resource for the id to use
