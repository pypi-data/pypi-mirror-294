...
Refer to the Terraform Registry for docs: [`datadog_integration_slack_channel`](https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel).
'''
...
class IntegrationSlackChannel(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_name: Slack account name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#account_name IntegrationSlackChannel#account_name}
        :param channel_name: Slack channel name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#channel_name IntegrationSlackChannel#channel_name}
        :param display: display block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#display IntegrationSlackChannel#display}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing IntegrationSlackChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#import import section} in the documentation of this resource for the id to use
    ...
    def put_display(
        ...
        *,
        ...
        '''
        :param message: Show the main body of the alert event. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#message IntegrationSlackChannel#message}
        :param notified: Show the list of.
        :param snapshot: Show the alert event's snapshot image. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#snapshot IntegrationSlackChannel#snapshot}
        :param tags: Show the scopes on which the monitor alerted. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/integration_slack_channel#tags IntegrationSlackChannel#tags}
        '''
