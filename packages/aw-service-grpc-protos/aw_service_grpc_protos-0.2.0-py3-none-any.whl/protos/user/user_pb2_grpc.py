...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CompanyVerification = channel.unary_unary(
                ...
                response_deserializer=user__pb2.CompanyVerificationResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CompanyVerification': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=user__pb2.CompanyVerificationResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def CompanyVerification(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            user__pb2.CompanyVerificationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
