...
Refer to the Terraform Registry for docs: [`vsphere_content_library_item`](https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item).
'''
...
class ContentLibraryItem(
    ...
    def __init__(
        ...
        *,
        ...
        :param library_id: ID of the content library to contain item. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#library_id ContentLibraryItem#library_id}
        :param name: The name of the content library item. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#name ContentLibraryItem#name}
        :param description: Optional description of the content library item. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#description ContentLibraryItem#description}
        :param file_url: ID of source VM of content library item. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#file_url ContentLibraryItem#file_url}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#id ContentLibraryItem#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param source_uuid: The managed object ID of an existing VM to be cloned to the content library. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#source_uuid ContentLibraryItem#source_uuid}
        :param type: Type of content library item. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#type ContentLibraryItem#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ContentLibraryItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/content_library_item#import import section} in the documentation of this resource for the id to use
