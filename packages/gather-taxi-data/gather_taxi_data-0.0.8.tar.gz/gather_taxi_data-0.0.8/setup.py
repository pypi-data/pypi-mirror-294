...
setup(
    name="gather-taxi-data",  # Replace with your package name
    version="0.0.8",  # Replace with your package version
    ...
    entry_points={
        "console_scripts": [
            "gather_taxi_data=gather_all_data:main",  # Replace with your CLI commands if needed
        ],
    },
)