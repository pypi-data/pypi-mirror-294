...
class Danila_balka_text_recognize_model_4(Danila_balka_text_recognize_model):
    def get_model(self, yolo_path):
        return Balka_Text_Recognize_yolo(model_path= LOCAL_RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS_4, yolo_path=yolo_path)

    def get_model_altai(self, yolo_path):
        return Balka_Text_Recognize_altai_yolo(model_path=LOCAL_RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS_4,
                                               yolo_path=yolo_path,
