...
class TeamRoleMapping(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping launchdarkly_team_role_mapping}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping launchdarkly_team_role_mapping} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param custom_role_keys: A set of custom role keys to assign to the team. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping#custom_role_keys TeamRoleMapping#custom_role_keys}
        :param team_key: The LaunchDarkly team key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping#team_key TeamRoleMapping#team_key}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TeamRoleMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping#import import section} in the documentation of this resource for the id to use
...
class TeamRoleMappingConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def custom_role_keys(self) -> typing.List[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping#custom_role_keys TeamRoleMapping#custom_role_keys}
        '''
    ...
    def team_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.2/docs/resources/team_role_mapping#team_key TeamRoleMapping#team_key}
        '''
