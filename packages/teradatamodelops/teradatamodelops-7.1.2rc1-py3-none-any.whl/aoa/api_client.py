...
class AoaClient(object):
    ...
    def projects(self):
        ...
        return ProjectApi(aoa_client=self)
    ...
    def datasets(self):
        ...
        return DatasetApi(aoa_client=self)
    ...
    def dataset_templates(self):
        ...
        return DatasetTemplateApi(aoa_client=self)
    ...
    def dataset_connections(self):
        ...
        return DatasetConnectionApi(aoa_client=self)
    ...
    def deployments(self):
        ...
        return DeploymentApi(aoa_client=self)
    ...
    def feature_engineering(self):
        ...
        from aoa import FeatureEngineeringApi

        return FeatureEngineeringApi(aoa_client=self)
    ...
    def jobs(self):
        ...
        from aoa import JobApi

        return JobApi(aoa_client=self)
    ...
    def job_events(self):
        ...
        from aoa import JobEventApi

        return JobEventApi(aoa_client=self)
    ...
    def messages(self):
        ...
        return MessageApi(aoa_client=self)
    ...
    def models(self):
        ...
        return ModelApi(aoa_client=self)
    ...
    def trained_models(self):
        ...
        from aoa import TrainedModelApi

        return TrainedModelApi(aoa_client=self)
    ...
    def trained_model_artefacts(self):
        ...
        return TrainedModelArtefactsApi(aoa_client=self)
    ...
    def trained_model_events(self):
        ...
        from aoa import TrainedModelEventApi

        return TrainedModelEventApi(aoa_client=self)
    ...
    def user_attributes(self):
        ...
        return UserAttributesApi(aoa_client=self)
