...
//
extern Result stash_closeDB(long long unsigned int dbH);
...
//
extern Result stash_createStash(long long unsigned int dbH, char* identity, char* url, char* config);

// stash_openStash opens an existing safe with the specified identity and URL. The function returns a handle to the stash.
//
extern Result stash_openStash(long long unsigned int dbH, char* identity, char* url);

// stash_closeStash closes the specified stash.
//
extern Result stash_closeStash(long long unsigned int safeH);
...
//
extern Result stash_updateGroup(long long unsigned int safeH, char* groupName, long int change, char* users);

// stash_getGroups returns all the groups in the specified stash. It is a map of group names to a list of identity IDs.
//
extern Result stash_getGroups(long long unsigned int safeH);
...
//
extern Result stash_getKeys(long long unsigned int safeH, char* groupName, long int expectedMinimumLenght);

// stash_openFS opens a file system in the specified stash. The function returns a handle to the file system.
//
extern Result stash_openFS(long long unsigned int safeH);

// stash_closeFS closes the specified file system.
//
extern Result stash_closeFS(long long unsigned int fsH);
...
//
extern Result stash_list(long long unsigned int fsH, char* path, char* options);

// stash_stat returns the information of the specified file in the file system. The function returns the file information.
//
extern Result stash_stat(long long unsigned int fsH, char* path);
...
//
extern Result stash_putFile(long long unsigned int fsH, char* dest, char* src, char* options);

// stash_putData puts the specified data to the specified path in the file system. The function returns the file information.
//
extern Result stash_putData(long long unsigned int fsH, char* dest, Data data, char* options);
...
//
extern Result stash_getFile(long long unsigned int fsH, char* src, char* dest, char* options);

// stash_getData gets the specified data in the file system. The function returns the data.
//
extern Result stash_getData(long long unsigned int fsH, char* src, char* options);

// stash_delete deletes the specified file in the file system.
//
extern Result stash_delete(long long unsigned int fsH, char* path);

// stash_rename renames the specified file in the file system.
//
extern Result stash_rename(long long unsigned int fsH, char* oldPath, char* newPath);
...
//
extern Result stash_openDatabase(long long unsigned int safeH, char* groupName, char* ddls);

// stash_closeDatabase closes the specified database connection.
//
extern Result stash_closeDatabase(long long unsigned int dbH);
...
//
extern Result stash_exec(long long unsigned int dbH, char* query, char* args);
...
//
extern Result stash_rewind(long long unsigned int commH, char* dest, long long unsigned int messageID);

// stash_send sends a message to the specified user.
//
extern Result stash_send(long long unsigned int commH, char* userId, char* message);

// stash_broadcast broadcasts a message to the specified group.
//
extern Result stash_broadcast(long long unsigned int commH, char* groupName, char* message);
...
//
extern Result stash_receive(long long unsigned int commH, char* filter);

// stash_download downloads a file attached to a message to the specified destination in the local filesystem.
//
extern Result stash_download(long long unsigned int commH, char* message, char* dest);
