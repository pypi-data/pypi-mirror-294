...
//
extern __declspec(dllexport) Result stash_setLogLevel(char* level);
extern __declspec(dllexport) Result stash_test(char* nick);
...
//
extern __declspec(dllexport) Result stash_newIdentity(char* nick);

// stash_nick returns the nick name of the specified identity.
//
extern __declspec(dllexport) Result stash_nick(char* identity);

// stash_castID casts the specified string to an Identity ID.
//
extern __declspec(dllexport) Result stash_castID(char* id);
extern __declspec(dllexport) Result stash_decodeKeys(char* id);
...
//
extern __declspec(dllexport) Result stash_openDB(char* url);

// stash_closeDB closes the specified database connection.
//
extern __declspec(dllexport) Result stash_closeDB(long long unsigned int dbH);
...
//
extern __declspec(dllexport) Result stash_createStash(long long unsigned int dbH, char* identity, char* url, char* config);

// stash_openStash opens an existing safe with the specified identity and URL. The function returns a handle to the stash.
//
extern __declspec(dllexport) Result stash_openStash(long long unsigned int dbH, char* identity, char* url);

// stash_closeStash closes the specified stash.
//
extern __declspec(dllexport) Result stash_closeStash(long long unsigned int safeH);
...
//
extern __declspec(dllexport) Result stash_updateGroup(long long unsigned int safeH, char* groupName, long int change, char* users);

// stash_getGroups returns all the groups in the specified stash. It is a map of group names to a list of identity IDs.
//
extern __declspec(dllexport) Result stash_getGroups(long long unsigned int safeH);
...
//
extern __declspec(dllexport) Result stash_getKeys(long long unsigned int safeH, char* groupName, long int expectedMinimumLenght);

// stash_openFS opens a file system in the specified stash. The function returns a handle to the file system.
//
extern __declspec(dllexport) Result stash_openFS(long long unsigned int safeH);

// stash_closeFS closes the specified file system.
//
extern __declspec(dllexport) Result stash_closeFS(long long unsigned int fsH);
...
//
extern __declspec(dllexport) Result stash_list(long long unsigned int fsH, char* path, char* options);

// stash_stat returns the information of the specified file in the file system. The function returns the file information.
//
extern __declspec(dllexport) Result stash_stat(long long unsigned int fsH, char* path);
...
//
extern __declspec(dllexport) Result stash_putFile(long long unsigned int fsH, char* dest, char* src, char* options);

// stash_putData puts the specified data to the specified path in the file system. The function returns the file information.
//
extern __declspec(dllexport) Result stash_putData(long long unsigned int fsH, char* dest, Data data, char* options);
...
//
extern __declspec(dllexport) Result stash_getFile(long long unsigned int fsH, char* src, char* dest, char* options);

// stash_getData gets the specified data in the file system. The function returns the data.
//
extern __declspec(dllexport) Result stash_getData(long long unsigned int fsH, char* src, char* options);

// stash_delete deletes the specified file in the file system.
//
extern __declspec(dllexport) Result stash_delete(long long unsigned int fsH, char* path);

// stash_rename renames the specified file in the file system.
//
extern __declspec(dllexport) Result stash_rename(long long unsigned int fsH, char* oldPath, char* newPath);
...
//
extern __declspec(dllexport) Result stash_openDatabase(long long unsigned int safeH, char* groupName, char* ddls);

// stash_closeDatabase closes the specified database connection.
//
extern __declspec(dllexport) Result stash_closeDatabase(long long unsigned int dbH);
...
//
extern __declspec(dllexport) Result stash_exec(long long unsigned int dbH, char* query, char* args);
...
//
extern __declspec(dllexport) Result stash_query(long long unsigned int dbH, char* key, char* args);

// stash_nextRow returns the next row in the result set. The function returns the values of the row as a list.
//
extern __declspec(dllexport) Result stash_nextRow(long long unsigned int rowsH);

// stash_closeRows closes the specified result set.
//
extern __declspec(dllexport) Result stash_closeRows(long long unsigned int rowsH);

// stash_sync synchronizes the database with the stash. The function returns the number of updates.
//
extern __declspec(dllexport) Result stash_sync(long long unsigned int dbH);

// stash_cancel cancels the current database operation
//
extern __declspec(dllexport) Result stash_cancel(long long unsigned int dbH);

// stash_openComm opens a point to point communication channel for the specified stash.
//
extern __declspec(dllexport) Result stash_openComm(long long unsigned int safeH);
...
//
extern __declspec(dllexport) Result stash_rewind(long long unsigned int commH, char* dest, long long unsigned int messageID);

// stash_send sends a message to the specified user.
//
extern __declspec(dllexport) Result stash_send(long long unsigned int commH, char* userId, char* message);

// stash_broadcast broadcasts a message to the specified group.
//
extern __declspec(dllexport) Result stash_broadcast(long long unsigned int commH, char* groupName, char* message);
...
//
extern __declspec(dllexport) Result stash_receive(long long unsigned int commH, char* filter);

// stash_download downloads a file attached to a message to the specified destination in the local filesystem.
//
extern __declspec(dllexport) Result stash_download(long long unsigned int commH, char* message, char* dest);
