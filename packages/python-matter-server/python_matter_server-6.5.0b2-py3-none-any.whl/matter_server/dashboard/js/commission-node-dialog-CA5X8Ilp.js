import{_ as i,n as o,r as e,t as s,s as t,x as d}from"./matter-dashboard-app-CE7argVb.js";import{p as n}from"./prevent_default-DThrK0lQ.js";let m=class extends t{render(){return d`
    ...
    `}_commissionWifi(){this.client.serverInfo.bluetooth_enabled&&(import("./commission-node-wifi-C-cmXpZU.js"),this._mode="wifi")}_commissionThread(){this.client.serverInfo.bluetooth_enabled&&(import("./commission-node-thread-Qa5hqs-X.js"),this._mode="thread")}_commissionExisting(){import("./commission-node-existing-DSXt8oK8.js"),this._mode="existing"}_nodeCommissioned(i){window.location.href=`#node/${i.detail.node_id}`,this._close()}_close(){this.shadowRoot.querySelector("md-dialog").close()}_handleClosed(){this.parentNode.removeChild(this)}};i([o({attribute:!1})],m.prototype,"client",void 0),i([e()],m.prototype,"_mode",void 0),m=i([s("commission-node-dialog")],m);export{m as ComissionNodeDialog};
