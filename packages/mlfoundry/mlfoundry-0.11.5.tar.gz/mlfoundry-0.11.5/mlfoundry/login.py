...
from mlfoundry.tracking.auth_service import AuthServiceClient
...
def login(
    ...
    auth_service = AuthServiceClient.from_base_url(tracking_uri)
    ...
    with cred_file:
        ...
        if api_key:
            ...
            if device_code.complete_verification_url:
                ...
                auto_open_url = device_code.get_user_clickable_url(
                    tracking_uri=tracking_uri
                )
            if auto_open_url:
                print(f"Opening:- {auto_open_url}")
