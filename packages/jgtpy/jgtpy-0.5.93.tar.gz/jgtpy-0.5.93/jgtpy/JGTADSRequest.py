...
class JGTADSRequest(JGTCDSRequest):
    ...
    @staticmethod
    def new_feature_plot(instrument,timeframe,feature_plot:int,*args, **kwargs):
        cc = JGTChartConfig.new_feature_plot(feature_plot)
        return JGTADSRequest(instrument=instrument,timeframe=timeframe,cc=cc,*args, **kwargs)
