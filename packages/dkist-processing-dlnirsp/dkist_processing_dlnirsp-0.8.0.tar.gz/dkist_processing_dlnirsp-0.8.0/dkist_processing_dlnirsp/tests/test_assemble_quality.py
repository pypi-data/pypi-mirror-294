...
def test_correct_polcal_label_list(dlnirsp_assemble_quality_data_task, quality_assemble_data_mock):
    """
    ...
    task()
    quality_assemble_data_mock.assert_called_once_with(task, polcal_label_list=["IFU"])
