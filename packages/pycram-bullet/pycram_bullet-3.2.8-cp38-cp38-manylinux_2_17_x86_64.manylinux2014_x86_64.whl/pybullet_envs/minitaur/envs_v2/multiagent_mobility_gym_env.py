...
from pycram_bullet_envs.minitaur.envs_v2 import locomotion_gym_env
...
class MultiagentMobilityGymEnv(locomotion_gym_env.LocomotionGymEnv):
  ...
  def step(self, actions):
    ...
    if self._is_render:
      ...
      [yaw, pitch,
       dist] = self._pycram_bullet_client.getDebugVisualizerCamera()[8:11]
