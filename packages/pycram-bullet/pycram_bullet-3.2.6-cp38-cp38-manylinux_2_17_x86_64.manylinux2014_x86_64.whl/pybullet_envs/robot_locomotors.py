...
def get_cube(_p, x, y, z):
  body = _p.loadURDF(os.path.join(pycram_bullet_data.getDataPath(), "cube_small.urdf"), [x, y, z])
...
def get_sphere(_p, x, y, z):
  body = _p.loadURDF(os.path.join(pycram_bullet_data.getDataPath(), "sphere2red_nocol.urdf"), [x, y, z])
  part_name, _ = _p.getBodyInfo(body)
  part_name = part_name.decode("utf8")
  bodies = [body]
  return BodyPart(_p, part_name, bodies, 0, -1)
