"""Tests for pycram_bullet_envs.minitaur.envs.locomotion_gym_config."""
...
import gin
from pycram_bullet_envs.minitaur.envs_v2 import locomotion_gym_config
import unittest
...
class LocomotionGymConfigTest(unittest.TestCase):
  ...
  def testSimulationParametersFromGinString(self):
    config_text = (
        'import pycram_bullet_envs.minitaur'
