...
import time
import numpy as np
import pycram_bullet_robots.panda.panda_sim_grasp as panda_sim
...
if createVideo:
	p.connect(p.GUI, options="--minGraphicsUpdateTimeMs=0 --mp4=\"pycram_bullet_grasp.mp4\" --mp4fps="+str(fps) )
else:
	p.connect(p.GUI)
