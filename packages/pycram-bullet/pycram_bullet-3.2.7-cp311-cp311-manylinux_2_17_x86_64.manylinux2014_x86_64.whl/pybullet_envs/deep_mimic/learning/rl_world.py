import numpy as np
import pycram_bullet_envs.deep_mimic.learning.agent_builder as AgentBuilder
import pycram_bullet_envs.deep_mimic.learning.tf_util as TFUtil
from pycram_bullet_envs.deep_mimic.learning.rl_agent import RLAgent
      ...
      if curr_agent is not None:
        ...
        if (len(model_files) > 0):
          ...
          if curr_model_file != 'none':
            curr_agent.load_model(pycram_bullet_data.getDataPath() + "/" + curr_model_file)
