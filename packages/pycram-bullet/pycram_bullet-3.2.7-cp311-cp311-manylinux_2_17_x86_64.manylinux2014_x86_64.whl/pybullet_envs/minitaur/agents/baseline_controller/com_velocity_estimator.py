...
from pycram_bullet_envs.minitaur.robots.safety.python import moving_window_filter
...
class COMVelocityEstimator(state_estimator.StateEstimatorBase):
  ...
  def update(self, current_time):
    ...
    _, inverse_rotation = self._robot.pycram_bullet_client.invertTransform(
        (0, 0, 0), base_orientation)

    self._com_velocity_body_yaw_aligned_frame, _ = (
        self._robot.pycram_bullet_client.multiplyTransforms(
