...
from pycram_bullet_envs.minitaur.agents.baseline_controller import com_velocity_estimator
from pycram_bullet_envs.minitaur.agents.baseline_controller import imu_based_com_velocity_estimator
from pycram_bullet_envs.minitaur.agents.baseline_controller import locomotion_controller
from pycram_bullet_envs.minitaur.agents.baseline_controller import openloop_gait_generator
from pycram_bullet_envs.minitaur.agents.baseline_controller import raibert_swing_leg_controller
...
def load_sim_config(render=True):
  ...
  # jacobians, as we are directly calling the pycram_bullet API. We will try to fix
  # this by loading a separate pycram_bullet instance, set the pose and joint
