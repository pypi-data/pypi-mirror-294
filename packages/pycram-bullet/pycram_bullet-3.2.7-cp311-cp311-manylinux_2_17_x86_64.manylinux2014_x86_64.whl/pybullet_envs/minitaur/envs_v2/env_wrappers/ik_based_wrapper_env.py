...
import gym
import numpy as np
from pycram_bullet_envs.minitaur.robots import vision60
...
class IKBasedWrapperEnv(object):
  ...
  def __init__(self,
    ...
    Args:
      ...
      toe_indices: A list of four pycram_bullet joint indices for the four toes. [3,
        7, 11, 15] for the vision60.
      abduction_motor_ids: A list of four pycram_bullet joint indices for the four
