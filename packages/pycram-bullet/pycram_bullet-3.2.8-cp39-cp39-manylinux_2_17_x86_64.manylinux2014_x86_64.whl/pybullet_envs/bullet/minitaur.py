...
class Minitaur(object):
  ...
  def _RecordMassInfoFromURDF(self):
    self._base_mass_urdf = self._pycram_bullet_client.getDynamicsInfo(self.quadruped, BASE_LINK_ID)[0]
    self._leg_masses_urdf = []
    self._leg_masses_urdf.append(
        self._pycram_bullet_client.getDynamicsInfo(self.quadruped, LEG_LINK_ID[0])[0])
    self._leg_masses_urdf.append(
        self._pycram_bullet_client.getDynamicsInfo(self.quadruped, MOTOR_LINK_ID[0])[0])
  ...
  def Reset(self, reload_urdf=True):
    ...
    if reload_urdf:
      ...
      if self._on_rack:
        self._pycram_bullet_client.createConstraint(self.quadruped, -1, -1, -1,
                                               self._pycram_bullet_client.JOINT_FIXED, [0, 0, 0],
                                               [0, 0, 0], [0, 0, 1])
    else:
  ...
  def SetBaseMass(self, base_mass):
    self._pycram_bullet_client.changeDynamics(self.quadruped, BASE_LINK_ID, mass=base_mass)
  ...
  def SetLegMasses(self, leg_masses):
    ...
    for link_id in LEG_LINK_ID:
      self._pycram_bullet_client.changeDynamics(self.quadruped, link_id, mass=leg_masses[0])
    for link_id in MOTOR_LINK_ID:
      self._pycram_bullet_client.changeDynamics(self.quadruped, link_id, mass=leg_masses[1])
