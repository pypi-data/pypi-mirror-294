...
from pycram_bullet_envs.deep_mimic.learning.ppo_agent import PPOAgent

import pycram_bullet_data
from pycram_bullet_utils.arg_parser import ArgParser
from pycram_bullet_utils.logger import Logger
from pycram_bullet_envs.deep_mimic.env.pycram_bullet_deep_mimic_env_multiclip import PyBulletDeepMimicEnvMultiClip
import sys
import random
...
def build_arg_parser(args):
    ...
    if (arg_file != ''):
        path = pycram_bullet_data.getDataPath() + "/args/" + arg_file
...
def build_world(args, enable_draw):
    ...
    agent_files = pycram_bullet_data.getDataPath() + "/" + arg_parser.parse_string("agent_files")
...
if __name__ == '__main__':
    ...
    while (world.env._pycram_bullet_client.isConnected()):
