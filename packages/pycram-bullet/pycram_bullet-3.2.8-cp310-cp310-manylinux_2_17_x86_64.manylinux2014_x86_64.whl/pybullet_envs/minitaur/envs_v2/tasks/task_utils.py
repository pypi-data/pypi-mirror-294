...
def front_vector(pycram_bullet_client, orientation):
  """Calculates the front vector of the robot on x-y plane.

  Args:
    pycram_bullet_client: Pybullet client instantiation.
    orientation: Orientation of the robot in quaternion form.

  Returns:
    3D vector where z component is set to 0.
  """
  rot_matrix = pycram_bullet_client.getMatrixFromQuaternion(orientation)
