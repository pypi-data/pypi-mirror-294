...
from pycram_bullet_envs.minitaur.envs_v2.sensors import base_position_sensor
from pycram_bullet_envs.minitaur.envs_v2.sensors import sensor as generic_sensor
...
class OrcaController(CrowdController):
  ...
  def __init__(
    ...
    Args:
      ...
      workaround_erp_issue: There is an issue with pycram_bullet constraint that the
