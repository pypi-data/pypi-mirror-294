...
from pycram_bullet_envs.minitaur.vision import sim_camera
...
class CameraSensor(sensor.Sensor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      parent_link_id: The pycram_bullet link id, where the camera is mounted on.
  ...
  def set_robot(self, robot):
    ...
    self._camera = sim_camera.MountedCamera(
        pycram_bullet_client=robot.pycram_bullet_client,
