...
from pycram_bullet_envs.minitaur.envs_v2.utilities import env_utils_v2 as env_utils
from pycram_bullet_envs.minitaur.envs_v2.utilities import termination_reason as tr
...
def default_terminal_condition_for_minitaur(env):
  ...
  rot_mat = env.pycram_bullet_client.getMatrixFromQuaternion(orientation)
  local_up = rot_mat[6:]
...
def default_terminal_condition_for_laikago_v2(
  ...
  if enforce_foot_contacts:
    ...
    contacts = env.pycram_bullet_client.getContactPoints(bodyA=env.robot.robot_id)
