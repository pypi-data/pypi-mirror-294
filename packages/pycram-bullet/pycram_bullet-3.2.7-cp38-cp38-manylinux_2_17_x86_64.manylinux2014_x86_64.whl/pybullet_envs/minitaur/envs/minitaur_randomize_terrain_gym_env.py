...
class MinitaurRandomizeTerrainGymEnv(minitaur_gym_env.MinitaurGymEnv):
  ...
  def reset(self):
    ...
    terrain_collision_shape_id = self._pycram_bullet_client.createCollisionShape(
        shapeType=self._pycram_bullet_client.GEOM_MESH,
        fileName=terrain_file_name,
        flags=1,
        meshScale=[0.5, 0.5, 0.5])
    self._pycram_bullet_client.createMultiBody(terrain_mass, terrain_collision_shape_id,
