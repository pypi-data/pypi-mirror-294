...
import numpy as np
from pycram_bullet_envs.minitaur.envs import motor
...
class Minitaur(object):
  ...
  def _RecordInertiaInfoFromURDF(self):
    ...
    for body_id in range(-1, num_bodies):  # -1 is for the base link.
      inertia = self._pycram_bullet_client.getDynamicsInfo(self.quadruped, body_id)[2]
  ...
  def _RemoveDefaultJointDamping(self):
    ...
    for i in range(num_joints):
      joint_info = self._pycram_bullet_client.getJointInfo(self.quadruped, i)
      self._pycram_bullet_client.changeDynamics(joint_info[0], -1, linearDamping=0, angularDamping=0)
  ...
  def Reset(self, reload_urdf=True, default_motor_angles=None, reset_time=3.0):
    ...
    if reload_urdf:
      if self._self_collision_enabled:
        ...
        self.quadruped = self._pycram_bullet_client.loadURDF("%s/quadruped/minitaur.urdf" %
                                                        self._urdf_root,
                                                        init_position,
                                                        useFixedBase=self._on_rack)
      ...
      self._pycram_bullet_client.resetBasePositionAndOrientation(self.quadruped, init_position,
                                                            INIT_ORIENTATION)
      self._pycram_bullet_client.resetBaseVelocity(self.quadruped, [0, 0, 0], [0, 0, 0])
  ...
  def _SetMotorTorqueById(self, motor_id, torque):
    self._pycram_bullet_client.setJointMotorControl2(bodyIndex=self.quadruped,
                                                jointIndex=motor_id,
  ...
  def _ResetPoseForLeg(self, leg_id, add_constraint):
    ...
    self._pycram_bullet_client.resetJointState(self.quadruped,
    ...
    if add_constraint:
      self._pycram_bullet_client.createConstraint(
          ...
          self._pycram_bullet_client.JOINT_POINT2POINT, [0, 0, 0], KNEE_CONSTRAINT_POINT_RIGHT,
  ...
  def GetBasePosition(self):
    ...
    """
    position, _ = (self._pycram_bullet_client.getBasePositionAndOrientation(self.quadruped))
    return position
  ...
  def GetBaseRollPitchYaw(self):
    ...
    delayed_roll_pitch_yaw = self._pycram_bullet_client.getEulerFromQuaternion(delayed_orientation)
  ...
  def GetTrueMotorAngles(self):
    ...
    """
    motor_angles = [
        self._pycram_bullet_client.getJointState(self.quadruped, motor_id)[0]
  ...
  def GetTrueMotorVelocities(self):
    ...
    """
    motor_velocities = [
        self._pycram_bullet_client.getJointState(self.quadruped, motor_id)[1]
        for motor_id in self._motor_id_list
    ]
  ...
  def GetTrueMotorTorques(self):
    ...
    if self._accurate_motor_model_enabled or self._pd_control_enabled:
      ...
      motor_torques = [
          self._pycram_bullet_client.getJointState(self.quadruped, motor_id)[3]
          for motor_id in self._motor_id_list
      ]
  ...
  def GetTrueBaseOrientation(self):
    ...
    """
    _, orientation = (self._pycram_bullet_client.getBasePositionAndOrientation(self.quadruped))
    return orientation
  ...
  def GetBaseOrientation(self):
    ...
    """
    return self._pycram_bullet_client.getQuaternionFromEuler(self.GetBaseRollPitchYaw())
  ...
  def GetTrueBaseRollPitchYawRate(self):
    ...
    """
    vel = self._pycram_bullet_client.getBaseVelocity(self.quadruped)
  ...
  def SetBaseMasses(self, base_mass):
    ...
    for chassis_id, chassis_mass in zip(self._chassis_link_ids, base_mass):
      self._pycram_bullet_client.changeDynamics(self.quadruped, chassis_id, mass=chassis_mass)
  ...
  def SetLegMasses(self, leg_masses):
    ...
    for leg_id, leg_mass in zip(self._leg_link_ids, leg_masses):
      self._pycram_bullet_client.changeDynamics(self.quadruped, leg_id, mass=leg_mass)
    motor_masses = leg_masses[len(self._leg_link_ids):]
    for link_id, motor_mass in zip(self._motor_link_ids, motor_masses):
      self._pycram_bullet_client.changeDynamics(self.quadruped, link_id, mass=motor_mass)
  ...
  def SetBaseInertias(self, base_inertias):
    ...
    for chassis_id, chassis_inertia in zip(self._chassis_link_ids, base_inertias):
      ...
      self._pycram_bullet_client.changeDynamics(self.quadruped,
                                           chassis_id,
  ...
  def SetFootFriction(self, foot_friction):
    ...
    for link_id in self._foot_link_ids:
      self._pycram_bullet_client.changeDynamics(self.quadruped, link_id, lateralFriction=foot_friction)
  ...
  def SetFootRestitution(self, foot_restitution):
    ...
    """
    for link_id in self._foot_link_ids:
      self._pycram_bullet_client.changeDynamics(self.quadruped, link_id, restitution=foot_restitution)
