...
class MinitaurBallGymEnv(minitaur_gym_env.MinitaurGymEnv):
  ...
  def reset(self):
    ...
    self._ball_id = self._pycram_bullet_client.loadURDF(
  ...
  def _get_observation(self):
    world_translation_minitaur, world_rotation_minitaur = (
        self._pycram_bullet_client.getBasePositionAndOrientation(self.minitaur.quadruped))
    world_translation_ball, world_rotation_ball = (
        self._pycram_bullet_client.getBasePositionAndOrientation(self._ball_id))
    minitaur_translation_world, minitaur_rotation_world = (self._pycram_bullet_client.invertTransform(
        world_translation_minitaur, world_rotation_minitaur))
    minitaur_translation_ball, _ = (self._pycram_bullet_client.multiplyTransforms(
  ...
  def _distance_to_ball(self):
    world_translation_minitaur, _ = (self._pycram_bullet_client.getBasePositionAndOrientation(
        self.minitaur.quadruped))
    world_translation_ball, _ = (self._pycram_bullet_client.getBasePositionAndOrientation(
        self._ball_id))
