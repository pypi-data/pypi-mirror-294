"""This file implements the functionalities of a minitaur derpy using pycram_bullet.
  ...
  def Reset(self, reload_urdf=True, default_motor_angles=None, reset_time=3.0):
    ...
    if reload_urdf:
      if self._self_collision_enabled:
        ...
        self.quadruped = self._pycram_bullet_client.loadURDF("%s/quadruped/minitaur_derpy.urdf" %
                                                        self._urdf_root,
                                                        init_position,
                                                        useFixedBase=self._on_rack)
