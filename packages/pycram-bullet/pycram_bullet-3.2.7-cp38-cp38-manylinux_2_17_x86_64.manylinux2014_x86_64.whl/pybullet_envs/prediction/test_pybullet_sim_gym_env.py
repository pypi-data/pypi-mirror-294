...
import math
import numpy as np
from pycram_bullet_envs.prediction import pycram_bullet_sim_gym_env
import argparse
import time
...
def ResetPoseExample(steps):
  ...
  environment = pycram_bullet_sim_gym_env.PyBulletSimGymEnv(pycram_bullet_sim_factory=boxstack_pycram_bullet_sim,
