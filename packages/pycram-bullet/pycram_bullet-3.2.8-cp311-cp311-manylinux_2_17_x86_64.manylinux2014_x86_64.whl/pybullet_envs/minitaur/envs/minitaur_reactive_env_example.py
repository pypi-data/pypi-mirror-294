...
from pycram_bullet_envs.minitaur.agents.scripts import utility
import pycram_bullet_data
from pycram_bullet_envs.minitaur.envs import simple_ppo_agent

flags = tf.app.flags
FLAGS = tf.app.flags.FLAGS
LOG_DIR = os.path.join(pycram_bullet_data.getDataPath(), "policies/ppo/minitaur_reactive_env")
