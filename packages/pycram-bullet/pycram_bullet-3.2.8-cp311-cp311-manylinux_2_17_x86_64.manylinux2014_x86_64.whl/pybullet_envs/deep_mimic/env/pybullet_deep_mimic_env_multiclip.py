...
import time
from pycram_bullet_envs.deep_mimic.env import motion_capture_data_multiclip
from pycram_bullet_envs.deep_mimic.env import humanoid_stable_pd_multiclip
...
class PyBulletDeepMimicEnvMultiClip(Env):
    ...
    def reset(self):
        ...
        if not self._isInitialized:
            ...
            useFixedBase = False
            self._humanoid = humanoid_stable_pd_multiclip.HumanoidStablePDMultiClip(self._pycram_bullet_client, self._mocapData,
