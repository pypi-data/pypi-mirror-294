...
from pycram_bullet_envs.minitaur.agents.baseline_controller import locomotion_controller_setup
from pycram_bullet_envs.minitaur.envs_v2 import env_loader

FLAGS = flags.FLAGS

SCENARIO_SET_CONFIG = """
import pycram_bullet_envs.minitaur.envs_v2.scenarios.locomotion_simple_scenario_set
