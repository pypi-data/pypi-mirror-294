...
import time
import subprocess
import pycram_bullet as p2
import pycram_bullet_data
from pycram_bullet_utils import bullet_client as bc
from pkg_resources import parse_version
from pycram_bullet_envs.deep_mimic.env.pycram_bullet_deep_mimic_env import PyBulletDeepMimicEnv, InitializationStrategy
...
class HumanoidDeepBulletEnv(gym.Env):
  ...
  def reset(self):
    ...
    self._p = self._internal_env._pycram_bullet_client
