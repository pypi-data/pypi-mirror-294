...
import gin
import numpy as np
from pycram_bullet_utils import transformations
from pycram_bullet_envs.minitaur.envs_v2.utilities import laikago_pose_utils
from pycram_bullet_envs.minitaur.robots import laikago_constants
from pycram_bullet_envs.minitaur.robots import laikago_motor
from pycram_bullet_envs.minitaur.robots import minitaur
...
class Laikago(minitaur.Minitaur):
  ...
  def GetFootContacts(self):
    all_contacts = self._pycram_bullet_client.getContactPoints(bodyA=self.quadruped)
