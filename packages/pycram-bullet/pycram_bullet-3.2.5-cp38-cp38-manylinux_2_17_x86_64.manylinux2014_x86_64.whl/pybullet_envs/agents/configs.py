...
from pycram_bullet_envs.bullet import minitaur_gym_env
from pycram_bullet_envs.bullet import minitaur_duck_gym_env
from pycram_bullet_envs.bullet import minitaur_env_randomizer
import pycram_bullet_envs.bullet.minitaur_gym_env as minitaur_gym_env
...
def pycram_bullet_doublependulum():
  locals().update(default())
...
def pycram_bullet_pendulumswingup():
  locals().update(default())
...
def pycram_bullet_kuka_grasping():
...
def pycram_bullet_duck_minitaur():
