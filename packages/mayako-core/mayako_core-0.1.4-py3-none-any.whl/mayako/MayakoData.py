...
class MayakoData(Observable):
    ...
    mc_capabilities: List[MicroControllerCapabilities]
    """
    Example for data:
    {
        "MC01": {
    ...
    the data is cast to the associated model class when it is transfered to the sensors themselves
    """
    data: Dict[str, Dict[str, Dict[str, List[Dict]]]]
    #sensor and actuator capabilities are in mc_capabilities
    ...
    def __init__(self) -> None:
        ...
        #self._save_to_file() #can we savely remove this? dont know why we have this here
