import lastmile_auto_eval.__generated__.status_pb2 as _status_pb2
...
class DataEntry(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., requestIndex: _Optional[int] = ..., data: _Optional[_Mapping[str, str]] = ...) -> None: ...
