...
def obfuscate_module_fake_init(folder_path: str, new_folder_name=None, syspath: str | None = None):
    if syspath:
...
def obfuscate_module(folder_path: str, new_folder_name=None, syspath: str | None = None):
    if syspath:
        sys.path.insert(1, syspath)
    ...
    obfuscate(folder_name, f"{new_folder_name}")
