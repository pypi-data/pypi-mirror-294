...
class m:
        ...
        try:
            if token:
                ...
                if idinfo:
                    ...
                    response.headers.add('Set-Cookie',f"authToken=abcdef; Domain={cookie_domain}; HttpOnly; Path=/; SameSite=None; Secure")
            ...
            self.insert_log(invoking_function_name, error_message, sqlite_db_path)
    ...
    def send_telegram_message(self, invoking_function_name, message, preset_name):
        ...
        try:
            ...
            self.insert_log(invoking_function_name, f"Failed to send Telegram message: {e}", sqlite_db_path)
