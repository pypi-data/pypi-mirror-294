...
class m:
    ...
    def validate_email(self, invoking_function_name, request, sqlite_db_path, gmail_bot_preset_name, telegram_bot_preset_name):
        ...
        def get_gmail_bot_details(config, preset_name):
            ...
            return preset.get("email"), service_account_credentials_path
        ...
        def send_email(sender_email_id, service_account_credentials_path, recipient_email, subject, message_text):
            ...
            try:
                ...
                debug_message = f"TEMP PASSWORD EMAIL: \n\n MESSAGE ID: {message['id']} \n\n TO: {recipient_email} \n\n FROM: {sender_email_id} \n\n SUBJECT: {subject}\n]n BODY: {message_text}"
        ...
        # Load configuration
        config = load_config()
        sender_email_id, service_account_credentials_path = get_gmail_bot_details(config, gmail_bot_preset_name)
        ...
        try:
            ...
            email_message = f"Your temporary password is: {temp_password}. Please use this password to set a new password."
            debug_message = send_email(sender_email_id, service_account_credentials_path, email, email_subject, email_message)
