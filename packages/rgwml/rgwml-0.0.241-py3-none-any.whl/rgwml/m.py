...
class m:
    ...
    def validate_email(self, invoking_function_name, request, sqlite_db_path, telegram_bot_preset_name):
        ...
        try:
            ...
            if email.endswith('@gmail.com') or (user and user[0]):  # user[0] corresponds to google_auth_user_id
                return jsonify(success=False, message="Please use 'Sign in with Gmail'. Your account is attached to your Google identity."), 400
