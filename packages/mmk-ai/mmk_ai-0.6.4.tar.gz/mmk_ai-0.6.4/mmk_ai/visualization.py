...
def scatter_plot(data, continuous_vars, hue=None, theme="Viridis"):
    """
    Plots scatter plots for two continuous variables.
    ...
    data : pandas.DataFrame
        The dataset containing the continuous variables.
    continuous_vars : list of str
        The list of two continuous variables to plot.
    hue : str, optional
        The name of the column to use for color encoding. Default is None.
    theme : str, optional
        The color theme to use for the visualizations. Default is "Viridis".
    ...
    --------
    None
        Displays scatter plots for the specified continuous variables.
    """
    if theme not in COLOR_THEMES:
        theme = "Viridis"

    fig, ax = plt.subplots(figsize=(10, 7))
    sns.scatterplot(data=data, x=continuous_vars[0], y=continuous_vars[1], hue=hue, palette=theme.lower())
    plt.title(f'Scatter Plot of {continuous_vars[0]} vs {continuous_vars[1]}')
    plt.show()
    
def violin_plot(data, continuous_vars, hue=None, theme="Viridis"):
    """
    Plots violin plots for continuous variables.
    ...
    --------
    None
        Displays violin plots for the specified continuous variables.
    """
    if theme not in COLOR_THEMES:
        theme = "Viridis"
    ...
    for i, var in enumerate(continuous_vars):
        sns.violinplot(data=data, x=var, y=hue, ax=axes[i], palette=theme.lower())
...
def bar_plot(data, x, y, hue=None, theme="Viridis"):
    """
    Plots bar plots for categorical variables.
    ...
    --------
    None
        Displays bar plots for the specified categorical variables.
    """
    if theme not in COLOR_THEMES:
        theme = "Viridis"

    fig, ax = plt.subplots(figsize=(10, 7))
    sns.barplot(data=data, x=x, y=y, hue=hue, palette=theme.lower())
    plt.title(f'Bar Plot of {x} vs {y}')
    plt.show()
    
def line_plot(data, x, y, hue=None, theme="Viridis"):
    """
    Plots line plots for continuous variables.
    ...
    --------
    None
        Displays line plots for the specified continuous variables.
    """
    if theme not in COLOR_THEMES:
        theme = "Viridis"

    fig, ax = plt.subplots(figsize=(10, 7))
    sns.lineplot(data=data, x=x, y=y, hue=hue, palette=theme.lower())
    plt.title(f'Line Plot of {x} vs {y}')
    plt.show()
    
def scatter_matrix(data, theme="Viridis"):
    """
    Plots a scatter matrix for the dataset.
    ...
    --------
    None
        Displays a scatter matrix for the features in the dataset.
    """
    if theme not in COLOR_THEMES:
        theme = "Viridis"

    fig = px.scatter_matrix(data, color=theme.lower())
