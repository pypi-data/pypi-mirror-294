...
class ResourceAPI:  # noqa: D101
    ...
    def upload_version(
        ...
        Args:
            ...
            progress_update_rate: If callback is specified, update progress at most this rate.
        ...
        completed_upload = self._perform_upload(
            mrt, transfer_path, progress_callback_func=progress_callback_func, progress_update_rate=progress_update_rate
        )
        if completed_upload:
    ...
    def _perform_upload(
        self, mrt: ModelRegistryTarget, transfer_path: str, progress_callback_func=None, progress_update_rate=0.5
    ):
