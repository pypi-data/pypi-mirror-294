...
class MyController {
    ...
    def test1(String pathParameter1, Integer pathParameter2) {
        ...
        // Body parameters
        def bodyParameter1 = request.JSON.bodyParameter1
        def bodyParameter2 = request.JSON.bodyParameter2
        ...
        if (request.getContentType() == 'application/xml') {
            ...
            render(contentType: 'application/json', text: groovy.json.JsonOutput.toJson(incomes), status: 200)
        }
    }
