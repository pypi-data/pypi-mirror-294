...
apiPattern = r'''((?:String uri = "(?P<paths>\S+)";\n)|(?:(?:public |protected |private )\w+ (?P<functionName>\w+)\((.*(\s?\w+ (?P<pathParameters>\w+),?)*?)\).*\n)|.*?\n)*?(?:(?:(?P<firstSeparatorPart>)(?P<secondSeparatorPart>.*(?:public|protected|private)))|\Z)'''
