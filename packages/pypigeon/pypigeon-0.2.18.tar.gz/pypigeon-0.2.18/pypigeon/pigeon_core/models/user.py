...
from ..models.user_visibility_level import UserVisibilityLevel
...
class User:
    ...
    Attributes:
        ...
        subject_id (str):
        user_name (str):
        visibility_level (UserVisibilityLevel):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        visibility_level = UserVisibilityLevel(d.pop("visibility_level"))
