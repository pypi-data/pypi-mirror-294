...
from ..models.update_user_visibility_level import UpdateUserVisibilityLevel
...
class UpdateUser:
    ...
    Attributes:
        ...
        visibility_level (Union[Unset, UpdateUserVisibilityLevel]):
    """
    ...
    visibility_level: Union[Unset, UpdateUserVisibilityLevel] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_visibility_level, Unset):
            ...
            visibility_level = UpdateUserVisibilityLevel(_visibility_level)
