...
from taxonomy_graph import TaxonomiesGraph
...
class FairspaceGraph:
    ...
    def __init__(self, taxonomies_directory, taxonomy_prefix):
        self.taxonomy_graph = TaxonomiesGraph(taxonomies_directory, taxonomy_prefix)
    ...
    def process_data(self, source_study_directories: List[str], source_study_prefixes: List[str]):
        pass