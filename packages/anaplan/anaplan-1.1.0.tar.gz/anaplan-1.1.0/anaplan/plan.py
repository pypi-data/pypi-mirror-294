...
voice = input(Fore.MAGENTA + "Voice support on or off ? Press enter 'on' or something else. from: plan" + Style.RESET_ALL)
...
def predict_model_ssd(Input, model_name, model_path):
    ...
    Input = standard_scaler(None, Input, scaler_params, voice=False)
