...
def get_input():
    global voice
    voice = input(Fore.WHITE + "Voice support on or off ? Press enter 'on' or something else in 5 seconds. from: plan module: " + Style.RESET_ALL)
...
def input_with_timeout(timeout):
    ...
    if input_thread.is_alive():
        print(Fore.WHITE + "\nNo input within 5 seconds. Voice support set to 'off'." + Style.RESET_ALL)
    else:
        print(Fore.WHITE + f"\nInput received: Voice is set to '{voice}'." + Style.RESET_ALL)
