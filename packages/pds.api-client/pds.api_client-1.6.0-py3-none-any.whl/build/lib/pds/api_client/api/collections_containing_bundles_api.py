...
class CollectionsContainingBundlesApi(object):
    ...
    def bundles_containing_collection(self, identifier, **kwargs):  # noqa: E501
        ...
        return self.bundles_containing_collection_with_http_info(identifier, **kwargs)  # noqa: E501

    def bundles_containing_collection_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """get bundles containing this given collection  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bundles_containing_collection_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('identifier' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `identifier` when calling `bundles_containing_collection`")  # noqa: E501
