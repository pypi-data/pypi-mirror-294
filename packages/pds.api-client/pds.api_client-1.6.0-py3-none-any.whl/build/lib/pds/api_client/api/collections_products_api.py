...
class CollectionsProductsApi(object):
    ...
    def products_of_a_collection(self, identifier, **kwargs):  # noqa: E501
        """get products belonging to a given collection  # noqa: E501
        ...
        return self.products_of_a_collection_with_http_info(identifier, **kwargs)  # noqa: E501

    def products_of_a_collection_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """get products belonging to a given collection  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.products_of_a_collection_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('identifier' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `identifier` when calling `products_of_a_collection`")  # noqa: E501
    ...
    def products_of_a_collection_all(self, identifier, **kwargs):  # noqa: E501
        """get products belonging to a given collection  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.products_of_a_collection_all_with_http_info(identifier, **kwargs)  # noqa: E501

    def products_of_a_collection_all_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """get products belonging to a given collection  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.products_of_a_collection_all_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method products_of_a_collection_all" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and ('identifier' not in local_var_params or  # noqa: E501
                                                        local_var_params['identifier'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `products_of_a_collection_all`")  # noqa: E501
    ...
    def products_of_a_collection_latest(self, identifier, **kwargs):  # noqa: E501
        """get products belonging to a given collection  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.products_of_a_collection_latest_with_http_info(identifier, **kwargs)  # noqa: E501

    def products_of_a_collection_latest_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """get products belonging to a given collection  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.products_of_a_collection_latest_with_http_info(identifier, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method products_of_a_collection_latest" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'identifier' is set
        if self.api_client.client_side_validation and ('identifier' not in local_var_params or  # noqa: E501
                                                        local_var_params['identifier'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `identifier` when calling `products_of_a_collection_latest`")  # noqa: E501
