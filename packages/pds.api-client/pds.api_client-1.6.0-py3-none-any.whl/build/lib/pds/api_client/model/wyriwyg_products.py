...
class WyriwygProducts(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WyriwygProduct']:
                        return WyriwygProduct
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['WyriwygProduct'], typing.List['WyriwygProduct']],
                ...
                def __getitem__(self, i: int) -> 'WyriwygProduct':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["summary", "data", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["summary"]) -> 'Summary': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["summary", "data", ], str]):
