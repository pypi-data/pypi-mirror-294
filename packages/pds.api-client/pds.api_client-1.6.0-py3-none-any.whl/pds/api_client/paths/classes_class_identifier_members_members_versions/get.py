...
class ModelClassSchema(
    ...
    @schemas.classproperty
    def OBSERVATIONALS(cls):
        return cls("observationals")
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'versions': typing.Union[VersionsSchema, str, ],
    }
)
...
request_path_versions = api_client.PathParameter(
    name="versions",
    style=api_client.ParameterStyle.SIMPLE,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _class_members_members_vers_oapg(
        self,
...
class ClassMembersMembersVers(BaseApi):
    ...
    def class_members_members_vers(
        ...
        return self._class_members_members_vers_oapg(
