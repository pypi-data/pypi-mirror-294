                        ...
                        def mkT(text,code):
                            try:
                                if text not in ['',]:
                                    ...
                                    if text in ['ipv','invert pallet value','invert_pallet_value']:
                                        if mkTextStore:
                                            ...
                                            print(f"Inverted Palet Count is {Fore.light_steel_blue}{value}{Style.reset}")
                                            return value,text,''
                                    else:
                                        tmp=text.split(',')
                                        if len(tmp) == 2:
...
{Style.bold}{Fore.orange_red_1}Code={Fore.spring_green_3a}{CD}{Style.reset}'''
                        ...
                        ptext=f'''{hafnhaf}
{Fore.light_red}Enter {Style.bold}{Style.underline}{Fore.orange_red_1}Quantity/Formula{Style.reset} amount|+amount|-amount|a,+a,-a(advanced)|r,+r,-r(ReParseFormula) (Enter==1)|ipv=invert pallet value'''
