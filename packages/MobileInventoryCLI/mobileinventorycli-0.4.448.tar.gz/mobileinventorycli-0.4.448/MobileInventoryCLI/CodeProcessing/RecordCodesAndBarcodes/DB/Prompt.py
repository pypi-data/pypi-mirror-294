...
'''
            ...
            elif cmd.lower() in ['tmu',]:
                TM.Tasks.TasksMode(parent=self,engine=db.ENGINE)
...
{Fore.light_green}tm{Fore.light_red}u{Fore.light_steel_blue} - task mode menu{Style.reset}
