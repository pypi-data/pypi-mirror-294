...
setup(
    ...
    install_requires = ['fire','v4l2py','flask_httpauth','gunicorn','numpy','imutils','pandas','matplotlib','psutil','pyserial-asyncio', 'imagezmq','notifator','pyautogui','importlib_resources','requests','pynput','console','pillow==9.0.1','scikit-video', 'tdb_io', 'wheel', 'setuptools', 'distutils'],
)
