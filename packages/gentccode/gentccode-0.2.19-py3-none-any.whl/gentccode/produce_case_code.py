...
class ProduceCaseCode:
    ...
    def produce_import_and_class_setup_str(self) -> str:
        ...
        setup_class_str = (
            ...
            + f"{space_str_4}service_ip_label = 'toc'\n"
            + f"{space_str_4}# replace with you own auth\n"
            + f"{space_str_4}api_token = TocUserUtil.get_user_api_token('subot1@shopee.com')\n"
            + f"{space_str_4}"
            + "header_auth = {'Authorization': api_token}\n"
    ...
    @DeprecationWarning
    def produce_import_and_class_setup_str_old(self) -> str:
        space_str_4 = self.CHAR_SPACE_4
