...
class PKCE:
    ...
    def pkce_login(self, request):
        ...
        logging.info("pkce pkce_login code_verifier " + self.code_verifier)
        code_challenge = PKCE.generate_code_challenge(self.code_verifier)
    ...
    def pkce_callback(self, request):
        ...
        #logging.info("pkce pkce_callback code_verifier " + current_code_verifier)
