...
class ChatApi:
    ...
    def _create_chat_completion_serialize(
        ...
        if _header_params.get('Accept') is None:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{appName}/v1/chat-completions/{modelName}',
    ...
    @validate_call
    def create_training_chat_completion(
        self,
        app_name: Annotated[StrictStr, Field(description="app Name")],
        task_id: Annotated[StrictStr, Field(description="Training task ID")],
        x_ncp_clovastudio_request_id: Annotated[StrictStr, Field(description="request id")],
        create_chat_completion_request: CreateChatCompletionRequest,
        _request_timeout: Union[
            None,
        ...
        """create_training_chat_completion


        :param app_name: app Name (required)
        :type app_name: str
        :param task_id: Training task ID (required)
        :type task_id: str
        :param x_ncp_clovastudio_request_id: request id (required)
        :type x_ncp_clovastudio_request_id: str
        :param create_chat_completion_request: (required)
        ...
        _param = self._create_training_chat_completion_serialize(
            app_name=app_name,
            task_id=task_id,
            x_ncp_clovastudio_request_id=x_ncp_clovastudio_request_id,
            create_chat_completion_request=create_chat_completion_request,
    ...
    @validate_call
    def create_training_chat_completion_with_http_info(
        self,
        app_name: Annotated[StrictStr, Field(description="app Name")],
        task_id: Annotated[StrictStr, Field(description="Training task ID")],
        x_ncp_clovastudio_request_id: Annotated[StrictStr, Field(description="request id")],
    ...
    @validate_call
    def create_training_chat_completion_without_preload_content(
        self,
        app_name: Annotated[StrictStr, Field(description="app Name")],
        task_id: Annotated[StrictStr, Field(description="Training task ID")],
        x_ncp_clovastudio_request_id: Annotated[StrictStr, Field(description="request id")],
    ...
    def _create_training_chat_completion_serialize(
        self,
        app_name,
        task_id,
        x_ncp_clovastudio_request_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{appName}/v1/tasks/{taskId}/chat-completions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
