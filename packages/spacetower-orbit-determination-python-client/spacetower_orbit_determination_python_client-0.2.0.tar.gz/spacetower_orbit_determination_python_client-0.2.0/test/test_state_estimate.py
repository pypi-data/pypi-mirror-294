...
from spacetower_orbit_determination_python_client.models.state_estimate import StateEstimate

class TestStateEstimate(unittest.TestCase):
    """StateEstimate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateEstimate:
        """Test StateEstimate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateEstimate`
        """
        model = StateEstimate()
        if include_optional:
