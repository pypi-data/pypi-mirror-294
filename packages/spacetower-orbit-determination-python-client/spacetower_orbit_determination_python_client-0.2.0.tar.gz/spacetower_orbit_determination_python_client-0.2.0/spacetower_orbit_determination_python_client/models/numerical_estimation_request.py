...
class NumericalEstimationRequest(BaseModel):
    ...
    """ # noqa: E501
    initial_guess: StateEstimate = Field(alias="initialGuess")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "initialGuess": StateEstimate.from_dict(obj["initialGuess"]) if obj.get("initialGuess") is not None else None,
