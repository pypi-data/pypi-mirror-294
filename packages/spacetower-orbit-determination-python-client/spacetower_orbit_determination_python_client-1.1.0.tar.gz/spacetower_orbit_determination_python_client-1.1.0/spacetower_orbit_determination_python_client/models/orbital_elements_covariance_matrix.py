...
class OrbitalElementsCovarianceMatrix(OrbitalCovarianceMatrix):
    """
    Covariance matrix expressed in terms of orbital elements. The upper triangular part of the <br> matrix is expected. The order of the elements is the same than for ref:'#/components/schemas/InertialFrameId'
    """ # noqa: E501
