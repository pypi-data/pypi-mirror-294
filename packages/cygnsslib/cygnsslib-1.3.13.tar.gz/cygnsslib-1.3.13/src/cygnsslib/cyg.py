...
def _find_sp_in_day(cygnss_l1_path: str, i_date: datetime.date, download_cygnss_data: bool, thresh_ddm_snr: float, ddm_quality_filter: int,
                    ...
                    title_img_inc_ddm_time: str, out_folder: str, fig_out_folder: str, plt_reflectivity: bool = False, pbar: Optional[tqdm] = None,
                    ...
                    if sp_is_in_poly:
                        ...
                        if ddm_save_var is not None:
                            for _key, val_ in ddm_save_var.items():
                                ddm_data[_key] = val_
                        ddm_data['quality_flags_msg'] = ', '.join(qflags_msg_list)
