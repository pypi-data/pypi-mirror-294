...
class RecipesElement(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="web source of the shopping element indicates the source of information included in the element")
