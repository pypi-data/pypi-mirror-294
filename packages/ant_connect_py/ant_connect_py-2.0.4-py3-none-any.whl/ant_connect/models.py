...
class Column(ModelBaseClass):
    ...
    def all(cls, table_id: str) -> list[Column]:
        ...
        if response.ok:
            ...
            raise ValueError(
                f"Could not load data from API, response code {response.status_code} with response {response.text}"
            )
    ...
    def update(
        ...
        endpoint = f"columns/{column_id}"
        response: requests.Response = Column._call_api(
            method_type=HttpMethodType.PUT, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return Column._from_json(response.json())
        else:
    ...
    def create(
        ...
        endpoint = f"columns"
        response: requests.Response = Column._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return Column._from_json(response.json())
        else:
...
class Label(ModelBaseClass):
    ...
    def all(cls, license_id: str, project_id: Optional[str] = None) -> list[Label]:
        ...
        response: requests.Response = Label._call_api(
            method_type=HttpMethodType.GET, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
    ...
    @preprocess_arguments
    def update(
        cls, label_id: str, title: Optional[str] = None, description: Optional[str] = None, color: Optional[str] = None
    ) -> Label:
        """Update label
...
class License(ModelBaseClass):
    ...
    def add_user(cls, license_id: str, email: str) -> MessageResponse:
        ...
        endpoint = f"licenses/{license_id}/users"
        response: requests.Response = License._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return MessageResponse._from_json(response.json())
...
class Link(ModelBaseClass):
    ...
    @preprocess_arguments
    def create_project(
        cls, project_id: str, name: Optional[str] = None, link: Optional[str] = None, color: Optional[str] = None
    ) -> Link:
        """Create project link
        ...
        endpoint = f"projects/{project_id}/links"
        response: requests.Response = Link._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
    ...
    @preprocess_arguments
    def update_project(
        cls, project_id: str, link_id: str, name: Optional[str] = None, color: Optional[str] = None
    ) -> Link:
        """Update project link
...
class Member(ModelBaseClass):
    ...
    def add_role_to_project(cls, project_id: str, email: str, role_id: str) -> MessageResponse:
        ...
        endpoint = f"projects/{project_id}/members"
        response: requests.Response = Member._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return MessageResponse._from_json(response.json())
    ...
    def delete_role(cls, project_id: str, email: str, role_id: str) -> MessageResponse:
        ...
        endpoint = f"projects/{project_id}/members"
        response: requests.Response = Member._call_api(
            method_type=HttpMethodType.DELETE, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return MessageResponse._from_json(response.json())
        else:
...
class Permission(ModelBaseClass):
    ...
    def create(
        ...
        response: requests.Response = Permission._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return Permission._from_json(response.json())
...
class Project(ModelBaseClass):
    ...
    def all_license(cls, license_id: str, filters: Optional[dict] = None) -> list[Project]:
        ...
        response: requests.Response = Project._call_api(
            method_type=HttpMethodType.GET, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
...
class Record(ModelBaseClass):
    ...
    def create(cls, table_id: str, record: Optional[dict] = None) -> Record:
        ...
        response: requests.Response = Record._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
    ...
    @classmethod
    @preprocess_arguments
    def delete(cls, table_id: str, records: Optional[List] = None) -> MessageResponse:
    ...
    @classmethod
    @preprocess_arguments
    def import_data(cls, table_id: str, records: Optional[str] = None) -> MessageResponse:
        """Import records
...
class Relation(ModelBaseClass):
    ...
    @preprocess_arguments
    def create(
        cls, table: str, column: str, related_project: str, related_table: str, related_column: Optional[str] = None
    ) -> Relation:
        ...
        response: requests.Response = Relation._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
...
class Role(ModelBaseClass):
    ...
    def update_project(cls, role_id: str, name: str) -> Role:
        ...
        endpoint = f"roles/{role_id}"
        response: requests.Response = Role._call_api(
            method_type=HttpMethodType.PUT, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return Role._from_json(response.json())
    ...
    @classmethod
    @preprocess_arguments
    def update_general_permissions(
        cls,
        role_id: str,
    ...
    @classmethod
    @preprocess_arguments
    def update_workflow_permissions(
        cls,
        role_id: str,
        is_import: Optional[bool] = None,
        configure: Optional[bool] = None,
...
class SbsRecord(ModelBaseClass):
    ...
    def search_sbs_records(cls, project_id: str, code_id: str) -> list[SbsRecord]:
        ...
        response: requests.Response = SbsRecord._call_api(
            method_type=HttpMethodType.GET, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return [SbsRecord._from_json(i) for i in response.json()]
    ...
    @classmethod
    @preprocess_arguments
    def update_sbs_records(
        cls, project_id: str, code_id: str, parent: Optional[str] = None, label: Optional[str] = None
    ) -> SbsRecord:
        """Update sbs record
...
class AntPersonalAccessToken(ModelBaseClass):
    ...
    def get_tokens(cls) -> list[AntPersonalAccessToken]:
        ...
        response: requests.Response = AntPersonalAccessToken._call_api(
            method_type=HttpMethodType.GET, endpoint=endpoint
        )
        if response.ok:
    ...
    @preprocess_arguments
    def create_token(
        cls, name: Optional[str] = None, expires_at: Optional[str] = None
    ...
    def delete_token(cls, token_id: str) -> MessageResponse:
        ...
        response: requests.Response = AntPersonalAccessToken._call_api(
            method_type=HttpMethodType.DELETE, endpoint=endpoint
        )
        if response.ok:
            return MessageResponse._from_json(response.json())
        else:
...
class Table(ModelBaseClass):
    ...
    def update(cls, table_id: str, name: str) -> Table:
        ...
        endpoint = f"tables/{table_id}"
        response: requests.Response = Table._call_api(
            method_type=HttpMethodType.PUT, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
            return Table._from_json(response.json())
    ...
    @classmethod
    @preprocess_arguments
    def query(cls, tables: List[dict]) -> list[dict]:
    ...
    @classmethod
    @preprocess_arguments
    def query_export(cls, tables: List[dict]) -> dict:
...
class Task(ModelBaseClass):
    ...
    def upload_appendix(cls, task_id: str, name: str, extension: str, data: str) -> Task:
        ...
        response: requests.Response = Task._call_api(
            method_type=HttpMethodType.POST, endpoint=endpoint, parameters=parameters
        )
        if response.ok:
    ...
    @classmethod
    @preprocess_arguments
    def save(cls, objects: List[dict]) -> list[Task]:
