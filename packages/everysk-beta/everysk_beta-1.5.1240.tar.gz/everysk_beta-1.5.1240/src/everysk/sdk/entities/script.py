...
class Script(BaseDict, BaseSDK):
    ...
    def _fetch(self, user_input: Any, variant: str, workspace: str) -> Any:
        """
    ...
    def fetch(self, user_input: Any, variant: str, workspace: str) -> Any:
        ...
        entity: Any = self._fetch(user_input, variant, workspace)

        return entity

    def _fetch_list(self, user_input: Any, variant: str, workspace: str) -> list:
        """
    ...
    def fetch_list(self, user_input: Any, variant: str, workspace: str) -> list:
        ...
        entity_list: list = self._fetch_list(user_input, variant, workspace)
    ...
    def _storage(self, entity: Any, storage_settings: StorageSettings) -> Any:
        """
    ...
    def storage(self, entity: Any, storage_settings: StorageSettings) -> Any:
        ...
        entity: Any = self._storage(entity, storage_settings)
