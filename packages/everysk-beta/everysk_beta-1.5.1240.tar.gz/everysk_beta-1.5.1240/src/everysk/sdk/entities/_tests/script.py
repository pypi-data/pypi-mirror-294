...
class ScriptTestCase(TestCase):
    ...
    def test_script_query_tag_latest_variant(self):
        expected_data = compress({'class_name': 'Script', 'method_name': '_fetch', 'self_obj': {'_klass': 'Portfolio', '__class_path__': 'everysk.sdk.entities.script.Script'}, 'params': {'user_input': {'tags': 'someTag'}, 'variant': 'tagLatest', 'workspace': 'someWorkspace'}}, protocol='gzip', serialize='json')
        ...
        expected_data = compress({'class_name': 'Script', 'method_name': '_fetch', 'self_obj': Portfolio.script.to_dict(add_class_path=True), 'params': {'user_input': {'tags': 'someTag'}, 'variant': 'tagLatest', 'workspace': 'someWorkspace'}}, protocol='gzip', serialize='json')
