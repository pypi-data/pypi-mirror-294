    ...
    def test_info_as_json(self):
        with mock.patch.object(self.log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 755, "function": "test_info_as_json"}}\n'
            )
    ...
    def test_info_as_json_with_labels(self):
        with mock.patch.object(self.log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 772, "function": "test_info_as_json_with_labels"}}\n'
            )
    ...
    def test_info_as_json_with_labels_as_bytes(self):
        with mock.patch.object(self.log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 789, "function": "test_info_as_json_with_labels_as_bytes"}}\n'
            )
    ...
    def test_info_as_json_with_labels_with_bytes(self):
        with mock.patch.object(self.log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 806, "function": "test_info_as_json_with_labels_with_bytes"}}\n'
            )
    ...
    def test_info_as_json_with_http_headers(self):
        with mock.patch.object(self.log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": true, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 824, "function": "test_info_as_json_with_http_headers"}}\n'
            )
    ...
    def test_error_as_json(self):
        with mock.patch.object(self.log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 846, "function": "test_error_as_json"}}\n'
            )
