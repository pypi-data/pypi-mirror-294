...
class BlockVarPair:
    ...
    def __init__(self, blockPlacedID: int, blockID: str, variableID: str, variableType: str, variableAllowedValues: typing.Optional[typing.List[typing.Any]] = None) -> None: ...
