...
class CkObject(Enum):
    ...
    def data_product_id(self):
        ...
        _product_id_map = {
            "JPSS": DataProductIdentifier.spice_jpss_ck,
            "AZROT": DataProductIdentifier.spice_az_ck,
            "ELSCAN": DataProductIdentifier.spice_el_ck
        }
        return _product_id_map[self.value]
    ...
    def processing_step_id(self):
        ...
        _processing_step_id_map = {
            "JPSS": ProcessingStepIdentifier.spice_jpss,
            "AZROT": ProcessingStepIdentifier.spice_azel,
            "ELSCAN": ProcessingStepIdentifier.spice_azel
        }
        return _processing_step_id_map[self.value]
