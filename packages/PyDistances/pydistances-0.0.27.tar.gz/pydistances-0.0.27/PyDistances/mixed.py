...
class VG_GGower_Fast_Estimation :
    """
    ...
    def compute(self, X):
        ...
        for i in range(0, self.VG_n_samples) :
            ...
            VG_GGower_fast = VG_GGower_Estimation(p1=self.p1, p2=self.p2, p3=self.p3, 
            ...
            VG1, VG2, VG3 = VG_GGower_fast.compute(X=X_sample)
...
class GGower_dist_matrix: 
    ...
    def compute(self, X):
        ...
        if self.fast_VG == True:   
            VG_GGower_fast = VG_GGower_Fast_Estimation(p1=self.p1, p2=self.p2, p3=self.p3, 
                                               d1=self.d1, d2=self.d2, d3=self.d3, 
            ...
            VG1, VG2, VG3 = VG_GGower_fast.compute(X=X)
        else:
            VG1, VG2, VG3 = VG(D1_2), VG(D2_2), VG(D3_2)
...
class GGower_dist: 
    ...
    def fit(self, X) :
        ...
        VG_GGower_fast = VG_GGower_Fast_Estimation(p1=p1, p2=p2, p3=p3, d1=d1, d2=d2, d3=d3, method=self.method, 
                                           alpha=self.alpha, epsilon=self.epsilon, n_iters=self.n_iters,
                                           VG_sample_size=self.VG_sample_size, VG_n_samples=self.VG_n_samples, 
                                           random_state=self.random_state, weights=self.weights)
        
        self.VG1, self.VG2, self.VG3 = VG_GGower_fast.compute(X=X)
