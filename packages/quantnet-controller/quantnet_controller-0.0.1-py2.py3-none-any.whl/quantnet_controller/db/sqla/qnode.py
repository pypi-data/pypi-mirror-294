...
#     if filter_ is None:
#         filter_ = {}
#     query = session.query(models.Qnode.id, models.Qnode.Qnode_type,
#                           models.Qnode.name).filter_by(status=NodeStatus.ACTIVE)
...
#
#     for id, qnode_type, name in query.order_by(models.Qnode.id).yield_per(25):
#         yield {'id': id, 'type': qnode_type, 'name': name}
