...
def add_pingpong(id, remote=None, phase=None, reason=None, *, session: "Session"):
...
@read_session
def get_pingpong(id, *, session: "Session"):
...
@transactional_session
def update_pingpong(id, key, value, *, session: "Session"):
