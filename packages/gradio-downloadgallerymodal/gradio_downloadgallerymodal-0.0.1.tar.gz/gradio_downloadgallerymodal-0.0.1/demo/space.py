...
with gr.Blocks(
    ...
    gr.Markdown(
"""
# `gradio_downloadgallerymodal`

<div style="display: flex; gap: 7px;">
<img alt="Static Badge" src="https://img.shields.io/badge/version%20-%200.0.1%20-%20orange">  
</div>

gallery with download button, without close button, for modal panel
...
```bash
pip install gradio_downloadgallerymodal
```
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["DownloadGalleryModal"]["members"]["__init__"], linkify=[])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["DownloadGalleryModal"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "DownloadGalleryModal-user-fn"], header_links=True)
