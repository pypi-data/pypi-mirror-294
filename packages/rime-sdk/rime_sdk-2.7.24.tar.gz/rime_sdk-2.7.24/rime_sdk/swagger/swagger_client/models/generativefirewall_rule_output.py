...
class GenerativefirewallRuleOutput(object):
    ...
    def __init__(self, rule_name=None, action=None, risk_category=None, pii_detection_details=None, language_detection_details=None, prompt_injection_details=None, toxicity_detection_details=None):  # noqa: E501
