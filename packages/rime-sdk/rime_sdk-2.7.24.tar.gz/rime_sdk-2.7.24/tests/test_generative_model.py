...
from rime_sdk.swagger.swagger_client import (
    ...
    GenerativetestingObjectiveSubCategory,
...
def mock_start_generative_model_tests(mocker, mock_job_id):
    ...
    mocker.patch.object(
        GenerativeModelTestingApi,
        "generative_model_testing_start_generative_model_test",
...
def mock_get_generative_test_results(mocker, mock_job_id):
    ...
    def mock_function(job_id_uuid=None, page_token=None, page_size=None):
        ...
        result: GenerativetestingGenerativeTestingResult = {
            ...
            "objective_sub_category": GenerativetestingObjectiveSubCategory.STALKING,
            "failing_examples": [
                GenerativeTestingResultExample(
        ...
        return GenerativetestingGetGenerativeModelTestResultsResponse(results=[result])
...
def test_get_generative_model_test_results(
    ...
    assert (
        ...
        == GenerativetestingObjectiveSubCategory.STALKING
    )
