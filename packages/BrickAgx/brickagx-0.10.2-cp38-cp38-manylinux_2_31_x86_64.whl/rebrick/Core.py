...
class ModelDeclaration(object):
    ...
    def create(qualifier_token, name_token, extends_qualifier_token, parent_segments, annotations, traits, members):
        r"""
        create(Token qualifier_token, Token name_token, Token extends_qualifier_token, TokenVector parent_segments, std::vector< Brick::AnnotationPtr,std::allocator< Brick::AnnotationPtr > > const & annotations, std::vector< Brick::TraitImplPtr,std::allocator< Brick::TraitImplPtr > > const & traits, std::vector< Brick::NodePtr,std::allocator< Brick::NodePtr > > const & members) -> Brick::ModelDeclPtr
...
def ModelDeclaration_create(qualifier_token, name_token, extends_qualifier_token, parent_segments, annotations, traits, members):
    r"""
    ModelDeclaration_create(Token qualifier_token, Token name_token, Token extends_qualifier_token, TokenVector parent_segments, std::vector< Brick::AnnotationPtr,std::allocator< Brick::AnnotationPtr > > const & annotations, std::vector< Brick::TraitImplPtr,std::allocator< Brick::TraitImplPtr > > const & traits, std::vector< Brick::NodePtr,std::allocator< Brick::NodePtr > > const & members) -> Brick::ModelDeclPtr
...
class BundleConfig(object):
    ...
    dependencies = property(_CorePythonSwig.BundleConfig_dependencies_get, _CorePythonSwig.BundleConfig_dependencies_set, doc=r"""dependencies : std::vector<(std::string,std::allocator<(std::string)>)>""")
...
class AnalysisContext(object):
    ...
    def __init__(self, bundles, error_reporter):
        r"""
        __init__(AnalysisContext self, std::vector< Brick::Analysis::BundleLookup,std::allocator< Brick::Analysis::BundleLookup > > bundles, std::shared_ptr< ErrorReporter > error_reporter) -> AnalysisContext

        Parameters
        ----------
        bundles: std::vector< Brick::Analysis::BundleLookup,std::allocator< Brick::Analysis::BundleLookup > >
        error_reporter: std::shared_ptr< ErrorReporter >
    ...
    def getErrorReporter(self):
        r"""getErrorReporter(AnalysisContext self) -> std::shared_ptr< ErrorReporter >"""
