...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            save_image(result_img, os.path.join(img_folder, 'image_transferred.jpg'))
            print("Histograma transferido e imagem salva como 'image_transferred.jpg'.")

        elif choice == '2':
            image1 = read_image(os.path.join(img_folder, 'imagem1.jpg'))
            image2 = read_image(os.path.join(img_folder, 'imagem2.jpg'))
            transferred_image = read_image(os.path.join(img_folder, 'image_transferred.jpg'))
            ...
            save_image(gray_image1, os.path.join(img_folder, 'imagem1_gray.jpg'))
            print("Imagem1 convertida para escala cinza e salva como 'imagem1_gray.jpg'.")

        elif choice == '4':
            image1 = read_image(os.path.join(img_folder, 'imagem1.jpg'))
            gray_image1 = read_image(os.path.join(img_folder, 'imagem1_gray.jpg'))
