...
class ExifScanner:
    ...
    def __init__(self, WorkDirectory=None, MetashapeDirectory=None, KartDirectory=None, KartRemote=None,
        ...
        self.metadata_writer = MetadataWriter(self.WorkDirectory, self.metashapeCacheTime, self.MetashapeDirectory)
    ...
    def update_data(self):
                ...
                if result.returncode == 41:
                    ...
                    if self.KartRemote:
                        ...
                        if remoteResult.returncode == 128:
                            ...
                            remoteAddResult = init_process = subprocess.run(['kart', 'remote', 'add', 'origin', self.KartRemote], cwd=self.KartDirectory)
                            pushResult = init_process = subprocess.run(['kart', 'push', '--set-upstream', 'origin', 'main'], cwd=self.KartDirectory)
                            if remoteResult.returncode == 0 and pushResult == 0:
        ...
        # Create a map centered at the mean coordinates of your geodata
