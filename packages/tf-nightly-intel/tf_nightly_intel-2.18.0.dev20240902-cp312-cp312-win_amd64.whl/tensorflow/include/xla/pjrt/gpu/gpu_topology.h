...
class GpuTopology {
 public:
  explicit GpuTopology(const std::vector<int>& gpu_device_ids,
      ...
      : devices_ids_(gpu_device_ids),
        ...
        core_count_per_chip_(core_count_per_chip) {}
  ...
  bool operator==(const GpuTopology& other) const {
    return devices_ids_ == other.devices_ids_ &&
           ...
           core_count_per_chip_ == other.core_count_per_chip_;
  }
  ...
  int32_t core_count_per_chip() const { return core_count_per_chip_; }
 ...
 private:
  ...
  const int32_t core_count_per_chip_;
