...
class GpuTopologyProto final :
 ...
 public:
  ...
  enum : int {
    ...
    kCoreCountPerChipFieldNumber = 7,
  };
  ...
  void clear_core_count_per_chip();
  int32_t core_count_per_chip() const;
  void set_core_count_per_chip(int32_t value);
  private:
  int32_t _internal_core_count_per_chip() const;
  void _internal_set_core_count_per_chip(int32_t value);
  public:
...
// int32 core_count_per_chip = 7;
inline void GpuTopologyProto::clear_core_count_per_chip() {
  _impl_.core_count_per_chip_ = 0;
}
inline int32_t GpuTopologyProto::_internal_core_count_per_chip() const {
  return _impl_.core_count_per_chip_;
}
inline int32_t GpuTopologyProto::core_count_per_chip() const {
  // @@protoc_insertion_point(field_get:xla.GpuTopologyProto.core_count_per_chip)
  return _internal_core_count_per_chip();
}
inline void GpuTopologyProto::_internal_set_core_count_per_chip(int32_t value) {
  
  _impl_.core_count_per_chip_ = value;
}
inline void GpuTopologyProto::set_core_count_per_chip(int32_t value) {
  _internal_set_core_count_per_chip(value);
  // @@protoc_insertion_point(field_set:xla.GpuTopologyProto.core_count_per_chip)
}
