...
class StatisticsQuantity2D(IdsBaseClass):
    ...
    statistics_type: Optional[StatisticsQuantity2DType] = field(
        default_factory=lambda: StructArray(type=StatisticsQuantity2DType),
        metadata={
...
class GenericGridVectorComponents(IdsBaseClass):
    ...
    :ivar toroidal : Toroidal component, one scalar value is provided per element in the grid subset.
    :ivar toroidal_coefficients : Interpolation coefficients for the toroidal component, to be used for a high precision evaluation of the physical quantity with finite elements, provided per element in the grid subset (first dimension).
    ...
    toroidal_coefficients: Optional[np.ndarray] = field(
        default_factory=lambda: np.zeros(shape=(0,) * 2, dtype=float),
        metadata={
            "imas_type": "FLT_2D",
            "ndims": 2,
...
class Statistics(IdsBaseClass):
    ...
    quantity_2d: Optional[StatisticsQuantity2D] = field(
        default_factory=lambda: StructArray(type=StatisticsQuantity2D),
        metadata={
    ...
    uq_input_2d: Optional[StatisticsInput2D] = field(
        default_factory=lambda: StructArray(type=StatisticsInput2D),
        metadata={
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesVectorComponents1(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_vector_components_1"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesVectorComponents2(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_vector_components_2"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesVectorComponents3(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_vector_components_3"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesGlobalQuantitiesIon(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_global_quantities_ion"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesGlobalQuantities(IdsBaseClass):
    """
    ...
    :ivar li : Internal inductance. The li_3 definition is used, i.e. li_3 = 2/R0/mu0^2/Ip^2 * int(Bp^2 dV).
    ...
    :ivar beta_tor_norm : Normalised toroidal beta, defined as 100 * beta_tor * a[m] * B0 [T] / ip [MA]
    ...
    class Meta:
        name = "plasma_profiles_global_quantities"
        is_root_ids = False
    ...
    ion: Optional[PlasmaProfilesGlobalQuantitiesIon] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesGlobalQuantitiesIon
        ),
        metadata={
            "imas_type": "plasma_profiles_global_quantities_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "../../profiles_1d(itime)/ion"},
            "field_type": PlasmaProfilesGlobalQuantitiesIon,
        },
    )
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfiles1DFit(IdsBaseClass):
    """
    ...
    :ivar rho_tor_norm : Normalised toroidal flux coordinate of each measurement (local value for a local measurement, minimum value reached by the line of sight for a line measurement)
    :ivar rho_pol_norm : Normalised poloidal flux coordinate of each measurement (local value for a local measurement, minimum value reached by the line of sight for a line measurement)
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles1DIonState(IdsBaseClass):
    """
    ...
    :ivar ionisation_potential : Cumulative and average ionisation potential to reach a given bundle. Defined as sum (x_z* (sum of Epot from z&#39;=0 to z-1)), where Epot is the ionisation potential of ion Xz_+, and x_z is the relative concentration of a given charge state in the bundle, i.e. sum(x_z) = 1 over the bundle.
    ...
    class Meta:
        name = "plasma_profiles_profiles_1d_ion_state"
        is_root_ids = False
    ...
    ionisation_potential: Optional[float] = field(
        default=9e40, metadata={"imas_type": "FLT_0D", "field_type": float}
    )
    ...
    density_fit: Optional[PlasmaProfiles1DFit] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_1d_fit",
            "field_type": PlasmaProfiles1DFit,
        },
    )
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles1DIon(IdsBaseClass):
    """

    :ivar element : List of elements forming the atom or molecule
    :ivar z_ion : Ion charge (of the dominant ionisation state; lumped ions are allowed), volume averaged over plasma radius
    ...
    class Meta:
        name = "plasma_profiles_profiles_1d_ion"
        is_root_ids = False

    element: Optional[PlasmaCompositionNeutralElement] = field(
        default_factory=lambda: StructArray(
            type=PlasmaCompositionNeutralElement
        ),
        metadata={
    ...
    temperature_fit: Optional[PlasmaProfiles1DFit] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_1d_fit",
            "field_type": PlasmaProfiles1DFit,
    ...
    velocity: Optional[PlasmaProfilesVectorComponents2] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_vector_components_2",
            "field_type": PlasmaProfilesVectorComponents2,
        },
    )
    multiple_states_flag: Optional[int] = field(
        default=999999999, metadata={"imas_type": "INT_0D", "field_type": int}
    )
    state: Optional[PlasmaProfilesProfiles1DIonState] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesProfiles1DIonState
        ),
        metadata={
            "imas_type": "plasma_profiles_profiles_1d_ion_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesProfiles1DIonState,
        },
    )


@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles1DNeutralState(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_profiles_1d_neutral_state"
        is_root_ids = False
    ...
    velocity: Optional[PlasmaProfilesVectorComponents3] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_vector_components_3",
            "field_type": PlasmaProfilesVectorComponents3,
        },
    )
    temperature: Optional[np.ndarray] = field(
        default_factory=lambda: np.zeros(shape=(0,) * 1, dtype=float),
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles1DNeutral(IdsBaseClass):
    """

    :ivar element : List of elements forming the atom or molecule
    :ivar label : String identifying the species (e.g. H, D, T, He, C, D2, DT, CD4, ...)
    ...
    class Meta:
        name = "plasma_profiles_profiles_1d_neutral"
        is_root_ids = False
    ...
    state: Optional[PlasmaProfilesProfiles1DNeutralState] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesProfiles1DNeutralState
        ),
        metadata={
            "imas_type": "plasma_profiles_profiles_1d_neutral_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesProfiles1DNeutralState,
        },
    )


@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles1DElectrons(IdsBaseClass):
    """
    ...
    :ivar pressure_fast_perpendicular : Fast (non-thermal) perpendicular pressure
    :ivar pressure_fast_parallel : Fast (non-thermal) parallel pressure
    :ivar collisionality_norm : Collisionality normalised to the bounce frequency
    """

    class Meta:
        name = "plasma_profiles_profiles_1d_electrons"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles1D(IdsBaseClass):
    """
    ...
    :ivar ion : Quantities related to the different ion species, in the sense of isonuclear or isomolecular sequences. Ionisation states (and other types of states) must be differentiated at the state level below
    ...
    :ivar j_total : Total parallel current density = average(jtot.B) / B0, where B0 = plasma_profiles/Vacuum_Toroidal_Field/ B0
    ...
    :ivar j_ohmic : Ohmic parallel current density = average(J_Ohmic.B) / B0, where B0 = plasma_profiles/Vacuum_Toroidal_Field/ B0
    :ivar j_non_inductive : Non-inductive (includes bootstrap) parallel current density = average(jni.B) / B0, where B0 = plasma_profiles/Vacuum_Toroidal_Field/ B0
    :ivar j_bootstrap : Bootstrap current density = average(J_Bootstrap.B) / B0, where B0 = plasma_profiles/Vacuum_Toroidal_Field/ B0
    :ivar conductivity_parallel : Parallel conductivity
    :ivar e_field : Electric field, averaged on the magnetic surface. E.g for the parallel component, average(E.B) / B0, using plasma_profiles/vacuum_toroidal_field/b0
    ...
    class Meta:
        name = "plasma_profiles_profiles_1d"
        is_root_ids = False
    ...
    electrons: Optional[PlasmaProfilesProfiles1DElectrons] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_profiles_1d_electrons",
            "field_type": PlasmaProfilesProfiles1DElectrons,
        },
    )
    ion: Optional[PlasmaProfilesProfiles1DIon] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesProfiles1DIon),
        metadata={
            "imas_type": "plasma_profiles_profiles_1d_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesProfiles1DIon,
        },
    )
    neutral: Optional[PlasmaProfilesProfiles1DNeutral] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesProfiles1DNeutral
        ),
        metadata={
            "imas_type": "plasma_profiles_profiles_1d_neutral",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesProfiles1DNeutral,
        },
    )
    ...
    t_i_average_fit: Optional[PlasmaProfiles1DFit] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_1d_fit",
            "field_type": PlasmaProfiles1DFit,
    ...
    zeff_fit: Optional[PlasmaProfiles1DFit] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_1d_fit",
            "field_type": PlasmaProfiles1DFit,
    ...
    e_field: Optional[PlasmaProfilesVectorComponents1] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_vector_components_1",
            "field_type": PlasmaProfilesVectorComponents1,
        },
    )
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfiles2DVectorComponents2(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_2d_vector_components_2"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfiles2DIonState(IdsBaseClass):
    """
    ...
    :ivar z_average : Average Z of the charge state bundle, volume averaged over the plasma radius (equal to z_min if no bundle), = sum (Z*x_z) where x_z is the relative concentration of a given charge state in the bundle, i.e. sum(x_z) = 1 over the bundle.
    :ivar z_square_average : Average Z square of the charge state bundle, volume averaged over the plasma radius (equal to z_min squared if no bundle), = sum (Z^2*x_z) where x_z is the relative concentration of a given charge state in the bundle, i.e. sum(x_z) = 1 over the bundle.
    :ivar ionisation_potential : Cumulative and average ionisation potential to reach a given bundle. Defined as sum (x_z* (sum of Epot from z&#39;=0 to z-1)), where Epot is the ionisation potential of ion Xz’+, and x_z is the relative concentration of a given charge state in the bundle, i.e. sum(x_z) = 1 over the bundle.
    :ivar label : String identifying state (e.g. C+, C+2 , C+3, C+4, C+5, C+6, ...)
    :ivar electron_configuration : Configuration of atomic orbitals of this state, e.g. 1s2-2s1
    :ivar vibrational_level : Vibrational level (can be bundled)
    :ivar vibrational_mode : Vibrational mode of this state, e.g. &#34;A_g&#34;. Need to define, or adopt a standard nomenclature.
    ...
    class Meta:
        name = "plasma_profiles_2d_ion_state"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfiles2DIon(IdsBaseClass):
    """
    ...
    velocity: Optional[PlasmaProfiles2DVectorComponents2] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_2d_vector_components_2",
            "field_type": PlasmaProfiles2DVectorComponents2,
        },
    )
    multiple_states_flag: Optional[int] = field(
        default=999999999, metadata={"imas_type": "INT_0D", "field_type": int}
    )
    state: Optional[PlasmaProfiles2DIonState] = field(
        default_factory=lambda: StructArray(type=PlasmaProfiles2DIonState),
        metadata={
            "imas_type": "plasma_profiles_2d_ion_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfiles2DIonState,
        },
    )


@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesProfiles2D(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_profiles_2d"
        is_root_ids = False
    ...
    ion: Optional[PlasmaProfiles2DIon] = field(
        default_factory=lambda: StructArray(type=PlasmaProfiles2DIon),
        metadata={
            "imas_type": "plasma_profiles_2d_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfiles2DIon,
        },
    )
    t_i_average: Optional[np.ndarray] = field(
        default_factory=lambda: np.zeros(shape=(0,) * 2, dtype=float),
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesTimeSliceNeutralState(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_time_slice_neutral_state"
        is_root_ids = False
    ...
    temperature: Optional[GenericGridScalar] = field(
        default_factory=lambda: StructArray(type=GenericGridScalar),
        metadata={
    ...
    velocity: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesTimeSliceIonChargeState(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_time_slice_ion_charge_state"
        is_root_ids = False
    ...
    ionisation_potential: Optional[GenericGridScalar] = field(
        default_factory=lambda: StructArray(type=GenericGridScalar),
        metadata={
            "imas_type": "generic_grid_scalar",
            "ndims": 1,
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesTimeSliceNeutral(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_time_slice_neutral"
        is_root_ids = False
    ...
    state: Optional[PlasmaProfilesTimeSliceNeutralState] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesTimeSliceNeutralState
        ),
        metadata={
            "imas_type": "plasma_profiles_time_slice_neutral_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesTimeSliceNeutralState,
        },
    )


@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesTimeSliceIon(IdsBaseClass):
    """

    :ivar element : List of elements forming the atom or molecule
    :ivar z_ion : Ion charge (of the dominant ionisation state; lumped ions are allowed).
    :ivar label : String identifying the species (e.g. H+, D+, T+, He+2, C+, D2, DT, CD4, ...)
    :ivar neutral_index : Index of the corresponding neutral species in the ../../neutral array
    :ivar temperature : Temperature (average over states when multiple states are considered), given on various grid subsets
    :ivar density : Density (thermal+non-thermal) (sum over states when multiple states are considered), given on various grid subsets
    :ivar density_fast : Density of fast (non-thermal) particles (sum over states when multiple states are considered), given on various grid subsets
    ...
    :ivar pressure_fast_parallel : Fast (non-thermal) parallel pressure (average over states when multiple states are considered), given on various grid subsets
    :ivar velocity : Velocity (average over states when multiple states are considered), given on various grid subsets
    :ivar velocity_over_b_field : Velocity (average over states when multiple states are considered) divided by the modulus of the local magnetic field, given on various grid subsets
    :ivar energy_density_kinetic : Kinetic energy density (sum over states when multiple states are considered), given on various grid subsets
    :ivar multiple_states_flag : Multiple state calculation flag : 0-Only one state is considered; 1-Multiple states are considered and are described in the state structure
    :ivar state : Quantities related to the different states of the species (ionisation, energy, excitation, ...)
    """
    ...
    class Meta:
        name = "plasma_profiles_time_slice_ion"
        is_root_ids = False
    ...
    velocity_over_b_field: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
            "imas_type": "generic_grid_vector_components",
            "ndims": 1,
    ...
    state: Optional[PlasmaProfilesTimeSliceIonChargeState] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesTimeSliceIonChargeState
        ),
        metadata={
            "imas_type": "plasma_profiles_time_slice_ion_charge_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesTimeSliceIonChargeState,
        },
    )


@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesGgdFastIon(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_ggd_fast_ion"
        is_root_ids = False
    ...
    content: Optional[GenericGridScalarSinglePosition] = field(
        default_factory=lambda: StructArray(
            type=GenericGridScalarSinglePosition
        ),
        metadata={
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesTimeSliceElectrons(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_time_slice_electrons"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesGgdFastElectrons(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_ggd_fast_electrons"
        is_root_ids = False
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesTimeSlice(IdsBaseClass):
    """
    ...
    :ivar r_j_total_phi : Toroidal component of the current density multiplied by the local major radius, given on various grid subsets
    ...
    :ivar velocity_mass_centre : Velocity of the centre of mass of all the species (see equation 2 in the paper linked below), given on various grid subsets
    :ivar velocity_parallel_over_b_field : Parallel (to magnetic field) velocity of the centre of mass of all the species (see equation 2 in the paper linked below), divided by the module of the local magnetic field, given on various grid subsets
    :ivar vorticity : Curl of the velocity_mass_centre vector, given on various grid subsets
    :ivar vorticity_over_r : Vorticity divided by the local major radius, given on various grid subsets
    :ivar time : Time
    """

    class Meta:
        name = "plasma_profiles_time_slice"
        is_root_ids = False

    electrons: Optional[PlasmaProfilesTimeSliceElectrons] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_time_slice_electrons",
            "field_type": PlasmaProfilesTimeSliceElectrons,
        },
    )
    ion: Optional[PlasmaProfilesTimeSliceIon] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesTimeSliceIon),
        metadata={
            "imas_type": "plasma_profiles_time_slice_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesTimeSliceIon,
        },
    )
    neutral: Optional[PlasmaProfilesTimeSliceNeutral] = field(
        default_factory=lambda: StructArray(
            type=PlasmaProfilesTimeSliceNeutral
        ),
        metadata={
            "imas_type": "plasma_profiles_time_slice_neutral",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesTimeSliceNeutral,
        },
    )
    ...
    r_j_total_phi: Optional[GenericGridScalar] = field(
        default_factory=lambda: StructArray(type=GenericGridScalar),
        metadata={
            "imas_type": "generic_grid_scalar",
            "ndims": 1,
    ...
    b_field: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
            "imas_type": "generic_grid_vector_components",
            "ndims": 1,
    ...
    a_field: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
            "imas_type": "generic_grid_vector_components",
            "ndims": 1,
    ...
    velocity_mass_centre: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
            "imas_type": "generic_grid_vector_components",
            "ndims": 1,
    ...
    vorticity: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
            "imas_type": "generic_grid_vector_components",
            "ndims": 1,
    ...
    vorticity_over_r: Optional[GenericGridVectorComponents] = field(
        default_factory=lambda: StructArray(type=GenericGridVectorComponents),
        metadata={
            "imas_type": "generic_grid_vector_components",
            "ndims": 1,
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfilesGgdFast(IdsBaseClass):
    """
    ...
    class Meta:
        name = "plasma_profiles_ggd_fast"
        is_root_ids = False

    electrons: Optional[PlasmaProfilesGgdFastElectrons] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_ggd_fast_electrons",
            "field_type": PlasmaProfilesGgdFastElectrons,
        },
    )
    ion: Optional[PlasmaProfilesGgdFastIon] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesGgdFastIon),
        metadata={
            "imas_type": "plasma_profiles_ggd_fast_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PlasmaProfilesGgdFastIon,
        },
    )
...
@idspy_dataclass(repr=False, slots=True)
class PlasmaProfiles(IdsBaseClass):
    """
    ...
    :ivar profiles_1d : Radial profiles for various time slices. Flux averaged profiles in the closed field line region (grid/rho_pol_norm &lt;= 1) and taking local values on outboard equatorial mid-plane when in the SOL (grid/rho_pol_norm &gt; 1)
    :ivar profiles_2d : Plasma quantities in a poloidal cross section, for various time slices
    ...
    :ivar ggd : Plasma quantities represented using the general grid description, for various time slices. The timebase of this array of structure must be a subset of the ggd_fast timebase (only if the ggd_fast array of structure is used)
    ...
    global_quantities: Optional[PlasmaProfilesGlobalQuantities] = field(
        default=None,
        metadata={
            "imas_type": "plasma_profiles_global_quantities",
            "field_type": PlasmaProfilesGlobalQuantities,
        },
    )
    profiles_1d: Optional[PlasmaProfilesProfiles1D] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesProfiles1D),
        metadata={
            "imas_type": "plasma_profiles_profiles_1d",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": PlasmaProfilesProfiles1D,
        },
    )
    profiles_2d: Optional[PlasmaProfilesProfiles2D] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesProfiles2D),
        metadata={
            "imas_type": "plasma_profiles_profiles_2d",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": PlasmaProfilesProfiles2D,
        },
    )
    grid_ggd: Optional[GenericGridAos3Root] = field(
        default_factory=lambda: StructArray(type=GenericGridAos3Root),
        metadata={
    ...
    ggd: Optional[PlasmaProfilesTimeSlice] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesTimeSlice),
        metadata={
            "imas_type": "plasma_profiles_time_slice",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": PlasmaProfilesTimeSlice,
        },
    )
    ggd_fast: Optional[PlasmaProfilesGgdFast] = field(
        default_factory=lambda: StructArray(type=PlasmaProfilesGgdFast),
        metadata={
            "imas_type": "plasma_profiles_ggd_fast",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": PlasmaProfilesGgdFast,
        },
    )
    ...
    statistics: Optional[Statistics] = field(
        default_factory=lambda: StructArray(type=Statistics),
        metadata={
