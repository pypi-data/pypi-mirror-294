...
class EdgeSourcesSourceGgdFast(IdsBaseClass):
    ...
    ion: Optional[EdgeSourcesSourceGgdFastIon] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSourceGgdFastIon),
        metadata={
            "imas_type": "edge_sources_source_ggd_fast_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": EdgeSourcesSourceGgdFastIon,
        },
    )
    time: Optional[float] = field(
        default=9e40, metadata={"imas_type": "flt_type", "field_type": float}
...
class EdgeSourcesSourceGgdIon(IdsBaseClass):
    ...
    state: Optional[EdgeSourcesSourceGgdIonState] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSourceGgdIonState),
        metadata={
            "imas_type": "edge_sources_source_ggd_ion_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": EdgeSourcesSourceGgdIonState,
        },
    )
...
class EdgeSourcesSourceGgdNeutral(IdsBaseClass):
    ...
    state: Optional[EdgeSourcesSourceGgdNeutralState] = field(
        default_factory=lambda: StructArray(
            type=EdgeSourcesSourceGgdNeutralState
        ),
        metadata={
            "imas_type": "edge_sources_source_ggd_neutral_state",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": EdgeSourcesSourceGgdNeutralState,
        },
    )
...
class EdgeSourcesSourceGgd(IdsBaseClass):
    ...
    electrons: Optional[EdgeSourcesSourceGgdElectrons] = field(
        default=None,
        metadata={
            "imas_type": "edge_sources_source_ggd_electrons",
            "field_type": EdgeSourcesSourceGgdElectrons,
        },
    )
    ion: Optional[EdgeSourcesSourceGgdIon] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSourceGgdIon),
        metadata={
            "imas_type": "edge_sources_source_ggd_ion",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": EdgeSourcesSourceGgdIon,
        },
    )
    neutral: Optional[EdgeSourcesSourceGgdNeutral] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSourceGgdNeutral),
        metadata={
            "imas_type": "edge_sources_source_ggd_neutral",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": EdgeSourcesSourceGgdNeutral,
        },
    )
...
class EdgeSourcesSource(IdsBaseClass):
    ...
    ggd: Optional[EdgeSourcesSourceGgd] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSourceGgd),
        metadata={
            "imas_type": "edge_sources_source_ggd",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": EdgeSourcesSourceGgd,
        },
    )
    ggd_fast: Optional[EdgeSourcesSourceGgdFast] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSourceGgdFast),
        metadata={
            "imas_type": "edge_sources_source_ggd_fast",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": EdgeSourcesSourceGgdFast,
        },
    )
...
class EdgeSources(IdsBaseClass):
    ...
    source: Optional[EdgeSourcesSource] = field(
        default_factory=lambda: StructArray(type=EdgeSourcesSource),
        metadata={
            "imas_type": "edge_sources_source",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": EdgeSourcesSource,
        },
    )
