...
class PSS1830 :
    ...
    def enter_login_prompt(self) :
        for i in range(10) :
            ...
            self.logger.debug(f"Enter Login Prompt is waiting the UserName input: {new_data}")
    ...
    def newUserPwdReset(self):
        ...
        for i in range(30) :
            ...
            if 'Error:' in new_data:
                self.logger.error(f"Password Change Failed due to Error: {new_data}")
