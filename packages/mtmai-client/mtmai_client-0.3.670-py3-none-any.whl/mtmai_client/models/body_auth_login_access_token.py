...
T = TypeVar("T", bound="BodyAuthLoginAccessToken")


@_attrs_define
class BodyAuthLoginAccessToken:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_auth_login_access_token = cls(
            username=username,
            password=password,
        ...
        body_auth_login_access_token.additional_properties = d
        return body_auth_login_access_token
