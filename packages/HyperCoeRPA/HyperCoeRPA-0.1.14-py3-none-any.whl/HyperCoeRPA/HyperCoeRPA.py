...
def Queue_Item_Change_Exception_Error(path, queueItemID, exception):
    try:
        ...
        # EndPoint API
        UrlAPI = 'https://hypercoe-api-hml.triasoftware.com.br/api/item-queue/exception'
...
def Queue_Item_Change_Status(path, queueItemID, status):
    try:
        ...
        # EndPoint API
        UrlAPI = 'https://hypercoe-api-hml.triasoftware.com.br/api/item-queue/status'
        #UrlAPIStatus = 'https://api-app.hypercoe.com​/api​/item-queue/get-all'
...
def Queue_Item_Get(path):
    try:
        ...
        # EndPoint API
        UrlAPIStatus = 'https://hypercoe-api-hml.triasoftware.com.br/api/item-queue/get-all'
...
def Populate_Queue(path, Reference, DadosJson):
    try:
        ...
        # EndPoint API
        UrlAPIStatus = 'https://hypercoe-api-hml.triasoftware.com.br/api/item-queue'
