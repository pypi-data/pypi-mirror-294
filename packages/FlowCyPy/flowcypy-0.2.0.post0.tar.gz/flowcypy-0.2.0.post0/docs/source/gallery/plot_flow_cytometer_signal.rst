...
.. GENERATED FROM PYTHON SOURCE LINES 41-122
...
.. code-block:: python3
    ...
    scatterer_distribution = ScattererDistribution(
        ...
        mean_size=1e-6,               # Mean particle size: 1 µm
        std_size=1e-7,                # Standard deviation: 0.1 µm
        distribution_type='singular:1e-6'   # Uniform distribution of particle sizes
    )
    ...
    source = Source(
        numerical_aperture=0.4,       # Numerical aperture of the source
    ...
    detector_fsc = Detector(
        ...
        theta_angle=0,                # Angle relative to the light beam
    ...
    detector_ssc = Detector(
        ...
        numerical_aperture=0.2,       # Numerical aperture of the SSC detector
...
.. image-sg:: /gallery/images/sphx_glr_plot_flow_cytometer_signal_001.png
   :alt: Detector: FSC, Size Distribution of Scatterers (Singular:1e-6 Distribution)
