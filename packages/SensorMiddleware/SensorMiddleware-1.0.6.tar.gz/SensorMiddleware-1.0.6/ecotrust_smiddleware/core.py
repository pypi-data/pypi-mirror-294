...
class SensorControler(Sensor):
    ...
    SCAN_RUNNING_STATUS 	= ['STARTED', 'SCANNING', 'PAUSING', 'STOPING', 'NETWORK-ERROR', 'UNKNOWN'] # noqa
    ...
    def wait_scan(self) -> bool:
        ...
        ST_MAXIMUM_WAIT_ENGINE:  Final[int] = 47
        errnow = 0
        waitnw = 0
        ...
        while not self.is_engine_process_running():
            ...
            if waitnw >= ST_MAXIMUM_WAIT_ENGINE:
                break
        ...
        while scan_status in self.SCAN_RUNNING_STATUS:
            ...
            is_scan_finished = scan_status in self.SCAN_FINISHED_STATUS
            ...
            # Engine proc check
            if not self.is_engine_process_running() or is_scan_finished:
                break
