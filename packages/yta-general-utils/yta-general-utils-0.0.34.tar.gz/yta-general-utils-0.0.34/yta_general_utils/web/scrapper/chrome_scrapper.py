...
class ChromeScrapper:
    ...
    def find_elements_by_element_type(self, element_type: str, element: Union[WebElement, None] = None):
        # TODO: Document
        if not element_type:
            raise Exception('No "element_type" provided.')
        
        if element:
            return element.find_elements(By.TAG_NAME, element_type)
    ...
    def scroll_to_element(self, element: WebElement):
        ...
        is very useful to take screenshots.
        """
