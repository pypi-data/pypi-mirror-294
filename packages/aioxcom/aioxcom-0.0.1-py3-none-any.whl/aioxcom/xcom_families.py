...
class XcomDeviceFamilies:
    XTENDER = XcomDeviceFamily(
        ...
        [3020,3028,3031,3032,3049,3078,3081,3083,3101,3104,3119], # nr defaults suggested
    )
    L1 = XcomDeviceFamily(
        "l1", "xt",
        "Phase L1", 
    ...
    BSP = XcomDeviceFamily(
        ...
        [7007,7008,7030,7031,7032,7033], # nr defaults suggested
    )
    ...
    VARIOTRACK = XcomDeviceFamily(
        ...
        [11007,11025,11038,11039,11040,11041,11042,11045,11069], # nr nr defaults suggested
    )
    VARIOSTRING = XcomDeviceFamily(
        ...
        [15017,15030,15054,15057,15064,15065,15108], # nr defaults suggested
    )
