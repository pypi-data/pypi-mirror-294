...
from src.umlars_translator.app.dtos import input as source_models
...
from src.umlars_translator.app.services.models_translator import translate_service
...
@app.post("/translate")
async def translate_uml_model(uml_model: source_models.UmlModelDTO, model_repo: UmlModelRepository = Depends(lambda: di[UmlModelRepository]), app_logger: logging.Logger = Depends(lambda: di[logging.Logger])):
