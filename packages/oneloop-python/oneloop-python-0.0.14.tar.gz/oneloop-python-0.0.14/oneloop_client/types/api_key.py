...
class ApiKey(pydantic.BaseModel):
    ...
    expires_at: typing.Optional[int] = pydantic.Field(alias="expiresAt")
    total_usage_left: typing.Optional[int] = pydantic.Field(alias="totalUsageLeft")
    ...
    last_used_at: typing.Optional[str] = pydantic.Field(alias="lastUsedAt")
